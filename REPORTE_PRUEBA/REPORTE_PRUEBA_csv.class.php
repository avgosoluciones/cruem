...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo  .= ".csv";
      $this->Tit_doc   = "REPORTE_PRUEBA.csv";
      ...
      if (!$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_return']);
          if ($this->Tem_csv_res) {
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_name']);
      }
      ...
      { 
          ...
          $this->Res = new REPORTE_PRUEBA_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   function NM_export_txt_fecha()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->txt_fecha);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
