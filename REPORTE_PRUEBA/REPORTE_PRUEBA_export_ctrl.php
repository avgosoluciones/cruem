<?php
@session_start() ;
$_SESSION['scriptcase']['REPORTE_PRUEBA']['sc_process_barr'] = true;
require_once('../REPORTE_PRUEBA/index.php');
unset($_SESSION['scriptcase']['REPORTE_PRUEBA']['sc_process_barr']);
$ExportCtrl = new REPORTE_PRUEBA_export_control;
$ExportCtrl->Export_barr();

class REPORTE_PRUEBA_export_control
{
