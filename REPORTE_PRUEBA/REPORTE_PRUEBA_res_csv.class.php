...
class REPORTE_PRUEBA_res_csv
{
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Res           = new REPORTE_PRUEBA_resumo("out");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['arr_export']['data'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['pivot_tabular'];
      if (1 >= sizeof($this->comp_y_axys))
      {
        ...
        if ('S' == $this->Label_CSV) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['REPORTE_PRUEBA'] ['export_info'] ['ordered_x_matrix'] as $rowNumber => $rowInfo) {
            }
        }

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['REPORTE_PRUEBA'] ['export_data'] as $exportRowInfo) {
            $csvLine = [];
            ...
            for ($i = $dimensionCount; $i < $_SESSION['sc_session'] [$this->Ini->sc_page] ['REPORTE_PRUEBA'] ['export_info'] ['dimension_count'] ['y']; $i++) {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['csv_res_file'] = $this->Csv_f;
      }
