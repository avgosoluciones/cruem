...
class REPORTE_PRUEBA_res_rtf
{
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['arr_export']['data'];
