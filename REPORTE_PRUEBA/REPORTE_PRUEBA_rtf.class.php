...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "REPORTE_PRUEBA.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_name']);
      }
   ...
   function NM_export_txt_fecha()
   {
         ...
         $this->txt_fecha = str_replace('<', '&lt;', $this->txt_fecha);
         $this->txt_fecha = str_replace('>', '&gt;', $this->txt_fecha);
         $this->Texto_tag .= "<td>" . $this->txt_fecha . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
