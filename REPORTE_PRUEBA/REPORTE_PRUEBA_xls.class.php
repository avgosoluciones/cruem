...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "REPORTE_PRUEBA/REPORTE_PRUEBA_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new REPORTE_PRUEBA_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_REPORTE_PRUEBA.zip";
          $this->Arquivo   .= "_REPORTE_PRUEBA" . $this->Xls_tp;
          $this->Tit_doc    = "REPORTE_PRUEBA" . $this->Xls_tp;
      ...
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "procedimiento_quien_reporta" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "procedimiento_tipo_caso" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones_id_observacion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones_id_procedimiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones_fecha" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones_ip" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones_observa" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "anotaciones_user" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "txt_fecha" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_barrio_id_barrio()
   {
         ...
         if (is_numeric($this->barrio_id_barrio))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->barrio_id_barrio);
         $this->Xls_col++;
   }
   //----- barrio_barrio
   function NM_export_barrio_barrio()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->barrio_barrio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->barrio_barrio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- barrio_id_sector
   function NM_export_barrio_id_sector()
   {
         ...
         if (is_numeric($this->barrio_id_sector))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->barrio_id_sector);
         $this->Xls_col++;
   }
   //----- eps_id_eps
   function NM_export_eps_id_eps()
   {
         ...
         if (is_numeric($this->eps_id_eps))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->eps_id_eps);
         $this->Xls_col++;
   }
   //----- eps_eps
   function NM_export_eps_eps()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->eps_eps, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->eps_eps, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_id_procedimiento()
   {
         ...
         if (is_numeric($this->procedimiento_id_procedimiento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->procedimiento_id_procedimiento);
         $this->Xls_col++;
   }
   //----- procedimiento_secad
   function NM_export_procedimiento_secad()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_secad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_secad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_direccion_servicio()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_direccion_servicio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_direccion_servicio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_id_barrio()
   {
         ...
         if (is_numeric($this->procedimiento_id_barrio))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->procedimiento_id_barrio);
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_quien_reporta()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->procedimiento_quien_reporta = html_entity_decode($this->procedimiento_quien_reporta, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_quien_reporta = strip_tags($this->procedimiento_quien_reporta);
         $this->procedimiento_quien_reporta = NM_charset_to_utf8($this->procedimiento_quien_reporta);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_quien_reporta, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_quien_reporta, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_hora_ingreso_llamada()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->procedimiento_hora_ingreso_llamada))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_ingreso_llamada, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_ingreso_llamada, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_hora_notifica_movil()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->procedimiento_hora_notifica_movil))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_notifica_movil, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_notifica_movil, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_hora_llegada_sitio()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->procedimiento_hora_llegada_sitio))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_llegada_sitio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_llegada_sitio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_hora_llegada_ips()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->procedimiento_hora_llegada_ips))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_llegada_ips, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_llegada_ips, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_hora_salida_ips()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->procedimiento_hora_salida_ips))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_salida_ips, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_hora_salida_ips, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_tipo_servicio()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_tipo_servicio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_tipo_servicio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_numero_contacto()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_numero_contacto, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_numero_contacto, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_radicado()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_radicado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_radicado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_nombre_apellido()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_nombre_apellido, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_nombre_apellido, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_tipo_documento()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_tipo_documento, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_tipo_documento, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_documento_identidad()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_documento_identidad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_documento_identidad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- procedimiento_edad
   function NM_export_procedimiento_edad()
   {
         ...
         if (is_numeric($this->procedimiento_edad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->procedimiento_edad);
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_tipo_caso()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->procedimiento_tipo_caso = html_entity_decode($this->procedimiento_tipo_caso, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_tipo_caso = strip_tags($this->procedimiento_tipo_caso);
         $this->procedimiento_tipo_caso = NM_charset_to_utf8($this->procedimiento_tipo_caso);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_tipo_caso, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_tipo_caso, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_genero()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_genero, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_genero, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_circunstancias_emergencia()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_circunstancias_emergencia, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_circunstancias_emergencia, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_id_seguridad_social()
   {
         ...
         if (is_numeric($this->procedimiento_id_seguridad_social))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->procedimiento_id_seguridad_social);
         $this->Xls_col++;
   }
   ...
   function NM_export_procedimiento_id_eps()
   {
         ...
         if (is_numeric($this->procedimiento_id_eps))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->procedimiento_id_eps);
         $this->Xls_col++;
   }
   //----- procedimiento_fecha
   function NM_export_procedimiento_fecha()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->procedimiento_fecha = substr($this->procedimiento_fecha, 0, 10);
         if (empty($this->procedimiento_fecha) || $this->procedimiento_fecha == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->procedimiento_fecha);
   ...
   function NM_export_procedimiento_ip()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_ip, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_ip, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- procedimiento_login
   function NM_export_procedimiento_login()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_login, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->procedimiento_login, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sector_id_sector
   function NM_export_sector_id_sector()
   {
         ...
         if (is_numeric($this->sector_id_sector))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sector_id_sector);
         $this->Xls_col++;
   }
   //----- sector_sector
   function NM_export_sector_sector()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sector_sector, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sector_sector, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_seguridad_id_seguridad_social()
   {
         ...
         if (is_numeric($this->seguridad_id_seguridad_social))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->seguridad_id_seguridad_social);
         $this->Xls_col++;
   }
   ...
   function NM_export_seguridad_seguridad_social()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->seguridad_seguridad_social, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->seguridad_seguridad_social, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- medico_id_medico
   function NM_export_medico_id_medico()
   {
         ...
         if (is_numeric($this->medico_id_medico))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->medico_id_medico);
         $this->Xls_col++;
   }
   //----- medico_medico
   function NM_export_medico_medico()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_medico, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_medico, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_medico_registro_medico()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_registro_medico, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_registro_medico, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- medico_telefono
   function NM_export_medico_telefono()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_telefono, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_telefono, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- medico_estado
   function NM_export_medico_estado()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_estado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->medico_estado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ambulancia_id_movil
   function NM_export_ambulancia_id_movil()
   {
         ...
         if (is_numeric($this->ambulancia_id_movil))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->ambulancia_id_movil);
         $this->Xls_col++;
   }
   //----- ambulancia_placa
   function NM_export_ambulancia_placa()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ambulancia_placa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ambulancia_placa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- anotaciones
   function NM_export_anotaciones()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_anotaciones_id_observacion()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->anotaciones_id_observacion = NM_charset_to_utf8($this->anotaciones_id_observacion);
         if (is_numeric($this->anotaciones_id_observacion))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anotaciones_id_observacion);
         $this->Xls_col++;
   }
   ...
   function NM_export_anotaciones_id_procedimiento()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->anotaciones_id_procedimiento = NM_charset_to_utf8($this->anotaciones_id_procedimiento);
         if (is_numeric($this->anotaciones_id_procedimiento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anotaciones_id_procedimiento);
         $this->Xls_col++;
   }
   //----- anotaciones_fecha
   function NM_export_anotaciones_fecha()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->anotaciones_fecha = substr($this->anotaciones_fecha, 0, 10);
         if (empty($this->anotaciones_fecha) || $this->anotaciones_fecha == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->anotaciones_fecha);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_anotaciones_ip()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->anotaciones_ip = html_entity_decode($this->anotaciones_ip, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anotaciones_ip = strip_tags($this->anotaciones_ip);
         $this->anotaciones_ip = NM_charset_to_utf8($this->anotaciones_ip);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_ip, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_ip, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- anotaciones_observa
   function NM_export_anotaciones_observa()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->anotaciones_observa = html_entity_decode($this->anotaciones_observa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anotaciones_observa = strip_tags($this->anotaciones_observa);
         $this->anotaciones_observa = NM_charset_to_utf8($this->anotaciones_observa);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_observa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_observa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- anotaciones_user
   function NM_export_anotaciones_user()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->anotaciones_user = html_entity_decode($this->anotaciones_user, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anotaciones_user = strip_tags($this->anotaciones_user);
         $this->anotaciones_user = NM_charset_to_utf8($this->anotaciones_user);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_user, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->anotaciones_user, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_0
   ...
   function NM_export_txt_fecha()
   {
      ...
      if (!empty($this->txt_fecha))
      {
         ...
         $this->txt_fecha = html_entity_decode($this->txt_fecha, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->txt_fecha = NM_charset_to_utf8($this->txt_fecha);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->txt_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->txt_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- barrio_id_barrio
   function NM_sub_cons_barrio_id_barrio()
   {
         $this->barrio_id_barrio = NM_charset_to_utf8($this->barrio_id_barrio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->barrio_id_barrio;
   ...
   //----- barrio_barrio
   function NM_sub_cons_barrio_barrio()
   {
         $this->barrio_barrio = html_entity_decode($this->barrio_barrio, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->barrio_barrio = strip_tags($this->barrio_barrio);
         $this->barrio_barrio = NM_charset_to_utf8($this->barrio_barrio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->barrio_barrio;
   ...
   //----- barrio_id_sector
   function NM_sub_cons_barrio_id_sector()
   {
         $this->barrio_id_sector = NM_charset_to_utf8($this->barrio_id_sector);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->barrio_id_sector;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- eps_id_eps
   function NM_sub_cons_eps_id_eps()
   {
         $this->eps_id_eps = NM_charset_to_utf8($this->eps_id_eps);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->eps_id_eps;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- eps_eps
   function NM_sub_cons_eps_eps()
   {
         $this->eps_eps = html_entity_decode($this->eps_eps, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->eps_eps = strip_tags($this->eps_eps);
         $this->eps_eps = NM_charset_to_utf8($this->eps_eps);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->eps_eps;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_id_procedimiento
   function NM_sub_cons_procedimiento_id_procedimiento()
   {
         $this->procedimiento_id_procedimiento = NM_charset_to_utf8($this->procedimiento_id_procedimiento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_id_procedimiento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- procedimiento_secad
   function NM_sub_cons_procedimiento_secad()
   {
         $this->procedimiento_secad = html_entity_decode($this->procedimiento_secad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_secad = strip_tags($this->procedimiento_secad);
         $this->procedimiento_secad = NM_charset_to_utf8($this->procedimiento_secad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_secad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_direccion_servicio
   function NM_sub_cons_procedimiento_direccion_servicio()
   {
         $this->procedimiento_direccion_servicio = html_entity_decode($this->procedimiento_direccion_servicio, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_direccion_servicio = strip_tags($this->procedimiento_direccion_servicio);
         $this->procedimiento_direccion_servicio = NM_charset_to_utf8($this->procedimiento_direccion_servicio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_direccion_servicio;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_id_barrio
   function NM_sub_cons_procedimiento_id_barrio()
   {
         $this->procedimiento_id_barrio = NM_charset_to_utf8($this->procedimiento_id_barrio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_id_barrio;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- procedimiento_quien_reporta
   function NM_sub_cons_procedimiento_quien_reporta()
   {
         $this->procedimiento_quien_reporta = html_entity_decode($this->procedimiento_quien_reporta, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_quien_reporta = strip_tags($this->procedimiento_quien_reporta);
         $this->procedimiento_quien_reporta = NM_charset_to_utf8($this->procedimiento_quien_reporta);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_quien_reporta;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_hora_ingreso_llamada
   function NM_sub_cons_procedimiento_hora_ingreso_llamada()
   {
      if (!empty($this->procedimiento_hora_ingreso_llamada))
      {
         $conteudo_x =  $this->procedimiento_hora_ingreso_llamada;
         ...
         $this->procedimiento_hora_ingreso_llamada = NM_charset_to_utf8($this->procedimiento_hora_ingreso_llamada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_hora_ingreso_llamada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_hora_notifica_movil
   function NM_sub_cons_procedimiento_hora_notifica_movil()
   {
      if (!empty($this->procedimiento_hora_notifica_movil))
      {
         $conteudo_x =  $this->procedimiento_hora_notifica_movil;
         ...
         $this->procedimiento_hora_notifica_movil = NM_charset_to_utf8($this->procedimiento_hora_notifica_movil);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_hora_notifica_movil;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_hora_llegada_sitio
   function NM_sub_cons_procedimiento_hora_llegada_sitio()
   {
      if (!empty($this->procedimiento_hora_llegada_sitio))
      {
         $conteudo_x =  $this->procedimiento_hora_llegada_sitio;
         ...
         $this->procedimiento_hora_llegada_sitio = NM_charset_to_utf8($this->procedimiento_hora_llegada_sitio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_hora_llegada_sitio;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_hora_llegada_ips
   function NM_sub_cons_procedimiento_hora_llegada_ips()
   {
      if (!empty($this->procedimiento_hora_llegada_ips))
      {
         $conteudo_x =  $this->procedimiento_hora_llegada_ips;
         ...
         $this->procedimiento_hora_llegada_ips = NM_charset_to_utf8($this->procedimiento_hora_llegada_ips);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_hora_llegada_ips;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_hora_salida_ips
   function NM_sub_cons_procedimiento_hora_salida_ips()
   {
      if (!empty($this->procedimiento_hora_salida_ips))
      {
         $conteudo_x =  $this->procedimiento_hora_salida_ips;
         ...
         $this->procedimiento_hora_salida_ips = NM_charset_to_utf8($this->procedimiento_hora_salida_ips);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_hora_salida_ips;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_tipo_servicio
   function NM_sub_cons_procedimiento_tipo_servicio()
   {
         $this->procedimiento_tipo_servicio = html_entity_decode($this->procedimiento_tipo_servicio, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_tipo_servicio = strip_tags($this->procedimiento_tipo_servicio);
         $this->procedimiento_tipo_servicio = NM_charset_to_utf8($this->procedimiento_tipo_servicio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_tipo_servicio;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_numero_contacto
   function NM_sub_cons_procedimiento_numero_contacto()
   {
         $this->procedimiento_numero_contacto = html_entity_decode($this->procedimiento_numero_contacto, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_numero_contacto = strip_tags($this->procedimiento_numero_contacto);
         $this->procedimiento_numero_contacto = NM_charset_to_utf8($this->procedimiento_numero_contacto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_numero_contacto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_radicado
   function NM_sub_cons_procedimiento_radicado()
   {
         $this->procedimiento_radicado = html_entity_decode($this->procedimiento_radicado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_radicado = strip_tags($this->procedimiento_radicado);
         $this->procedimiento_radicado = NM_charset_to_utf8($this->procedimiento_radicado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_radicado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_nombre_apellido
   function NM_sub_cons_procedimiento_nombre_apellido()
   {
         $this->procedimiento_nombre_apellido = html_entity_decode($this->procedimiento_nombre_apellido, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_nombre_apellido = strip_tags($this->procedimiento_nombre_apellido);
         $this->procedimiento_nombre_apellido = NM_charset_to_utf8($this->procedimiento_nombre_apellido);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_nombre_apellido;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_tipo_documento
   function NM_sub_cons_procedimiento_tipo_documento()
   {
         $this->procedimiento_tipo_documento = html_entity_decode($this->procedimiento_tipo_documento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_tipo_documento = strip_tags($this->procedimiento_tipo_documento);
         $this->procedimiento_tipo_documento = NM_charset_to_utf8($this->procedimiento_tipo_documento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_tipo_documento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_documento_identidad
   function NM_sub_cons_procedimiento_documento_identidad()
   {
         $this->procedimiento_documento_identidad = html_entity_decode($this->procedimiento_documento_identidad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_documento_identidad = strip_tags($this->procedimiento_documento_identidad);
         $this->procedimiento_documento_identidad = NM_charset_to_utf8($this->procedimiento_documento_identidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_documento_identidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_edad
   function NM_sub_cons_procedimiento_edad()
   {
         $this->procedimiento_edad = NM_charset_to_utf8($this->procedimiento_edad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_edad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- procedimiento_tipo_caso
   function NM_sub_cons_procedimiento_tipo_caso()
   {
         $this->procedimiento_tipo_caso = html_entity_decode($this->procedimiento_tipo_caso, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_tipo_caso = strip_tags($this->procedimiento_tipo_caso);
         $this->procedimiento_tipo_caso = NM_charset_to_utf8($this->procedimiento_tipo_caso);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_tipo_caso;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_genero
   function NM_sub_cons_procedimiento_genero()
   {
         $this->procedimiento_genero = html_entity_decode($this->procedimiento_genero, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_genero = strip_tags($this->procedimiento_genero);
         $this->procedimiento_genero = NM_charset_to_utf8($this->procedimiento_genero);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_genero;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_circunstancias_emergencia
   function NM_sub_cons_procedimiento_circunstancias_emergencia()
   {
         $this->procedimiento_circunstancias_emergencia = html_entity_decode($this->procedimiento_circunstancias_emergencia, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_circunstancias_emergencia = strip_tags($this->procedimiento_circunstancias_emergencia);
         $this->procedimiento_circunstancias_emergencia = NM_charset_to_utf8($this->procedimiento_circunstancias_emergencia);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_circunstancias_emergencia;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_id_seguridad_social
   function NM_sub_cons_procedimiento_id_seguridad_social()
   {
         $this->procedimiento_id_seguridad_social = NM_charset_to_utf8($this->procedimiento_id_seguridad_social);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_id_seguridad_social;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- procedimiento_id_eps
   function NM_sub_cons_procedimiento_id_eps()
   {
         $this->procedimiento_id_eps = NM_charset_to_utf8($this->procedimiento_id_eps);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_id_eps;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- procedimiento_fecha
   function NM_sub_cons_procedimiento_fecha()
   {
         $this->procedimiento_fecha = substr($this->procedimiento_fecha, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_fecha;
   ...
   //----- procedimiento_ip
   function NM_sub_cons_procedimiento_ip()
   {
         $this->procedimiento_ip = html_entity_decode($this->procedimiento_ip, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_ip = strip_tags($this->procedimiento_ip);
         $this->procedimiento_ip = NM_charset_to_utf8($this->procedimiento_ip);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_ip;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- procedimiento_login
   function NM_sub_cons_procedimiento_login()
   {
         $this->procedimiento_login = html_entity_decode($this->procedimiento_login, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->procedimiento_login = strip_tags($this->procedimiento_login);
         $this->procedimiento_login = NM_charset_to_utf8($this->procedimiento_login);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->procedimiento_login;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sector_id_sector
   function NM_sub_cons_sector_id_sector()
   {
         $this->sector_id_sector = NM_charset_to_utf8($this->sector_id_sector);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sector_id_sector;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- sector_sector
   function NM_sub_cons_sector_sector()
   {
         $this->sector_sector = html_entity_decode($this->sector_sector, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sector_sector = strip_tags($this->sector_sector);
         $this->sector_sector = NM_charset_to_utf8($this->sector_sector);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sector_sector;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- seguridad_id_seguridad_social
   function NM_sub_cons_seguridad_id_seguridad_social()
   {
         $this->seguridad_id_seguridad_social = NM_charset_to_utf8($this->seguridad_id_seguridad_social);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->seguridad_id_seguridad_social;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- seguridad_seguridad_social
   function NM_sub_cons_seguridad_seguridad_social()
   {
         $this->seguridad_seguridad_social = html_entity_decode($this->seguridad_seguridad_social, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->seguridad_seguridad_social = strip_tags($this->seguridad_seguridad_social);
         $this->seguridad_seguridad_social = NM_charset_to_utf8($this->seguridad_seguridad_social);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->seguridad_seguridad_social;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- medico_id_medico
   function NM_sub_cons_medico_id_medico()
   {
         $this->medico_id_medico = NM_charset_to_utf8($this->medico_id_medico);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->medico_id_medico;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- medico_medico
   function NM_sub_cons_medico_medico()
   {
         $this->medico_medico = html_entity_decode($this->medico_medico, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->medico_medico = strip_tags($this->medico_medico);
         $this->medico_medico = NM_charset_to_utf8($this->medico_medico);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->medico_medico;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- medico_registro_medico
   function NM_sub_cons_medico_registro_medico()
   {
         $this->medico_registro_medico = html_entity_decode($this->medico_registro_medico, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->medico_registro_medico = strip_tags($this->medico_registro_medico);
         $this->medico_registro_medico = NM_charset_to_utf8($this->medico_registro_medico);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->medico_registro_medico;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- medico_telefono
   function NM_sub_cons_medico_telefono()
   {
         $this->medico_telefono = html_entity_decode($this->medico_telefono, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->medico_telefono = strip_tags($this->medico_telefono);
         $this->medico_telefono = NM_charset_to_utf8($this->medico_telefono);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->medico_telefono;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- medico_estado
   function NM_sub_cons_medico_estado()
   {
         $this->medico_estado = html_entity_decode($this->medico_estado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->medico_estado = strip_tags($this->medico_estado);
         $this->medico_estado = NM_charset_to_utf8($this->medico_estado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->medico_estado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ambulancia_id_movil
   function NM_sub_cons_ambulancia_id_movil()
   {
         $this->ambulancia_id_movil = NM_charset_to_utf8($this->ambulancia_id_movil);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ambulancia_id_movil;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- ambulancia_placa
   function NM_sub_cons_ambulancia_placa()
   {
         $this->ambulancia_placa = html_entity_decode($this->ambulancia_placa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ambulancia_placa = strip_tags($this->ambulancia_placa);
         $this->ambulancia_placa = NM_charset_to_utf8($this->ambulancia_placa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ambulancia_placa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- anotaciones
   function NM_sub_cons_anotaciones()
   {
         $this->anotaciones = NM_charset_to_utf8($this->anotaciones);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- anotaciones_id_observacion
   function NM_sub_cons_anotaciones_id_observacion()
   {
         $this->anotaciones_id_observacion = NM_charset_to_utf8($this->anotaciones_id_observacion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones_id_observacion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anotaciones_id_procedimiento
   function NM_sub_cons_anotaciones_id_procedimiento()
   {
         $this->anotaciones_id_procedimiento = NM_charset_to_utf8($this->anotaciones_id_procedimiento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones_id_procedimiento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- anotaciones_fecha
   function NM_sub_cons_anotaciones_fecha()
   {
         $this->anotaciones_fecha = substr($this->anotaciones_fecha, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones_fecha;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   //----- anotaciones_ip
   function NM_sub_cons_anotaciones_ip()
   {
         $this->anotaciones_ip = html_entity_decode($this->anotaciones_ip, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anotaciones_ip = strip_tags($this->anotaciones_ip);
         $this->anotaciones_ip = NM_charset_to_utf8($this->anotaciones_ip);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones_ip;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- anotaciones_observa
   function NM_sub_cons_anotaciones_observa()
   {
         $this->anotaciones_observa = html_entity_decode($this->anotaciones_observa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anotaciones_observa = strip_tags($this->anotaciones_observa);
         $this->anotaciones_observa = NM_charset_to_utf8($this->anotaciones_observa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones_observa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- anotaciones_user
   function NM_sub_cons_anotaciones_user()
   {
         $this->anotaciones_user = html_entity_decode($this->anotaciones_user, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->anotaciones_user = strip_tags($this->anotaciones_user);
         $this->anotaciones_user = NM_charset_to_utf8($this->anotaciones_user);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->anotaciones_user;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- txt_fecha
   function NM_sub_cons_txt_fecha()
   {
      if (!empty($this->txt_fecha))
      {
         if ($this->txt_fecha !== "&nbsp;") 
         ...
         $this->txt_fecha = html_entity_decode($this->txt_fecha, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->txt_fecha = NM_charset_to_utf8($this->txt_fecha);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->txt_fecha;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['REPORTE_PRUEBA']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
