...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app3_Login']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app3_Login']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['app3_Login']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['app3_Login']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['app3_Login']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->facebook_error_code)) 
          {
              $_SESSION['facebook_error_code'] = $this->facebook_error_code;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['app3_Login']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new app3_Login_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['initialize'])
          {
              $_SESSION['scriptcase']['app3_Login']['contr_erro'] = 'on';
  if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_form_add_users']))
{
unset($_SESSION['scriptcase']['sc_apl_conf']['app3_form_add_users']);
}
;
if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_retrieve_pswd']))
{
unset($_SESSION['scriptcase']['sc_apl_conf']['app3_retrieve_pswd']);
}
;
...
$_SESSION['scriptcase']['app3_Login']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['app3_Login']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_Login']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_Login'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_Login']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_Login']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('app3_Login') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_Login']['label'] = "Login";
      ...
      $_SESSION['scriptcase']['error_icon']['app3_Login']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['app3_Login'] = "";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_Login']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_Login'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_Login'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("app3_Login", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'app3_Login_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'app3_Login_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'app3_Login/app3_Login_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "app3_Login_erro.class.php"); 
      }
      $this->Erro      = new app3_Login_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['app3_Login']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['final'];
      }
      else
      {
      }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['captcha_display'] = $this->nmgp_captcha_display;
;
}else{
...
$_SESSION['scriptcase']['app3_Login']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['app3_Login']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['app3_Login']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->retrieve_pswd = "" ;  
          $this->language = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos']))
              { 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][0]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][1]; 
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][2]; 
                  $new_user = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][3]; 
                  $retrieve_pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][4]; 
                  $language = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][5]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][0] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][1] = $this->pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][2] = $this->remember_me; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][3] = $this->new_user; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][4] = $this->retrieve_pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['campos'][5] = $this->language; 
          if (!empty($this->new_user))
          {
              ...
              else
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir_target_name'] = $this->new_user_sc_target_name;
          ...
          if (!empty($this->retrieve_pswd))
          {
              ...
              else
              {
                  ...
                  $path_retorno_aplicacao .=  $trab_saida;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir_target_name'] = $this->retrieve_pswd_sc_target_name;
                  $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $path_retorno_aplicacao;
                  $nm_apl_dependente = 1; 
               }
               $this->NM_close_db(); 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir'] == "redir")
          {
              $this->nmgp_redireciona(); 
          }
          else
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("app3_Login", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("app3_Login_fim.php", $this->nm_location, $contr_menu); 
              }
              elseif (!$this->NM_ajax_flag)
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "app3_Login.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="app3_Login_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="app3_Login"> 
...
//---------------------------------------------------------
     ...
     if (true && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['captcha_display']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['captcha_display'] != 'none')) {
         ...
         if (!$valid)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                 if (!isset($this->NM_ajax_info['errList']['geral_app3_Login']) || !is_array($this->NM_ajax_info['errList']['geral_app3_Login']))
                 {
                     $this->NM_ajax_info['errList']['geral_app3_Login'] = array();
                 }
                 $this->NM_ajax_info['errList']['geral_app3_Login'][] = "CAPTCHA: " . $this->Ini->Nm_lang['lang_othr_cptc_errm'] . "";
             }
         }
     }
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_app3_Login'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
else if($this->rs[0][1] == 'Y')
{
    ...
    if(!empty($this->rs[0][8])){
        ...
        $path_img = $_SESSION['scriptcase']['app3_Login']['glo_nm_path_imag_temp'] .'/sc_img_'. $this->sc_temp_usr_login . hash("md5",date('YmdHis')) . '.png';
			...
			if ($this->Ini->sc_tem_trans_banco)
{
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app3_change_pswd') . "/", $this->nm_location, "act_code?#?" . NM_encode_input($code) . "?@?" . "pswd_expired?#?" . NM_encode_input("1") . "?@?", "_self", "ret_self", 440, 630);
 };
		}
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app3_control_2fa') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };
            }
        }
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app3_add_2fa') . "/", $this->nm_location, "redir_menu?#?" . NM_encode_input("1") . "?@?", "_self", "ret_self", 440, 630);
 };
        }
...
$_SESSION['scriptcase']['app3_Login']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(app3_Login_pack_protect_string('1') => str_replace('<', '&lt;',app3_Login_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_remember_me'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['Lookup_remember_me'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['remember_me']['valList'][$i] = app3_Login_pack_protect_string($v);
          }
   ...
   function ajax_return_values_language($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app3_menu') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };	
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
if (!isset($this->sc_temp_return_msg_email_act)) {$this->sc_temp_return_msg_email_act = (isset($_SESSION['return_msg_email_act'])) ? $_SESSION['return_msg_email_act'] : "";}
  $_SESSION['scriptcase']['sc_apl_conf']['app3_form_add_users']['start'] = 'new';
...
$_SESSION['scriptcase']['app3_Login']['contr_erro'] = 'off'; 
    ...
    include_once("app3_Login_form_user.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_app3_Login = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['total'] = $qt_geral_reg_app3_Login;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          app3_Login_pack_ajax_response();
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['empty_filter'] = true;
          $this->NM_ajax_info['empty_filter'] = 'ok';
          app3_Login_pack_ajax_response();
          exit;
      }
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "app3_Login_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['nm_run_menu'] = 2;
       $nmgp_saida_form = "app3_Login_fim.php";
   }
   ...
   if ($this->NM_ajax_flag)
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir_target_name']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir_target_name'])
       {
           $sTarget = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir_target_name'];
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['redir_target_name']);
       }
       else
       {
           $sTarget = '_self';
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['ordem_ord'] == " desc") {
