...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____app3_Login"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____app3_Login"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_Login']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_outra_jan'])
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['app3_Login']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   ...
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['app3_Login']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['app3_Login']['db_changed'])
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_iframe_modal']);
               }
               else
               {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['app3_Login']['db_changed'])
           {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['app3_Login']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_Login']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['app3_Login']['embutida_filho'] as $ind => $sc_init)
          {
