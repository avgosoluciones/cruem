...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app3_Login/app3_Login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("app3_Login_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('app3_Login_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['link_info']['remove_border']) {
...
<?php
 include_once("app3_Login_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['app3_Login'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['app3_Login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['where_filter']))
       {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['Lookup_remember_me'][] = '1'; ?>
...
<input type="hidden" name="new_user_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_new_user('app3_form_add_users', '_self')"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<input type="hidden" name="retrieve_pswd_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_retrieve_pswd('app3_retrieve_pswd', '_self')"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<?php } else { ?>
<span id="id_read_on_language" class="css_language_line" style="<?php echo $sStyleReadLab_language; ?>"><?php echo $this->Ini->Nm_lang_conf_region[$tst_conf_reg]; ?></span><span id="id_read_off_language" class="css_read_off_language" style="<?php echo $sStyleReadInp_language; ?>">
 <span id="idAjaxSelect_language"><select class="sc-js-input scFormObjectOdd css_language_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" name="language" size=1 onChange="document.F1.nmgp_opcao.value='change_lang_f'; setLocale(this); document.F1.submit(); return false">
<?php
...
function captchaReloadImage() {
 ...
 document.getElementById("id_captcha_img").src = "app3_Login_captcha_show.php?sid=" + sRand;
}
</script>
<?php
if (true) {
...
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="app3_Login_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td><td><?php echo nmButtonOutput($this->arr_buttons, "bcaptchareload", "captchaReloadImage()", "captchaReloadImage()", "id_captcha_reload", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
</td></tr></table></td>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("app3_Login");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("app3_Login");
 parent.scAjaxDetailHeight("app3_Login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
