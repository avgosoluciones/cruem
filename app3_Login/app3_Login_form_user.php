...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/grp/crue_login_html/login/css/login.css">
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/grp/crue_login_html/libs/css/styles.css">
        <style>
    ...
    <body class="page-sidebar page-background bg-half-img" style="background-image:url('../_lib/libraries/grp/crue_login_html/login/img/emergencias.png');background-size:100%;">
        <div class="page">
            <div class="container">
                <div class="grid">
                    <div class="col-7">
...
?>
        ...
        <script type="text/javascript" src="../_lib/libraries/grp/crue_login_html/libs/js/error.js"></script>
    </body>
</html>