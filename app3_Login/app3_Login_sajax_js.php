  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_Login" == sTestField)
        {
...
?>
  ...
  // ---------- Validate login
  function do_ajax_app3_Login_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_Login_validate_login(var_login, var_script_case_init, do_ajax_app3_Login_validate_login_cb);
  } // do_ajax_app3_Login_validate_login

  function do_ajax_app3_Login_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_Login_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_app3_Login_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_Login_validate_pswd(var_pswd, var_script_case_init, do_ajax_app3_Login_validate_pswd_cb);
  } // do_ajax_app3_Login_validate_pswd

  function do_ajax_app3_Login_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_Login_validate_pswd_cb

  // ---------- Validate remember_me
  function do_ajax_app3_Login_validate_remember_me()
  {
    var nomeCampo_remember_me = "remember_me";
    var var_remember_me = scAjaxGetFieldCheckbox(nomeCampo_remember_me, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_Login_validate_remember_me(var_remember_me, var_script_case_init, do_ajax_app3_Login_validate_remember_me_cb);
  } // do_ajax_app3_Login_validate_remember_me

  function do_ajax_app3_Login_validate_remember_me_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_Login_validate_remember_me_cb

  // ---------- Validate new_user
  function do_ajax_app3_Login_validate_new_user()
  {
    var nomeCampo_new_user = "new_user";
    var var_new_user = scAjaxGetFieldText(nomeCampo_new_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_Login_validate_new_user(var_new_user, var_script_case_init, do_ajax_app3_Login_validate_new_user_cb);
  } // do_ajax_app3_Login_validate_new_user

  function do_ajax_app3_Login_validate_new_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_Login_validate_new_user_cb

  // ---------- Validate retrieve_pswd
  function do_ajax_app3_Login_validate_retrieve_pswd()
  {
    var nomeCampo_retrieve_pswd = "retrieve_pswd";
    var var_retrieve_pswd = scAjaxGetFieldText(nomeCampo_retrieve_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_Login_validate_retrieve_pswd(var_retrieve_pswd, var_script_case_init, do_ajax_app3_Login_validate_retrieve_pswd_cb);
  } // do_ajax_app3_Login_validate_retrieve_pswd

  function do_ajax_app3_Login_validate_retrieve_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_Login_validate_retrieve_pswd_cb

  // ---------- Validate language
  function do_ajax_app3_Login_validate_language()
  {
    var nomeCampo_language = "language";
    var var_language = scAjaxGetFieldText(nomeCampo_language);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_Login_validate_language(var_language, var_script_case_init, do_ajax_app3_Login_validate_language_cb);
  } // do_ajax_app3_Login_validate_language

  function do_ajax_app3_Login_validate_language_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_Login_validate_language_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_Login_submit_form()
  {
    scAjaxHideMessage();
    ...
    x_ajax_app3_Login_submit_form(var_login, var_pswd, var_remember_me, var_new_user, var_retrieve_pswd, var_language, var_new_user_sc_target_name, var_retrieve_pswd_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_captcha_sent, var_csrf_token, var_bok, do_ajax_app3_Login_submit_form_cb);
  } // do_ajax_app3_Login_submit_form

  function do_ajax_app3_Login_submit_form_cb(sResp)
  {
    captchaReloadImage();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_Login_submit_form_cb_after_alert);
  } // do_ajax_app3_Login_submit_form_cb
  function do_ajax_app3_Login_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_Login_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_Login_navigate_form()
  {
    perform_ajax_app3_Login_navigate_form();
  }

  function perform_ajax_app3_Login_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app3_Login_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_Login']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_Login_navigate_form_cb(sResp)
  {
    captchaReloadImage();
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_Login_navigate_form_cb_after_alert);
  } // do_ajax_app3_Login_navigate_form_cb
  function do_ajax_app3_Login_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
{
?>
    do_ajax_app3_Login_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_Login_navigate_form_cb_after_alert

  function sc_hide_app3_Login_form()
  {
  ...
  var ajax_error_list = {
    ...
    "language": {"label": "<?php echo $this->Ini->Nm_lang['lang_btns_lang'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
