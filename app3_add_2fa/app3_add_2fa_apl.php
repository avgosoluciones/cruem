...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->sett_enable_2fa)) 
          {
              $_SESSION['sett_enable_2fa'] = $this->sett_enable_2fa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new app3_add_2fa_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['app3_add_2fa']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_add_2fa']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_add_2fa'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_add_2fa']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_add_2fa']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('app3_add_2fa') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_add_2fa']['label'] = "" . $this->Ini->Nm_lang['lang_add_2fa_title'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['app3_add_2fa']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['app3_add_2fa'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_add_2fa'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_add_2fa'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'app3_add_2fa_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'app3_add_2fa_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'app3_add_2fa/app3_add_2fa_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "app3_add_2fa_erro.class.php"); 
      }
      $this->Erro      = new app3_add_2fa_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opcao'] = "novo";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['send_sms'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['botoes']['send_sms'];
          $this->nmgp_botoes['send_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['botoes']['send_email'];
          $this->nmgp_botoes['reset'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['botoes']['reset'];
          $this->nmgp_botoes['submit_ajax'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['botoes']['submit_ajax'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['app3_add_2fa']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['app3_add_2fa']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->counter = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos']))
              { 
                  $help_description = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][0]; 
                  $google_auth_img = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][1]; 
                  $phone = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][2]; 
                  $code = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][3]; 
                  $counter = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][4]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][0] = $this->help_description; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][1] = $this->google_auth_img; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][2] = $this->phone; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][3] = $this->code; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['campos'][4] = $this->counter; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("app3_add_2fa", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("app3_add_2fa_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "app3_add_2fa.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="app3_add_2fa_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="app3_add_2fa"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_app3_add_2fa']) || !is_array($this->NM_ajax_info['errList']['geral_app3_add_2fa']))
              {
                  $this->NM_ajax_info['errList']['geral_app3_add_2fa'] = array();
              }
              $this->NM_ajax_info['errList']['geral_app3_add_2fa'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values_counter($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
{
$_SESSION['scriptcase']['app3_add_2fa']['contr_erro'] = 'on';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['app3_add_2fa']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("app3_add_2fa_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "app3_add_2fa_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['nm_run_menu'] = 2;
       $nmgp_saida_form = "app3_add_2fa_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_btn_disabled($buttonName, $buttonState)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled'][$buttonName] = $buttonState;
    } // sc_btn_disabled
    ...
    function sc_btn_label($buttonName, $buttonLabel)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label'][$buttonName] = $buttonLabel;
    } // sc_btn_label

    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "submit_ajax":
                return array("sc_submit_ajax_bot");
                break;
            case "reset":
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['ordem_ord'] == " desc") {
