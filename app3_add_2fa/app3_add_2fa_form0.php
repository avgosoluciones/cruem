...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app3_add_2fa/app3_add_2fa_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("app3_add_2fa_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('app3_add_2fa_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['link_info']['remove_border']) {
...
<?php
 include_once("app3_add_2fa_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['app3_add_2fa'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['app3_add_2fa'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['empty_filter'] = true;
       }
  }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['submit_ajax']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['submit_ajax']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['submit_ajax']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['submit_ajax']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['submit_ajax'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['reset']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['reset']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['reset']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['reset']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['reset'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['send_sms']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['send_sms']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['send_sms']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['send_sms']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['send_sms'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['send_email']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['send_email']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['send_email']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['send_email']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['send_email'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("app3_add_2fa");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("app3_add_2fa");
 parent.scAjaxDetailHeight("app3_add_2fa", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
