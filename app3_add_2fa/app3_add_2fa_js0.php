...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="app3_add_2fa"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_submit_ajax()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_submit_ajax(); }, 500);
      return;
    }
    sc_btn_submit_ajax_ok();
}
function sc_btn_submit_ajax_cancel()
{
}
function sc_btn_submit_ajax_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['where_detal']))
  {
?>  
...
{
  if (scFormHasChanged) {
    scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', function() { document.F4.target = "_self"; document.F4.action = "app3_add_2fa_fim.php"; document.F4.submit(); }, function() {});
  } else {
    document.F4.target = "_self";
    document.F4.action = "app3_add_2fa_fim.php";
    document.F4.submit();
  }
}
