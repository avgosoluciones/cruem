...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->sett_enable_2fa)) 
          {
              $_SESSION['sett_enable_2fa'] = $this->sett_enable_2fa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new app3_add_2fa_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['app3_add_2fa_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_add_2fa_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_add_2fa_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_add_2fa_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_add_2fa_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('app3_add_2fa_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_add_2fa_mob']['label'] = "" . $this->Ini->Nm_lang['lang_add_2fa_title'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['app3_add_2fa_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['app3_add_2fa_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_add_2fa_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_add_2fa_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_add_2fa_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'app3_add_2fa_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'app3_add_2fa_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'app3_add_2fa/app3_add_2fa_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "app3_add_2fa_mob_erro.class.php"); 
      }
      $this->Erro      = new app3_add_2fa_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['app3_add_2fa']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['send_sms'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['botoes']['send_sms'];
          $this->nmgp_botoes['send_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['botoes']['send_email'];
          $this->nmgp_botoes['reset'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['botoes']['reset'];
          $this->nmgp_botoes['submit_ajax'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['botoes']['submit_ajax'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['app3_add_2fa_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['app3_add_2fa_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->counter = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos']))
              { 
                  $help_description = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][0]; 
                  $google_auth_img = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][1]; 
                  $phone = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][2]; 
                  $code = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][3]; 
                  $counter = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][4]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][0] = $this->help_description; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][1] = $this->google_auth_img; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][2] = $this->phone; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][3] = $this->code; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['campos'][4] = $this->counter; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("app3_add_2fa_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("app3_add_2fa_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "app3_add_2fa_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="app3_add_2fa_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="app3_add_2fa_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="app3_add_2fa_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_app3_add_2fa_mob']) || !is_array($this->NM_ajax_info['errList']['geral_app3_add_2fa_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_app3_add_2fa_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_app3_add_2fa_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values_counter($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
{
$_SESSION['scriptcase']['app3_add_2fa_mob']['contr_erro'] = 'on';
...
$this->sc_btn_disabled("submit_ajax", "off");

$this->nmgp_cmp_hidden["code"] = 'on'; $this->NM_ajax_info['fieldDisplay']['code'] = 'on';
$this->nmgp_cmp_hidden["counter"] = 'on'; $this->NM_ajax_info['fieldDisplay']['counter'] = 'on';
...
$modificado_counter = $this->counter;
$modificado_phone = $this->phone;
$this->nm_formatar_campos('code', 'counter', 'phone');
...
if ($original_counter !== $modificado_counter || isset($this->nmgp_cmp_readonly['counter']) || (isset($bFlagRead_counter) && $bFlagRead_counter))
{
    $this->ajax_return_values_counter(true);
}
...
$modificado_code = $this->code;
$modificado_counter = $this->counter;
$this->nm_formatar_campos('code', 'counter');
if ($original_code !== $modificado_code || isset($this->nmgp_cmp_readonly['code']) || (isset($bFlagRead_code) && $bFlagRead_code))
{
    $this->ajax_return_values_code(true);
}
...
if ($result) {
  if(!isset($this->sc_temp_redir_menu) || $this->sc_temp_redir_menu != 1){
    ...
    $this->nmgp_cmp_hidden["counter"] = 'off'; $this->NM_ajax_info['fieldDisplay']['counter'] = 'off';
    ...
    $this->sc_btn_disabled("submit_ajax","on");
...
$modificado_code = $this->code;
$modificado_phone = $this->phone;
$modificado_google_auth_img = $this->google_auth_img;
$modificado_counter = $this->counter;
$modificado_help_description = $this->help_description;
$this->nm_formatar_campos('code', 'phone', 'google_auth_img', 'counter', 'help_description');
if ($original_code !== $modificado_code || isset($this->nmgp_cmp_readonly['code']) || (isset($bFlagRead_code) && $bFlagRead_code))
{
    $this->ajax_return_values_code(true);
}
...
if ($original_google_auth_img !== $modificado_google_auth_img || isset($this->nmgp_cmp_readonly['google_auth_img']) || (isset($bFlagRead_google_auth_img) && $bFlagRead_google_auth_img))
{
...
if ($original_help_description !== $modificado_help_description || isset($this->nmgp_cmp_readonly['help_description']) || (isset($bFlagRead_help_description) && $bFlagRead_help_description))
{
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
if( $this->sc_temp_sett_enable_2fa == 'N'){
	$this->help_description  =  $this->Ini->Nm_lang['lang_sec_2fa_disable_desc'] ;
	$this->NM_ajax_info['buttonDisplay']['submit_ajax'] = $this->nmgp_botoes["submit_ajax"] = 'off';;
...
else
{
	...
	if(!empty($this->rs[0][0])){
		...
		if($this->sc_temp_sett_enable_2fa_mode != 'all'){
			$this->help_description  =  $this->Ini->Nm_lang['lang_sec_2fa_reset_desc'] ;
		}
		else{
			$this->help_description  =  $this->Ini->Nm_lang['lang_sec_2fa_reset_mode_all_desc'] ;
			$this->NM_ajax_info['buttonDisplay']['reset'] = $this->nmgp_botoes["reset"] = 'off';;
		}
	}
	else{
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_counter != $this->counter || (isset($bFlagRead_counter) && $bFlagRead_counter)))
    {
        $this->ajax_return_values_counter(true);
    }
...
$_SESSION['scriptcase']['app3_add_2fa_mob']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("app3_add_2fa_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "app3_add_2fa_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "app3_add_2fa_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_btn_disabled($buttonName, $buttonState)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['btn_disabled'][$buttonName] = $buttonState;
    } // sc_btn_disabled
    ...
    function sc_btn_label($buttonName, $buttonLabel)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['btn_label'][$buttonName] = $buttonLabel;
    } // sc_btn_label
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_add_2fa_mob']['ordem_ord'] == " desc") {
