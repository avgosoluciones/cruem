  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_change_pswd" == sTestField)
        {
...
?>
  ...
  function do_ajax_app3_change_pswd_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldHidden(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_change_pswd_validate_description(var_description, var_script_case_init, do_ajax_app3_change_pswd_validate_description_cb);
  } // do_ajax_app3_change_pswd_validate_description

  function do_ajax_app3_change_pswd_validate_description_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_change_pswd_validate_description_cb

  // ---------- Validate old_pswd
  function do_ajax_app3_change_pswd_validate_old_pswd()
  {
    var nomeCampo_old_pswd = "old_pswd";
    var var_old_pswd = scAjaxGetFieldText(nomeCampo_old_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_change_pswd_validate_old_pswd(var_old_pswd, var_script_case_init, do_ajax_app3_change_pswd_validate_old_pswd_cb);
  } // do_ajax_app3_change_pswd_validate_old_pswd

  function do_ajax_app3_change_pswd_validate_old_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_change_pswd_validate_old_pswd_cb

  // ---------- Validate pswd
  function do_ajax_app3_change_pswd_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_change_pswd_validate_pswd(var_pswd, var_script_case_init, do_ajax_app3_change_pswd_validate_pswd_cb);
  } // do_ajax_app3_change_pswd_validate_pswd

  function do_ajax_app3_change_pswd_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_change_pswd_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_app3_change_pswd_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_change_pswd_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_app3_change_pswd_validate_confirm_pswd_cb);
  } // do_ajax_app3_change_pswd_validate_confirm_pswd

  function do_ajax_app3_change_pswd_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_change_pswd_validate_confirm_pswd_cb

  // ---------- Validate pswd_rules
  function do_ajax_app3_change_pswd_validate_pswd_rules()
  {
    var nomeCampo_pswd_rules = "pswd_rules";
    var var_pswd_rules = scAjaxGetFieldHidden(nomeCampo_pswd_rules);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_change_pswd_validate_pswd_rules(var_pswd_rules, var_script_case_init, do_ajax_app3_change_pswd_validate_pswd_rules_cb);
  } // do_ajax_app3_change_pswd_validate_pswd_rules

  function do_ajax_app3_change_pswd_validate_pswd_rules_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_change_pswd_validate_pswd_rules_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_change_pswd_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_change_pswd_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_change_pswd_submit_form(var_description, var_old_pswd, var_pswd, var_confirm_pswd, var_pswd_rules, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_change_pswd_submit_form_cb);
  } // do_ajax_app3_change_pswd_submit_form

  function do_ajax_app3_change_pswd_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_change_pswd_submit_form_cb_after_alert);
  } // do_ajax_app3_change_pswd_submit_form_cb
  function do_ajax_app3_change_pswd_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_change_pswd_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_change_pswd_navigate_form()
  {
    perform_ajax_app3_change_pswd_navigate_form();
  }

  function perform_ajax_app3_change_pswd_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app3_change_pswd_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_change_pswd']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_change_pswd_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_change_pswd_navigate_form_cb_after_alert);
  } // do_ajax_app3_change_pswd_navigate_form_cb
  function do_ajax_app3_change_pswd_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app3_change_pswd_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_change_pswd_navigate_form_cb_after_alert

  function sc_hide_app3_change_pswd_form()
  {
