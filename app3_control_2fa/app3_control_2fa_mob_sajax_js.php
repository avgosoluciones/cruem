  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_control_2fa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app3_control_2fa_mob_form();
        }
...
?>
  ...
  function do_ajax_app3_control_2fa_mob_validate_help_description()
  {
    ...
    x_ajax_app3_control_2fa_mob_validate_help_description(var_help_description, var_script_case_init, do_ajax_app3_control_2fa_mob_validate_help_description_cb);
  } // do_ajax_app3_control_2fa_mob_validate_help_description

  function do_ajax_app3_control_2fa_mob_validate_help_description_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_control_2fa_mob_validate_help_description_cb

  // ---------- Validate code
  function do_ajax_app3_control_2fa_mob_validate_code()
  {
    var nomeCampo_code = "code";
    var var_code = scAjaxGetFieldText(nomeCampo_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_control_2fa_mob_validate_code(var_code, var_script_case_init, do_ajax_app3_control_2fa_mob_validate_code_cb);
  } // do_ajax_app3_control_2fa_mob_validate_code

  function do_ajax_app3_control_2fa_mob_validate_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "code";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_control_2fa_mob_validate_code_cb

  // ---------- Validate counter
  function do_ajax_app3_control_2fa_mob_validate_counter()
  {
    var nomeCampo_counter = "counter";
    var var_counter = scAjaxGetFieldHidden(nomeCampo_counter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_control_2fa_mob_validate_counter(var_counter, var_script_case_init, do_ajax_app3_control_2fa_mob_validate_counter_cb);
  } // do_ajax_app3_control_2fa_mob_validate_counter

  function do_ajax_app3_control_2fa_mob_validate_counter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "counter";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_control_2fa_mob_validate_counter_cb

  // ---------- Event onclick scajaxbutton_resend
  function do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick(var_script_case_init, do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick_cb);
  } // do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick

  function do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick_cb_after_alert);
  } // do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick_cb
  function do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_control_2fa_mob_event_scajaxbutton_resend_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_submit_ajax
  function do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick()
  {
    var var_code = scAjaxGetFieldText("code");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick(var_code, var_script_case_init, do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick_cb);
  } // do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick

  function do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick_cb_after_alert);
  } // do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick_cb
  function do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_control_2fa_mob_event_scajaxbutton_submit_ajax_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_control_2fa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_control_2fa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_control_2fa_mob_submit_form(var_help_description, var_code, var_counter, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_control_2fa_mob_submit_form_cb);
  } // do_ajax_app3_control_2fa_mob_submit_form

  function do_ajax_app3_control_2fa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_control_2fa_mob_submit_form_cb_after_alert);
  } // do_ajax_app3_control_2fa_mob_submit_form_cb
  function do_ajax_app3_control_2fa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_control_2fa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_control_2fa_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_app3_control_2fa_mob_navigate_form, function() {});
    } else {
      perform_ajax_app3_control_2fa_mob_navigate_form();
    }
  }

  function perform_ajax_app3_control_2fa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app3_control_2fa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_control_2fa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_control_2fa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_control_2fa_mob_navigate_form_cb_after_alert);
  } // do_ajax_app3_control_2fa_mob_navigate_form_cb
  function do_ajax_app3_control_2fa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app3_control_2fa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_control_2fa_mob_navigate_form_cb_after_alert

  function sc_hide_app3_control_2fa_mob_form()
  {
