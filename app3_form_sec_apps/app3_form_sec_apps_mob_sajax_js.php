  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_form_sec_apps_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app3_form_sec_apps_mob_form();
        }
...
?>
  ...
  // ---------- Validate app_name
  function do_ajax_app3_form_sec_apps_mob_validate_app_name()
  {
    var nomeCampo_app_name = "app_name";
    var var_app_name = scAjaxGetFieldText(nomeCampo_app_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_apps_mob_validate_app_name(var_app_name, var_script_case_init, do_ajax_app3_form_sec_apps_mob_validate_app_name_cb);
  } // do_ajax_app3_form_sec_apps_mob_validate_app_name

  function do_ajax_app3_form_sec_apps_mob_validate_app_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_apps_mob_validate_app_name_cb

  // ---------- Validate description
  function do_ajax_app3_form_sec_apps_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_apps_mob_validate_description(var_description, var_script_case_init, do_ajax_app3_form_sec_apps_mob_validate_description_cb);
  } // do_ajax_app3_form_sec_apps_mob_validate_description

  function do_ajax_app3_form_sec_apps_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_apps_mob_validate_description_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_form_sec_apps_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_form_sec_apps_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_form_sec_apps_mob_submit_form(var_app_name, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_form_sec_apps_mob_submit_form_cb);
  } // do_ajax_app3_form_sec_apps_mob_submit_form

  function do_ajax_app3_form_sec_apps_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_form_sec_apps_mob_submit_form_cb_after_alert);
  } // do_ajax_app3_form_sec_apps_mob_submit_form_cb
  function do_ajax_app3_form_sec_apps_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_form_sec_apps_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_form_sec_apps_mob_navigate_form()
  {
    perform_ajax_app3_form_sec_apps_mob_navigate_form();
  }

  function perform_ajax_app3_form_sec_apps_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_app3_form_sec_apps_mob_navigate_form(var_app_name, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app3_form_sec_apps_mob_navigate_form_cb);
  } // do_ajax_app3_form_sec_apps_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_apps_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_form_sec_apps_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_form_sec_apps_mob_navigate_form_cb_after_alert);
  } // do_ajax_app3_form_sec_apps_mob_navigate_form_cb
  function do_ajax_app3_form_sec_apps_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app3_form_sec_apps_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_form_sec_apps_mob_navigate_form_cb_after_alert

  function sc_hide_app3_form_sec_apps_mob_form()
  {
