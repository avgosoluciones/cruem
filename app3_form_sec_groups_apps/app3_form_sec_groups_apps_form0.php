<?php
class app3_form_sec_groups_apps_form extends app3_form_sec_groups_apps_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . " - " . $this->Ini->Nm_lang['lang_sec_group'] . ": " . $_SESSION['group_desc'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . " - " . $this->Ini->Nm_lang['lang_sec_group'] . ": " . $_SESSION['group_desc'] . ""); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['sc_redir_atualiz'] == 'ok')
{
?>
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app3_form_sec_groups_apps/app3_form_sec_groups_apps_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("app3_form_sec_groups_apps_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('app3_form_sec_groups_apps_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['link_info']['remove_border']) {
...
<?php
 include_once("app3_form_sec_groups_apps_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['app3_form_sec_groups_apps'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['app3_form_sec_groups_apps'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['last'];
        }
?>
...
<?php 
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['fast_search'][2] : "";
...
<?php
 ...
 ?>
   ...
   <?php }?>
    ...
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult sc-col-title"  width="10"> <?php echo $this->Ini->Nm_lang['lang_othr_slct_item'] ?><br /><input type="checkbox" class="sc-ui-checkbox-all-all" name="" /> </TD>
...
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_app_name__label sc-col-title" id="hidden_field_label_app_name_" style="<?php echo $sStyleHidden_app_name_; ?>" > <?php echo $label_final ?> </TD>
   <?php
...
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['description_']) || $this->nmgp_cmp_hidden['description_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_description__label sc-col-title" id="hidden_field_label_description_" style="<?php echo $sStyleHidden_description_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_access_']) || $this->nmgp_cmp_hidden['priv_access_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_priv_access__label sc-col-title" id="hidden_field_label_priv_access_" style="<?php echo $sStyleHidden_priv_access_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_insert_']) || $this->nmgp_cmp_hidden['priv_insert_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_priv_insert__label sc-col-title" id="hidden_field_label_priv_insert_" style="<?php echo $sStyleHidden_priv_insert_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_delete_']) || $this->nmgp_cmp_hidden['priv_delete_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_priv_delete__label sc-col-title" id="hidden_field_label_priv_delete_" style="<?php echo $sStyleHidden_priv_delete_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_update_']) || $this->nmgp_cmp_hidden['priv_update_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_priv_update__label sc-col-title" id="hidden_field_label_priv_update_" style="<?php echo $sStyleHidden_priv_update_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_export_']) || $this->nmgp_cmp_hidden['priv_export_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_priv_export__label sc-col-title" id="hidden_field_label_priv_export_" style="<?php echo $sStyleHidden_priv_export_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['priv_print_']) || $this->nmgp_cmp_hidden['priv_print_'] == 'on') {
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_priv_print__label sc-col-title" id="hidden_field_label_priv_print_" style="<?php echo $sStyleHidden_priv_print_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_app3_form_sec_groups_apps);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_app3_form_sec_groups_apps = $this->form_vert_app3_form_sec_groups_apps;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_app3_form_sec_groups_apps))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_app3_form_sec_groups_apps as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->group_id_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['group_id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->app_name_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['app_name_']; 
       ...
       $this->description_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['description_']; 
       ...
       $this->priv_access_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['priv_access_']; 
       ...
       $this->priv_insert_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['priv_insert_']; 
       ...
       $this->priv_delete_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['priv_delete_']; 
       ...
       $this->priv_update_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['priv_update_']; 
       ...
       $this->priv_export_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['priv_export_']; 
       ...
       $this->priv_print_ = $this->form_vert_app3_form_sec_groups_apps[$sc_seq_vert]['priv_print_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_app3_form_sec_groups_apps_add_new_line(" . $sc_seq_vert . ")", "do_ajax_app3_form_sec_groups_apps_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_app3_form_sec_groups_apps_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_app3_form_sec_groups_apps_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_app3_form_sec_groups_apps_cancel_update(" . $sc_seq_vert . ")", "do_ajax_app3_form_sec_groups_apps_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "");?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_description__line" id="hidden_field_data_description_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_description_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_description__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="description_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($description_); ?>"><span id="id_ajax_label_description_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($description_); ?></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y'; ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_app3_form_sec_groups_apps = $guarda_form_vert_app3_form_sec_groups_apps;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['balterarsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['balterarsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['balterarsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['balterarsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['balterarsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("app3_form_sec_groups_apps");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("app3_form_sec_groups_apps");
 parent.scAjaxDetailHeight("app3_form_sec_groups_apps", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
