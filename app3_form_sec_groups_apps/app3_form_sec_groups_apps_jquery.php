...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_group_id_' + iSeqRow).bind('change', function() { sc_app3_form_sec_groups_apps_group_id__onchange(this, iSeqRow) });
  $('#id_sc_field_app_name_' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app3_form_sec_groups_apps_app_name__onblur('#id_sc_field_app_name_' + iSeqRow, iSeqRow);}, 300) })
                                       .bind('change', function() { sc_app3_form_sec_groups_apps_app_name__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_app3_form_sec_groups_apps_app_name__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_access_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_priv_access__onblur('#id_sc_field_priv_access_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app3_form_sec_groups_apps_priv_access__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app3_form_sec_groups_apps_priv_access__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_insert_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_priv_insert__onblur('#id_sc_field_priv_insert_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app3_form_sec_groups_apps_priv_insert__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app3_form_sec_groups_apps_priv_insert__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_delete_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_priv_delete__onblur('#id_sc_field_priv_delete_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app3_form_sec_groups_apps_priv_delete__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app3_form_sec_groups_apps_priv_delete__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_update_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_priv_update__onblur('#id_sc_field_priv_update_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app3_form_sec_groups_apps_priv_update__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app3_form_sec_groups_apps_priv_update__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_export_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_priv_export__onblur('#id_sc_field_priv_export_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app3_form_sec_groups_apps_priv_export__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app3_form_sec_groups_apps_priv_export__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_print_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_priv_print__onblur('#id_sc_field_priv_print_' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_app3_form_sec_groups_apps_priv_print__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_app3_form_sec_groups_apps_priv_print__onfocus(this, iSeqRow) });
  $('#id_sc_field_description_' + iSeqRow).bind('blur', function() { sc_app3_form_sec_groups_apps_description__onblur('#id_sc_field_description_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app3_form_sec_groups_apps_description__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app3_form_sec_groups_apps_description__onfocus(this, iSeqRow) });
...
function sc_app3_form_sec_groups_apps_group_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app3_form_sec_groups_apps_app_name__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_app_name_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_app_name__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_app_name__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_access__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_priv_access_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_access__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_access__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_insert__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_priv_insert_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_insert__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_insert__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_delete__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_priv_delete_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_delete__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_delete__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_update__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_priv_update_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_update__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_update__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_export__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_priv_export_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_export__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_export__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_print__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_priv_print_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_print__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_priv_print__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_description__onblur(oThis, iSeqRow) {
  do_ajax_app3_form_sec_groups_apps_validate_description_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app3_form_sec_groups_apps_description__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app3_form_sec_groups_apps_description__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
        $("#id_app3_form_sec_groups_apps_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'app3_form_sec_groups_apps')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
