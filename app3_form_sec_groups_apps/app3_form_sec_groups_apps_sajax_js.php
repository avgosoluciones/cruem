  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_form_sec_groups_apps" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app3_form_sec_groups_apps_form();
        }
...
?>
  ...
  // ---------- Validate app_name_
  function do_ajax_app3_form_sec_groups_apps_validate_app_name_(iNumLinha)
  {
  } // do_ajax_app3_form_sec_groups_apps_validate_app_name_

  function do_ajax_app3_form_sec_groups_apps_validate_app_name__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_app_name__cb

  // ---------- Validate description_
  function do_ajax_app3_form_sec_groups_apps_validate_description_(iNumLinha)
  {
    var nomeCampo_description_ = "description_" + iNumLinha;
    var var_description_ = scAjaxGetFieldHidden(nomeCampo_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_description__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_description_

  function do_ajax_app3_form_sec_groups_apps_validate_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_description__cb

  // ---------- Validate priv_access_
  function do_ajax_app3_form_sec_groups_apps_validate_priv_access_(iNumLinha)
  {
    var nomeCampo_priv_access_ = "priv_access_" + iNumLinha;
    var var_priv_access_ = scAjaxGetFieldCheckbox(nomeCampo_priv_access_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_priv_access_(var_priv_access_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_priv_access__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_access_

  function do_ajax_app3_form_sec_groups_apps_validate_priv_access__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_access__cb

  // ---------- Validate priv_insert_
  function do_ajax_app3_form_sec_groups_apps_validate_priv_insert_(iNumLinha)
  {
    var nomeCampo_priv_insert_ = "priv_insert_" + iNumLinha;
    var var_priv_insert_ = scAjaxGetFieldCheckbox(nomeCampo_priv_insert_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_priv_insert_(var_priv_insert_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_priv_insert__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_insert_

  function do_ajax_app3_form_sec_groups_apps_validate_priv_insert__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_insert__cb

  // ---------- Validate priv_delete_
  function do_ajax_app3_form_sec_groups_apps_validate_priv_delete_(iNumLinha)
  {
    var nomeCampo_priv_delete_ = "priv_delete_" + iNumLinha;
    var var_priv_delete_ = scAjaxGetFieldCheckbox(nomeCampo_priv_delete_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_priv_delete_(var_priv_delete_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_priv_delete__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_delete_

  function do_ajax_app3_form_sec_groups_apps_validate_priv_delete__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_delete__cb

  // ---------- Validate priv_update_
  function do_ajax_app3_form_sec_groups_apps_validate_priv_update_(iNumLinha)
  {
    var nomeCampo_priv_update_ = "priv_update_" + iNumLinha;
    var var_priv_update_ = scAjaxGetFieldCheckbox(nomeCampo_priv_update_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_priv_update_(var_priv_update_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_priv_update__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_update_

  function do_ajax_app3_form_sec_groups_apps_validate_priv_update__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_update__cb

  // ---------- Validate priv_export_
  function do_ajax_app3_form_sec_groups_apps_validate_priv_export_(iNumLinha)
  {
    var nomeCampo_priv_export_ = "priv_export_" + iNumLinha;
    var var_priv_export_ = scAjaxGetFieldCheckbox(nomeCampo_priv_export_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_priv_export_(var_priv_export_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_priv_export__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_export_

  function do_ajax_app3_form_sec_groups_apps_validate_priv_export__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_export__cb

  // ---------- Validate priv_print_
  function do_ajax_app3_form_sec_groups_apps_validate_priv_print_(iNumLinha)
  {
    var nomeCampo_priv_print_ = "priv_print_" + iNumLinha;
    var var_priv_print_ = scAjaxGetFieldCheckbox(nomeCampo_priv_print_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_validate_priv_print_(var_priv_print_, iNumLinha, var_script_case_init, do_ajax_app3_form_sec_groups_apps_validate_priv_print__cb);
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_print_

  function do_ajax_app3_form_sec_groups_apps_validate_priv_print__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_form_sec_groups_apps_validate_priv_print__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_app3_form_sec_groups_apps_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_app3_form_sec_groups_apps_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_form_sec_groups_apps_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_app3_form_sec_groups_apps_add_new_line_cb);
  } // do_ajax_app3_form_sec_groups_apps_add_new_line

  function do_ajax_app3_form_sec_groups_apps_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_app3_form_sec_groups_apps_add_new_line_cb

  // ---------- backup_line
  function do_ajax_app3_form_sec_groups_apps_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_form_sec_groups_apps_backup_line(var_group_id_, var_app_name_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_app3_form_sec_groups_apps_backup_line_cb);
  } // do_ajax_app3_form_sec_groups_apps_backup_line

  function do_ajax_app3_form_sec_groups_apps_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_app3_form_sec_groups_apps_backup_line_cb

  function do_ajax_app3_form_sec_groups_apps_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_app3_form_sec_groups_apps_cancel_insert

  function do_ajax_app3_form_sec_groups_apps_cancel_update(iSeqVert)
  {
    do_ajax_app3_form_sec_groups_apps_backup_line(iSeqVert);
...
?>
  } // do_ajax_app3_form_sec_groups_apps_cancel_update

  function do_ajax_app3_form_sec_groups_apps_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_app3_form_sec_groups_apps_restore_buttons

  // ---------- table_refresh
  function do_ajax_app3_form_sec_groups_apps_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_app3_form_sec_groups_apps_table_refresh(var_group_id_, var_app_name_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app3_form_sec_groups_apps_table_refresh_cb);
  } //  do_ajax_app3_form_sec_groups_apps_table_refresh

  function do_ajax_app3_form_sec_groups_apps_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_app3_form_sec_groups_apps_table_refresh_cb_after_alert);
  } // do_ajax_app3_form_sec_groups_apps_table_refresh_cb
  function do_ajax_app3_form_sec_groups_apps_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_app3_form_sec_groups_apps_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_app3_form_sec_groups_apps_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_app3_form_sec_groups_apps_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_app3_form_sec_groups_apps_submit_form(var_app_name_, var_description_, var_priv_access_, var_priv_insert_, var_priv_delete_, var_priv_update_, var_priv_export_, var_priv_print_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_form_sec_groups_apps_submit_form_cb);
  } // do_ajax_app3_form_sec_groups_apps_submit_form

  function do_ajax_app3_form_sec_groups_apps_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_form_sec_groups_apps_submit_form_cb_after_alert);
  } // do_ajax_app3_form_sec_groups_apps_submit_form_cb
  function do_ajax_app3_form_sec_groups_apps_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_form_sec_groups_apps_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_form_sec_groups_apps_navigate_form()
  {
    perform_ajax_app3_form_sec_groups_apps_navigate_form();
  }

  function perform_ajax_app3_form_sec_groups_apps_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app3_form_sec_groups_apps_navigate_form(var_group_id_, var_app_name_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app3_form_sec_groups_apps_navigate_form_cb);
  } // do_ajax_app3_form_sec_groups_apps_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_form_sec_groups_apps']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_form_sec_groups_apps_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_form_sec_groups_apps_navigate_form_cb_after_alert);
  } // do_ajax_app3_form_sec_groups_apps_navigate_form_cb
  function do_ajax_app3_form_sec_groups_apps_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_app3_form_sec_groups_apps_navigate_form_cb_after_alert

    function sc_app3_form_sec_groups_apps_get_last_line_number()
    {
    ...
    } //sc_app3_form_sec_groups_apps_get_last_line_number

  function sc_hide_app3_form_sec_groups_apps_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["description_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_app_description'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["app_name_" + iRow] || "on" == ajax_error_count["description_" + iRow] || "on" == ajax_error_count["priv_access_" + iRow] || "on" == ajax_error_count["priv_insert_" + iRow] || "on" == ajax_error_count["priv_delete_" + iRow] || "on" == ajax_error_count["priv_update_" + iRow] || "on" == ajax_error_count["priv_export_" + iRow] || "on" == ajax_error_count["priv_print_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["app_name_" + iRow] && "off" == ajax_error_count["description_" + iRow] && "off" == ajax_error_count["priv_access_" + iRow] && "off" == ajax_error_count["priv_insert_" + iRow] && "off" == ajax_error_count["priv_delete_" + iRow] && "off" == ajax_error_count["priv_update_" + iRow] && "off" == ajax_error_count["priv_export_" + iRow] && "off" == ajax_error_count["priv_print_" + iRow]))
    {
      if (bErrorRow)
      {
