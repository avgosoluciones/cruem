...
*/
    ...
    $SC_cod_proj = "CRUE";
    $SC_apl_proc = "app3_grid_sec_apps";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_apps']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['app3_grid_sec_apps']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_apps']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['app3_grid_sec_apps']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['app3_grid_sec_apps']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['app3_grid_sec_apps']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_apps']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['app3_grid_sec_apps']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['app3_grid_sec_apps']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['app3_grid_sec_apps']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
