<?php
@session_start() ;
$_SESSION['scriptcase']['app3_grid_sec_groups']['sc_process_barr'] = true;
require_once('../app3_grid_sec_groups/index.php');
unset($_SESSION['scriptcase']['app3_grid_sec_groups']['sc_process_barr']);
$ExportCtrl = new app3_grid_sec_groups_export_control;
$ExportCtrl->Export_barr();

class app3_grid_sec_groups_export_control
{
