...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____app3_grid_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____app3_grid_sec_users"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>app3_grid_sec_users</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users']['embutida_filho'] as $ind => $sc_init)
          {
