...
function ajax_navigate(opc, parm, Fade='S')
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_app3_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_app3_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_app3_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_app3_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_app3_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_app3_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_app3_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_app3_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_app3_grid_sec_users').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_app3_grid_sec_users').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_app3_grid_sec_users').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_app3_grid_sec_users').style.width  = '0px';
        }
        if (oResp["setValue"]) {
