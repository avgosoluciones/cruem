...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____app3_grid_sec_users_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____app3_grid_sec_users_groups"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['app3_form_edit_users'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>app3_grid_sec_users_groups</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['app3_grid_sec_users_groups']['embutida_filho'] as $ind => $sc_init)
          {
