...
<?php
   ...
   $Ord_Cmp = new app3_grid_sec_users_groups_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class app3_grid_sec_users_groups_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["login"] : "" . $this->Nm_lang['lang_sec_users_fild_login'] . "";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["name"] : "" . $this->Nm_lang['lang_sec_users_fild_name'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["email"] : "" . $this->Nm_lang['lang_sec_users_fild_email'] . "";
   $tab_ger_campos['active'] = "on";
   $tab_def_campos['active'] = "active";
   $tab_labels["active"]   = (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["active"])) ? $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['labels']["active"] : "" . $this->Nm_lang['lang_sec_users_fild_active'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "app3_grid_sec_users_groups_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['app3_grid_sec_users_groups']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
