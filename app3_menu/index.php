<?php
include_once('app3_menu_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['app3_menu']['glo_nm_perfil']         = "conn_mysql";
    $_SESSION['scriptcase']['app3_menu']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['app3_menu']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['app3_menu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class app3_menu_class
{
  var $Db;
 ...
 function app3_menu_menu()
 {
    global $app3_menu_menuData, $nm_data_fixa;
 ...
 if (isset($_REQUEST["ajax_notif_request"]))    { 
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['app3_menu']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "app3_menu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_imag_temp'];
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/app3_menu_erro.php");
}
include_once(dirname(__FILE__) . "/app3_menu_erro.class.php"); 
$this->Erro = new app3_menu_erro();
$str_path = substr($_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['app3_menu']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$app3_menu_menuData         = array();
$app3_menu_menuData['path'] = array();
$app3_menu_menuData['url']  = array();
$app3_menu_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $app3_menu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $app3_menu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $app3_menu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $app3_menu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$app3_menu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$app3_menu_menuData['url']['web']   = str_replace("\\", '/', $app3_menu_menuData['url']['web']);
$app3_menu_menuData['path']['root'] = substr($app3_menu_menuData['path']['sys'],  0, -1 * strlen($app3_menu_menuData['url']['web']));
$app3_menu_menuData['path']['app']  = substr($app3_menu_menuData['path']['sys'],  0, strrpos($app3_menu_menuData['path']['sys'],  '/'));
$app3_menu_menuData['path']['link'] = substr($app3_menu_menuData['path']['app'],  0, strrpos($app3_menu_menuData['path']['app'],  '/'));
$app3_menu_menuData['path']['link'] = substr($app3_menu_menuData['path']['link'], 0, strrpos($app3_menu_menuData['path']['link'], '/')) . '/';
$app3_menu_menuData['path']['app'] .= '/';
$app3_menu_menuData['url']['app']   = substr($app3_menu_menuData['url']['web'],  0, strrpos($app3_menu_menuData['url']['web'],  '/'));
$app3_menu_menuData['url']['link']  = substr($app3_menu_menuData['url']['app'],  0, strrpos($app3_menu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] == "S")
{
    $app3_menu_menuData['url']['link']  = substr($app3_menu_menuData['url']['link'], 0, strrpos($app3_menu_menuData['url']['link'], '/'));
}
$app3_menu_menuData['url']['link']  .= '/';
$app3_menu_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['app3_menu']['sc_apl_link'] = $app3_menu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['app3_menu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['app3_menu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['app3_menu']['actual_lang']) || $_SESSION['scriptcase']['app3_menu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['app3_menu']['actual_lang'] = $this->str_lang;
...
include_once("app3_menu_toolbar.php");
...
if ($_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "app3_menu";
     $_SESSION['scriptcase']['menu_apls']['app3_menu'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['app3_menu']['glo_nm_conexao']) && $_SESSION['scriptcase']['app3_menu']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['app3_menu']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['app3_menu']['glo_nm_perfil']) && $_SESSION['scriptcase']['app3_menu']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['app3_menu']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['app3_menu']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['app3_menu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['app3_menu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['app3_menu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['app3_menu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['app3_menu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['app3_menu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['app3_menu']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['app3_menu']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['app3_menu']['init']))
{
    $_SESSION['sc_session'][1]['app3_menu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['app3_menu']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['app3_menu']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_app3_menu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_app3_menu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_app3_menu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['app3_menu'] = "on";
} 
if (!isset($_SESSION['scriptcase']['app3_menu']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_menu']) || $_SESSION['scriptcase']['sc_apl_seg']['app3_menu'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'app3_menu'))
{
    $_SESSION['sc_session'][1]['app3_menu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_app3_menu'] = "javascript:window.close()";
}
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_procedimiento1_ini.php");
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/dashboard_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/resumen_procedimiento_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/procedimiento_final_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_disponibilidad_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_eps_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_ciudad_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_ips_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_seguridad_social_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_servicios_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_movil_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_servicios_ips_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_medico_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_id_tipo_evento_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_barrio_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_sector_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_sc_log_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_users_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_users_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_users']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_apps_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_apps_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_apps']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_groups_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_groups_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_users_groups_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_grid_sec_users_groups_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_users_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_search_sec_groups_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_search_sec_groups_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_search_sec_groups']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['app3_search_sec_groups'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_sync_apps_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_sync_apps_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_sync_apps']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_add_2fa_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_add_2fa_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_add_2fa']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_settings_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_settings_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_settings']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_change_pswd_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_change_pswd_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_change_pswd']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['app3_change_pswd'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_my_info_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_my_info_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_my_info']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_Login_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app3_Login_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_Login']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['app3_Login'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_app3_menu'];
...
$app3_menu_menuData['data']['itens']['item_14'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  ...
                                                  'icon_check'     => "S",
                                                  'id'     => "item_14",
                                                  'target'      => $this->app3_menu_target('_self'),
...
$app3_menu_menuData['data']['itens']['item_31'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_procedimiento1&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$app3_menu_menuData['data']['itens']['item_29'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=resumen_procedimiento&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-ambulance",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'icon_check'     => "S",
                                                  'id'     => "item_29",
...
$app3_menu_menuData['data']['itens']['item_30'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_30&sc_apl_menu=procedimiento_final&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-bars",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_15'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_disponibilidad&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-hospital",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'icon_check'     => "S",
                                                  'id'     => "item_15",
...
$app3_menu_menuData['data']['itens']['item_16'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-key",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_17'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_eps&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_18'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_ciudad&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_19'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=grid_ips&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_20'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=grid_seguridad_social&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_21'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_21&sc_apl_menu=form_servicios&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_22'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_movil&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_23'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_servicios_ips&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_24'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_medico&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_25'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=form_id_tipo_evento&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_27'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_barrio&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_28'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_28&sc_apl_menu=grid_sector&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data']['itens']['item_16']['itens']['item_26'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_sc_log&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
$str_label = "" . $this->Nm_lang['lang_menu_security'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_list_users'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=app3_grid_sec_users&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_list_apps'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=app3_grid_sec_apps&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_list_groups'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=app3_grid_sec_groups&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_list_users_x_groups'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_11'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=app3_grid_sec_users_groups&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_list_apps_x_groups'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=app3_search_sec_groups&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_list_sync_apps'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_6'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=app3_sync_apps&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_2fa'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_12'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=app3_add_2fa&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_settings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_settings']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_settings'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_13'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=app3_settings&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_change_pswd'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data']['itens']['item_1']['itens']['item_7'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=app3_change_pswd&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_my_info']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_my_info']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_sec_edit_profile'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data_user']['itens']['item_user_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_user_1&sc_apl_menu=app3_my_info&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-user",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$app3_menu_menuData['data_user']['itens']['item_user_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_user_3&sc_apl_menu=app3_change_pswd&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-key",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app3_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app3_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "" . $this->Nm_lang['lang_exit'] . "";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$app3_menu_menuData['data_user']['itens']['item_user_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_user_2&sc_apl_menu=app3_Login&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$app3_menu_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$app3_menu_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$app3_menu_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$app3_menu_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$app3_menu_menuData['data_tb']['itens']['item_tb_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "app3_menu_form_php.php?sc_item_menu=item_tb_5&sc_apl_menu=notification&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-bell",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['app3_menu']))
{
    $app3_menu_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['app3_menu'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['app3_menu']))
{
    $app3_menu_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['app3_menu'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['app3_menu']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['app3_menu']))
{
    $app3_menu_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['app3_menu'];
}
if (is_file("app3_menu_help.txt"))
{
    $Arq_WebHelp = file("app3_menu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $app3_menu_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->app3_menu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['app3_menu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['app3_menu']))
{
    sc_menu_delete($app3_menu_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['app3_menu']);
    sc_menu_delete($app3_menu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['app3_menu']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['app3_menu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['app3_menu']))
{
    sc_menu_disable($app3_menu_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['app3_menu']);
    sc_menu_disable($app3_menu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['app3_menu']);
}
sc_menu_clearitens($app3_menu_menuData['data']);
sc_menu_clearitens($app3_menu_menuData['data_user']);
...
<head>
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
<script type="text/javascript">
   ...
   {
           var str_location = document.getElementById('iframe_app3_menu').contentWindow.location.toString();
...
/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['app3_menu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="app3_menu_message.js"></script>
...
<script>
        $( document ).ready(function() {
            $.contextMenu({
                ...
                items: {                        "reload" : {name: '<?php echo str_replace("'", "\'", $this->Nm_lang['lang_btns_reload']); ?>'},
                        "sep" : {type: 'cm_separator'},                        "close": {name: '<?php echo str_replace("'", "\'", $this->Nm_lang['lang_othr_contextmenu_close']); ?>'},
            ...
            $.contextMenu({
                ...
                items: {                        "reload" : {name: '<?php echo str_replace("'", "\'", $this->Nm_lang['lang_btns_reload']); ?>'},
                        "sep" : {type: 'cm_separator'},                        "closeothers" : {name: '<?php echo str_replace("'", "\'", $this->Nm_lang['lang_othr_contextmenu_closeothers']); ?>'},
                        "closeright" : {name: '<?php echo str_replace("'", "\'", $this->Nm_lang['lang_othr_contextmenu_closeright']); ?>'},
                    }
            });
        });
...
$arr_apl_default['app3_menu']['dados'] = array(
    'label'=> "",
    'hint'=> "",
    'icon_fa'=> "scriptcase__NM__ico__NM__sc_menu_home_e.png",
);
writeJsIframeControlRec($arr_apl_default, $seq, true);
if(isset($app3_menu_menuData['data']) && is_array($app3_menu_menuData['data']))
{
    foreach($app3_menu_menuData['data'] as $layer => $arr_item)
    {
...
if(isset($app3_menu_menuData['data_vertical']) && is_array($app3_menu_menuData['data_vertical']))
{
    foreach($app3_menu_menuData['data_vertical'] as $layer => $arr_item)
    {
        if(isset($arr_item['itens']) && !empty($arr_item['itens']))
        {
            writeJsIframeControlRec($arr_item['itens'], $seq);
...
if(isset($app3_menu_menuData['data_user']) && is_array($app3_menu_menuData['data_user']))
{
    foreach($app3_menu_menuData['data_user'] as $layer => $arr_item)
    {
        if(isset($arr_item['itens']) && !empty($arr_item['itens']))
        {
            writeJsIframeControlRec($arr_item['itens'], $seq);
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl, fa_ico)
{
    ...
    iframe.name = 'app3_menu_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'app3_menu'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_app3_menu').hide();
    if (str_id == "")
    {
        $('#iframe_app3_menu').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="app3_menu_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: ;" src=""></iframe>');
            }
            ...
            if (Tab_iframes[i] != 'app3_menu') 
            {
                Iframe_atual = "app3_menu_" + Tab_iframes[i] + '_iframe';
            }
...
{
  str_target_sv = "";
  if (str_id != "iframe_app3_menu")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("app3_menu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_app3_menu', 'app3_menu');
    if (str_target == "app3_menu_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        ...
        if (str_id != "app3_menu" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_app3_menu').length)
        $('#iframe_app3_menu')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->app3_menu_MenuH($app3_menu_menuData, $path_imag_cab, $strAlign); ?>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_app3_menu');\" item-href=\"app3_menu_form_php.php?sc_item_menu=app3_menu&sc_apl_menu=form_procedimiento1&sc_apl_link=" . urlencode($app3_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'] . "\"  item-target=\"app3_menu_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "app3_menu_pag_ini.php");
} 
?>
      <iframe id="iframe_app3_menu" name="app3_menu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
...
function writeHtmlIframeControlRec($arr_itens)
{
    ...
    {
        ?>
        <iframe id="iframe_<?php echo $id; ?>" name="app3_menu_<?php echo $id; ?>_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: ;" src=""></iframe>
        <?php
        if(isset($item['itens']) && !empty($item['itens']))
        {
...
function app3_menu_Header()
{
?>
    
<?php
}function app3_menu_MenuH($app3_menu_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->app3_menu_escreveMenu($app3_menu_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function app3_menu_Footer()
{
?>
    
<?php
}
function app3_menu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"dark-cobalt","layout":"V","usercheck":"S","username":"\" . $_SESSION[\'usr_name\'] . \"","userimage":"\" . $_SESSION[\'usr_picture\'] . \"","userdesc":"\" . $_SESSION[\'usr_login\'] . \" \/ \" . $_SESSION[\'usr_email\'] . \" \/ \" . $_SESSION[\'usr_phone\'] . \"","logo":"","logo_compact":"","items":[{"text":"Tablero de control","app":"dashboard","icon":"fas fa-chart-line","icon_check":"S","id":"item_14","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Nueva Emergencia","app":"form_procedimiento1","icon":"far fa-hospital","icon_check":"S","id":"item_31","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Procedimientos","app":"resumen_procedimiento","icon":"fas fa-ambulance","icon_check":"S","id":"item_29","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Registro Multiple","app":"procedimiento_final","icon":"fas fa-bars","icon_check":"S","id":"item_30","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Disponibilidades","app":"grid_disponibilidad","icon":"fas fa-hospital","icon_check":"S","id":"item_15","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Configuraci\u00f3n","app":"","icon":"fas fa-key","icon_check":"S","id":"item_16","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Eps","app":"grid_eps","icon":"fas fa-file","icon_check":"S","id":"item_17","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Ciudad","app":"grid_ciudad","icon":"fas fa-file","icon_check":"S","id":"item_18","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Ips","app":"grid_ips","icon":"fas fa-file","icon_check":"S","id":"item_19","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Seguridad Social","app":"grid_seguridad_social","icon":"fas fa-file","icon_check":"S","id":"item_20","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Servicios","app":"form_servicios","icon":"fas fa-file","icon_check":"S","id":"item_21","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Ambulancias","app":"grid_movil","icon":"fas fa-file","icon_check":"S","id":"item_22","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Servicios IPS","app":"grid_servicios_ips","icon":"fas fa-file","icon_check":"S","id":"item_23","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Medicos","app":"grid_medico","icon":"fas fa-file","icon_check":"S","id":"item_24","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Tipo de evento|","app":"form_id_tipo_evento","icon":"fas fa-file","icon_check":"S","id":"item_25","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Barrios","app":"grid_barrio","icon":"fas fa-file","icon_check":"S","id":"item_27","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Zona","app":"grid_sector","icon":"fas fa-file","icon_check":"S","id":"item_28","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Logs de eventos","app":"grid_sc_log","icon":"fas fa-file","icon_check":"S","id":"item_26","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"},{"text":"{lang_menu_security}","app":"","icon":"fas fa-cog","icon_check":"S","id":"item_1","link_target":"self","fav_check":"N","hint":"","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"{lang_list_users}","app":"app3_grid_sec_users","icon":"fas fa-cog","icon_check":"S","id":"item_2","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":""},{"text":"{lang_list_apps}","app":"app3_grid_sec_apps","icon":"fas fa-cog","icon_check":"S","id":"item_3","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":""},{"text":"{lang_list_groups}","app":"app3_grid_sec_groups","icon":"fas fa-cog","icon_check":"S","id":"item_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"{lang_list_users_x_groups}","app":"app3_grid_sec_users_groups","icon":"fas fa-cog","icon_check":"S","id":"item_11","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":""},{"text":"{lang_list_apps_x_groups}","app":"app3_search_sec_groups","icon":"fas fa-cog","icon_check":"S","id":"item_5","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":""},{"text":"{lang_list_sync_apps}","app":"app3_sync_apps","icon":"fas fa-cog","icon_check":"S","id":"item_6","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"{lang_2fa}","app":"app3_add_2fa","icon":"fas fa-cog","icon_check":"S","id":"item_12","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"{lang_settings}","app":"app3_settings","icon":"fas fa-cog","icon_check":"S","id":"item_13","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"{lang_change_pswd}","app":"app3_change_pswd","icon":"fas fa-cog","icon_check":"S","id":"item_7","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"}],"user_items":[{"text":"{lang_sec_edit_profile}","app":"app3_my_info","icon":"fas fa-user","icon_check":"S","id":"item_user_1","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"},{"text":"{lang_change_pswd}","app":"app3_change_pswd","icon":"fas fa-key","icon_check":"S","id":"item_user_3","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"},{"text":"{lang_exit}","app":"app3_Login","icon":"fas fa-sign-out-alt","icon_check":"S","id":"item_user_2","hint":"","link_target":"parente","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N"}],"tb_items":[{"text":"B\u00fasqueda","app":"search","icon":"fas fa-search","icon_check":"S","display":"S","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"S","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"S","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Atajos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"S","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"},{"text":"Notificaciones","app":"notification","icon":"fas fa-bell","icon_check":"S","display":"N","id":"item_tb_5","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","link_target":"self"}],"shortcuts":[],"pick_themes":["dark-cobalt","dark-coffee","dark-sunset","dark-rhino","dark-pink","dark-hyper-space","light-gray","monochromatic-blue"],"check_split":"N","check_toolbar":"S","layout_usr_pos":"out","check_show_search_path":"S","header_string":"","header_string_pos":"H","check_shortcut_label":"S","check_start_expanded":"S","check_use_loader":"S","should_reload":"S","notif_login_var":"\" . $_SESSION[\'usr_login\'] . \"","notif_data":{"notif_table":"notif_notifications","notif_id":"notif_id","notif_title":"notif_title","notif_message":"notif_message","notif_dtexpire":"notif_dtexpire","notif_login_sender":"notif_login_sender","notif_categ":"notif_categ","inbox_table":"notif_inbox","inbox_field_notif_id":"notif_id","inbox_field_ontop":"notif_ontop","inbox_field_userid":"login","inbox_field_isread":"notif_isread","inbox_field_read_date":"notif_dtread","inbox_field_sent_date":"notif_dtsent","inbox_field_tag":"notif_tags","notif_connection":"conn_mysql"},"font_string":"Open Sans","notif_open_all_app":"","notif_refresh_interval":"10000","notif_limit":"10"}', true);
    ...
    $apl_link_build = "app3_menu_form_php.php?sc_item_menu=notif_app_link&sc_apl_menu=###APPNAME###&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'];

    $apl_default = 'form_procedimiento1';
    $apl_name_ref_sc = 'app3_menu';
    if (isset($_SESSION['scriptcase']['sc_apl_seg'][ $apl_default ]) && $_SESSION['scriptcase']['sc_apl_seg'][ $apl_default ] == 'on')
    {
        $apl_default = "app3_menu_form_php.php?sc_item_menu=app3_menu&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'];
    }
    if (isset($menu_data['notif_open_all_app']) && !empty($menu_data['notif_open_all_app']))
    {
        $menu_data['notif_open_all_app'] = "app3_menu_form_php.php?sc_item_menu=notif_see_all&sc_apl_menu=" . $menu_data['notif_open_all_app'] . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app3_menu']['glo_nm_usa_grupo'];
    }
...
?>
  ...
  <main>
    <div id="sc-main-content" class="vertical-orientation">
      <section class="ae-menubar menubar" role="toolbar" aria-orientation="vertical" tabindex="0" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-cobalt"; ?>">
      ...
      <section class="ae-menubar toolbar" role="toolbar" aria-orientation="horizontal" tabindex="0" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-cobalt"; ?>">
        <div class="wrapper">
...
<span class="header-string-h-text"><?php echo ""; ?></span>
          ...
          <div class="user action-button" role="button" id="user-button" aria-label="ações do usuário" aria-expanded="false"
            ...
            <img src="<?php echo "" . $_SESSION['usr_picture'] . ""; ?>" class="user_image" />
          </div>
            <?php
            }
            ?>
        ...
        <div class="panel" id="user-panel" role="dialog" aria-label="menu de contexto com ações relativas ao usuário"
          ...
          <div class="section user-info mx-3">
              ...
              <div>
                  <p class="user-name"><?php echo "" . $_SESSION['usr_name'] . ""; ?></p>
                  <p class="user-profile"><?php echo "" . $_SESSION['usr_login'] . " / " . $_SESSION['usr_email'] . " / " . $_SESSION['usr_phone'] . ""; ?></p>
              </div>
          </div>
...
<script>
    ...
    <section class="ae-menubar tabsbar" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-cobalt"; ?>" style="" aria-orientation="horizontal">
         <style>
...
function tabLinkRefresh(str_id) {
    if (typeof $('[name="' + str_id + '"]')[0] != 'undefined') {
        if (typeof document.querySelector('[name="' + str_id + '"]').contentWindow.nm_move === 'function') {
            document.querySelector('[name="' + str_id + '"]').contentWindow.nm_move('igual');
        }
    }
}
...
function openInTab(url, tabName, tabTitle, tabHint, tabIcon, tabTarget, unclosable) {
    ...
    if (!$('#' + tabName)[0]) {
        ...
        var tabHint = (tabTitle == '' || typeof tabTitle == 'undefined') ? '' :' title="' + tabTitle + '" ';
        var frameOnload = ' onload="finishLoadingTab(\'' + tabName + '\');"';
        var frameOnerror = ' onerror="finishLoadingTab(\'' + tabName + '\'); $(this).addClass(\'error\');"';
        var tab = $('<li class=\'tab loading\' ' + tabHint + ' id=\'id_tab_' + tabName + '\'><a href=\'#' + tabName + '\'   ><div class="tab-loader-placeholder"><div class="lds-dual-ring"></div></div>' + tabIcon  + tabLabel + closeIcon + '  </a></li>');
        var app = $('<div id="' + tabName + '"><iframe '+ frameOnload + frameOnerror +' class="' + loadClass + '" name="' + tabName + '" src="' + url + '" frameborder="0" data-initial-src="' + url + '"></iframe><div class="loader-placeholder"><div class="lds-dual-ring"></div></div></div>');
    ...
    var tabs = M.Tabs.getInstance($('.tabs')[0]);
    if (tab_exists) {
        if (tabTarget == 'nm_app_frame') {
            $('#' + tabName + ' iframe').attr( 'src', url);
...
{
    if (typeof $('.tabsbar .tab .active')[0] != 'undefined') {
        return $('.tabsbar .tab .active').attr('href').substr(1);
    }
}
function del_aba_td(str_id)
{
    contextMenuCloseTab(str_id);
}
function contextMenuCloseTab(str_id)
{
    if (typeof str_id !== typeof 'str') {
        return false;
    }
    if (!str_id.startsWith('id_tab_')) {
        str_id = 'id_tab_' + str_id
    }
...
function contextMenuCloseOthersTabs(str_id)
{
    $( "#contrl_abas li" ).each(function( index, f) {
        if(str_id != $( this ).attr('id'))
        {
            contextMenuCloseTab($( this ).attr('id'));
        }
      ...
      <div class="frame-container"  id="app-frames" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-cobalt"; ?>">
...
}function app3_menu_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->app3_menu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function app3_menu_target($str_target)
{
   ...
   {
        $_SESSION['scriptcase']['app3_menu']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['app3_menu']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['app3_menu']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_CRUE.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app3_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_CRUE.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "app3_menu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['app3_menu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['app3_menu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['app3_menu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_CRUE'])) {
            $_SESSION['scriptcase']['app3_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CRUE'];
        }
    }
}
...
$contr_app3_menu = new app3_menu_class;
$contr_app3_menu->app3_menu_menu();
