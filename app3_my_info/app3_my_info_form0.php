...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app3_my_info/app3_my_info_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("app3_my_info_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('app3_my_info_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['link_info']['remove_border']) {
...
<?php
 include_once("app3_my_info_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['app3_my_info'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['app3_my_info'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_login_label" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_name_label" id="hidden_field_label_name" style="<?php echo $sStyleHidden_name; ?>"><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['php_cmp_required']['name'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_label" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['btn_label']['exit'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("app3_my_info");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("app3_my_info");
 parent.scAjaxDetailHeight("app3_my_info", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
