  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_my_info" == sTestField)
        {
...
?>
  ...
  // ---------- Validate picture
  function do_ajax_app3_my_info_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_my_info_validate_picture(var_picture, var_script_case_init, do_ajax_app3_my_info_validate_picture_cb);
  } // do_ajax_app3_my_info_validate_picture

  function do_ajax_app3_my_info_validate_picture_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_my_info_validate_picture_cb

  // ---------- Validate login
  function do_ajax_app3_my_info_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_my_info_validate_login(var_login, var_script_case_init, do_ajax_app3_my_info_validate_login_cb);
  } // do_ajax_app3_my_info_validate_login

  function do_ajax_app3_my_info_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_my_info_validate_login_cb

  // ---------- Validate name
  function do_ajax_app3_my_info_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_my_info_validate_name(var_name, var_script_case_init, do_ajax_app3_my_info_validate_name_cb);
  } // do_ajax_app3_my_info_validate_name

  function do_ajax_app3_my_info_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_my_info_validate_name_cb

  // ---------- Validate email
  function do_ajax_app3_my_info_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_my_info_validate_email(var_email, var_script_case_init, do_ajax_app3_my_info_validate_email_cb);
  } // do_ajax_app3_my_info_validate_email

  function do_ajax_app3_my_info_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_my_info_validate_email_cb

  // ---------- Validate phone
  function do_ajax_app3_my_info_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_my_info_validate_phone(var_phone, var_script_case_init, do_ajax_app3_my_info_validate_phone_cb);
  } // do_ajax_app3_my_info_validate_phone

  function do_ajax_app3_my_info_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_my_info_validate_phone_cb

  // ---------- Validate role
  function do_ajax_app3_my_info_validate_role()
  {
    var nomeCampo_role = "role";
    var var_role = scAjaxGetFieldText(nomeCampo_role);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_my_info_validate_role(var_role, var_script_case_init, do_ajax_app3_my_info_validate_role_cb);
  } // do_ajax_app3_my_info_validate_role

  function do_ajax_app3_my_info_validate_role_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "role";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_my_info_validate_role_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_my_info_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_my_info_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_my_info_submit_form(var_picture, var_login, var_name, var_email, var_phone, var_role, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_my_info_submit_form_cb);
  } // do_ajax_app3_my_info_submit_form

  function do_ajax_app3_my_info_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_my_info_submit_form_cb_after_alert);
  } // do_ajax_app3_my_info_submit_form_cb
  function do_ajax_app3_my_info_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_my_info_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_my_info_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_app3_my_info_navigate_form, function() {});
    } else {
      perform_ajax_app3_my_info_navigate_form();
    }
  }

  function perform_ajax_app3_my_info_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_app3_my_info_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app3_my_info_navigate_form_cb);
  } // do_ajax_app3_my_info_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_my_info']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_my_info_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_my_info_navigate_form_cb_after_alert);
  } // do_ajax_app3_my_info_navigate_form_cb
  function do_ajax_app3_my_info_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app3_my_info_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_my_info_navigate_form_cb_after_alert

  function sc_hide_app3_my_info_form()
  {
  ...
  ajax_field_list[4] = "phone";
  ajax_field_list[5] = "role";
  ...
  var ajax_error_list = {
    ...
    "phone": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_phone'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "role": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_role'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
