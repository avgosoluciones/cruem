  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_retrieve_pswd" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_app3_retrieve_pswd_form();
        }
...
?>
  ...
  // ---------- Validate login
  function do_ajax_app3_retrieve_pswd_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_retrieve_pswd_validate_login(var_login, var_script_case_init, do_ajax_app3_retrieve_pswd_validate_login_cb);
  } // do_ajax_app3_retrieve_pswd_validate_login

  function do_ajax_app3_retrieve_pswd_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_retrieve_pswd_validate_login_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_retrieve_pswd_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_retrieve_pswd_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_retrieve_pswd_submit_form(var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_retrieve_pswd_submit_form_cb);
  } // do_ajax_app3_retrieve_pswd_submit_form

  function do_ajax_app3_retrieve_pswd_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_retrieve_pswd_submit_form_cb_after_alert);
  } // do_ajax_app3_retrieve_pswd_submit_form_cb
  function do_ajax_app3_retrieve_pswd_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_retrieve_pswd_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_retrieve_pswd_navigate_form()
  {
    perform_ajax_app3_retrieve_pswd_navigate_form();
  }

  function perform_ajax_app3_retrieve_pswd_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app3_retrieve_pswd_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_retrieve_pswd']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_retrieve_pswd_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_retrieve_pswd_navigate_form_cb_after_alert);
  } // do_ajax_app3_retrieve_pswd_navigate_form_cb
  function do_ajax_app3_retrieve_pswd_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
{
?>
    do_ajax_app3_retrieve_pswd_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_retrieve_pswd_navigate_form_cb_after_alert

  function sc_hide_app3_retrieve_pswd_form()
  {
