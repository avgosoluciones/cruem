...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____app3_search_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____app3_search_sec_groups"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['app3_form_sec_groups_apps'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>app3_search_sec_groups</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['app3_search_sec_groups']['embutida_filho'] as $ind => $sc_init)
          {
