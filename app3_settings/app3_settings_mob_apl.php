...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->sett_smtp_api)) 
          {
              $_SESSION['sett_smtp_api'] = $this->sett_smtp_api;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new app3_settings_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_settings'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['app3_settings_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_settings_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['app3_settings_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_settings_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_settings_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('app3_settings_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app3_settings_mob']['label'] = "" . $this->Ini->Nm_lang['lang_settings'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['app3_settings_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['app3_settings_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['app3_settings_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_settings_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['app3_settings_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'app3_settings_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'app3_settings_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'app3_settings/app3_settings_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "app3_settings_mob_erro.class.php"); 
      }
      $this->Erro      = new app3_settings_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['app3_settings_mob']['start']);
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['app3_settings_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['app3_settings_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos']))
              { 
                  $session_expire = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][0]; 
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][1]; 
                  $cookie_expiration_time = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][2]; 
                  $theme = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][3]; 
                  $language = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][4]; 
                  $login_mode = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][5]; 
                  $captcha = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][6]; 
                  $pswd_last_updated = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][7]; 
                  $brute_force = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][8]; 
                  $brute_force_attempts = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][9]; 
                  $brute_force_time_block = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][10]; 
                  $retrieve_password = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][11]; 
                  $recover_pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][12]; 
                  $password_min = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][13]; 
                  $password_strength = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][14]; 
                  $group_administrator = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][15]; 
                  $enable_2fa = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][16]; 
                  $enable_2fa_expiration_time = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][17]; 
                  $enable_2fa_mode = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][18]; 
                  $enable_2fa_api_type = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][19]; 
                  $enable_2fa_api = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][20]; 
                  $mfa_last_updated = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][21]; 
                  $new_users = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][22]; 
                  $req_email_act = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][23]; 
                  $send_email_adm = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][24]; 
                  $group_default = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][25]; 
                  $smtp_api = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][26]; 
                  $smtp_server = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][27]; 
                  $smtp_port = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][28]; 
                  $smtp_security = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][29]; 
                  $smtp_user = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][30]; 
                  $smtp_pass = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][31]; 
                  $smtp_from_email = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][32]; 
                  $smtp_from_name = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][33]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][0] = $this->session_expire; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][1] = $this->remember_me; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][2] = $this->cookie_expiration_time; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][3] = $this->theme; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][4] = $this->language; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][5] = $this->login_mode; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][6] = $this->captcha; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][7] = $this->pswd_last_updated; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][8] = $this->brute_force; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][9] = $this->brute_force_attempts; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][10] = $this->brute_force_time_block; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][11] = $this->retrieve_password; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][12] = $this->recover_pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][13] = $this->password_min; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][14] = $this->password_strength; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][15] = $this->group_administrator; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][16] = $this->enable_2fa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][17] = $this->enable_2fa_expiration_time; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][18] = $this->enable_2fa_mode; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][19] = $this->enable_2fa_api_type; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][20] = $this->enable_2fa_api; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][21] = $this->mfa_last_updated; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][22] = $this->new_users; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][23] = $this->req_email_act; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][24] = $this->send_email_adm; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][25] = $this->group_default; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][26] = $this->smtp_api; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][27] = $this->smtp_server; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][28] = $this->smtp_port; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][29] = $this->smtp_security; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][30] = $this->smtp_user; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][31] = $this->smtp_pass; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][32] = $this->smtp_from_email; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['campos'][33] = $this->smtp_from_name; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("app3_settings_mob", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("app3_settings_mob_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "app3_settings_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="app3_settings_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="app3_settings_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="app3_settings_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_app3_settings_mob']) || !is_array($this->NM_ajax_info['errList']['geral_app3_settings_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_app3_settings_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_app3_settings_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['app3_settings_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['app3_settings_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_pswd_last_updated(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pswd_last_updated, 20, 0, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['group_administrator'])) {
       return;
               ...
               if (!empty($this->group_administrator) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator']) && !in_array($this->group_administrator, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['enable_2fa_api_type'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_api_type']) && !in_array($this->enable_2fa_api_type, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_api_type']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['group_default'])) {
       return;
               ...
               if (!empty($this->group_default) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default']) && !in_array($this->group_default, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('N') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_sess_no'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('R') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_sess_redir'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('M') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_sess_msg'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_session_expire'][] = 'N';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_session_expire'][] = 'R';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_session_expire'][] = 'M';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['session_expire']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_remember_me'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['remember_me']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_language'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['language']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('username') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_login_mode_user'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('email') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("E-mail")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('both') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_login_mode_both'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_login_mode'][] = 'username';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_login_mode'][] = 'email';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_login_mode'][] = 'both';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['login_mode']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_captcha'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['captcha']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_brute_force'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['brute_force']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_retrieve_password'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['retrieve_password']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('reset_send') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_reset_send'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('send_link') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_send_link'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_recover_pswd'][] = 'reset_send';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_recover_pswd'][] = 'send_link';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['recover_pswd']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('uppercase_letter') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_uppercase_letter'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('lowercase_letter') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_lowercase_letter'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('numbers') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_numbers'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('special_chars') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_special_chars'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_password_strength'][] = 'uppercase_letter';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_password_strength'][] = 'lowercase_letter';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_password_strength'][] = 'numbers';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_password_strength'][] = 'special_chars';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['password_strength']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(app3_settings_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', app3_settings_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_administrator'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['group_administrator']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('individual') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_2fa_individual'] . "")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('all') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_2fa_all'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_mode'][] = 'individual';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_mode'][] = 'all';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa_mode']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('email') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("E-mail")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('auth') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("Google Auth")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('sms') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("SMS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_api_type'][] = 'email';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_api_type'][] = 'auth';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_enable_2fa_api_type'][] = 'sms';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa_api_type']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_new_users'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['new_users']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_req_email_act'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['req_email_act']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_send_email_adm'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['send_email_adm']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default'] = array(); 
}
$aLookup[] = array(app3_settings_mob_pack_protect_string('') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_group_default'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['group_default']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app3_settings_mob_pack_protect_string('ssl') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("SSL")));
$aLookup[] = array(app3_settings_mob_pack_protect_string('tls') => str_replace('<', '&lt;',app3_settings_mob_pack_protect_string("TLS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_smtp_security'][] = 'ssl';
$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['Lookup_smtp_security'][] = 'tls';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['smtp_security']['valList'][$i] = app3_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_smtp_from_name($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['app3_settings_mob']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("app3_settings_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "app3_settings_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "app3_settings_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings_mob']['ordem_ord'] == " desc") {
