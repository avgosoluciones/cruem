  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_settings" == sTestField)
        {
...
?>
  ...
  function do_ajax_app3_settings_validate_session_expire()
  {
    ...
    x_ajax_app3_settings_validate_session_expire(var_session_expire, var_script_case_init, do_ajax_app3_settings_validate_session_expire_cb);
  } // do_ajax_app3_settings_validate_session_expire

  function do_ajax_app3_settings_validate_session_expire_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_session_expire_cb

  // ---------- Validate remember_me
  function do_ajax_app3_settings_validate_remember_me()
  {
    var nomeCampo_remember_me = "remember_me";
    var var_remember_me = scAjaxGetFieldCheckbox(nomeCampo_remember_me, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_remember_me(var_remember_me, var_script_case_init, do_ajax_app3_settings_validate_remember_me_cb);
  } // do_ajax_app3_settings_validate_remember_me

  function do_ajax_app3_settings_validate_remember_me_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_remember_me_cb

  // ---------- Validate cookie_expiration_time
  function do_ajax_app3_settings_validate_cookie_expiration_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_cookie_expiration_time(var_cookie_expiration_time, var_script_case_init, do_ajax_app3_settings_validate_cookie_expiration_time_cb);
  } // do_ajax_app3_settings_validate_cookie_expiration_time

  function do_ajax_app3_settings_validate_cookie_expiration_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_cookie_expiration_time_cb

  // ---------- Validate theme
  function do_ajax_app3_settings_validate_theme()
  {
    var nomeCampo_theme = "theme";
    var var_theme = scAjaxGetFieldText(nomeCampo_theme);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_theme(var_theme, var_script_case_init, do_ajax_app3_settings_validate_theme_cb);
  } // do_ajax_app3_settings_validate_theme

  function do_ajax_app3_settings_validate_theme_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "theme";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_theme_cb

  // ---------- Validate language
  function do_ajax_app3_settings_validate_language()
  {
    var nomeCampo_language = "language";
    var var_language = scAjaxGetFieldCheckbox(nomeCampo_language, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_language(var_language, var_script_case_init, do_ajax_app3_settings_validate_language_cb);
  } // do_ajax_app3_settings_validate_language

  function do_ajax_app3_settings_validate_language_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_language_cb

  // ---------- Validate login_mode
  function do_ajax_app3_settings_validate_login_mode()
  {
    var nomeCampo_login_mode = "login_mode";
    var var_login_mode = scAjaxGetFieldSelect(nomeCampo_login_mode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_login_mode(var_login_mode, var_script_case_init, do_ajax_app3_settings_validate_login_mode_cb);
  } // do_ajax_app3_settings_validate_login_mode

  function do_ajax_app3_settings_validate_login_mode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_login_mode_cb

  // ---------- Validate captcha
  function do_ajax_app3_settings_validate_captcha()
  {
    var nomeCampo_captcha = "captcha";
    var var_captcha = scAjaxGetFieldCheckbox(nomeCampo_captcha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_captcha(var_captcha, var_script_case_init, do_ajax_app3_settings_validate_captcha_cb);
  } // do_ajax_app3_settings_validate_captcha

  function do_ajax_app3_settings_validate_captcha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "captcha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_captcha_cb

  // ---------- Validate pswd_last_updated
  function do_ajax_app3_settings_validate_pswd_last_updated()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_pswd_last_updated(var_pswd_last_updated, var_script_case_init, do_ajax_app3_settings_validate_pswd_last_updated_cb);
  } // do_ajax_app3_settings_validate_pswd_last_updated

  function do_ajax_app3_settings_validate_pswd_last_updated_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_pswd_last_updated_cb

  // ---------- Validate brute_force
  function do_ajax_app3_settings_validate_brute_force()
  {
    var nomeCampo_brute_force = "brute_force";
    var var_brute_force = scAjaxGetFieldCheckbox(nomeCampo_brute_force, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_brute_force(var_brute_force, var_script_case_init, do_ajax_app3_settings_validate_brute_force_cb);
  } // do_ajax_app3_settings_validate_brute_force

  function do_ajax_app3_settings_validate_brute_force_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_brute_force_cb

  // ---------- Validate brute_force_attempts
  function do_ajax_app3_settings_validate_brute_force_attempts()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_brute_force_attempts(var_brute_force_attempts, var_script_case_init, do_ajax_app3_settings_validate_brute_force_attempts_cb);
  } // do_ajax_app3_settings_validate_brute_force_attempts

  function do_ajax_app3_settings_validate_brute_force_attempts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_brute_force_attempts_cb

  // ---------- Validate brute_force_time_block
  function do_ajax_app3_settings_validate_brute_force_time_block()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_brute_force_time_block(var_brute_force_time_block, var_script_case_init, do_ajax_app3_settings_validate_brute_force_time_block_cb);
  } // do_ajax_app3_settings_validate_brute_force_time_block

  function do_ajax_app3_settings_validate_brute_force_time_block_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_brute_force_time_block_cb

  // ---------- Validate retrieve_password
  function do_ajax_app3_settings_validate_retrieve_password()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_retrieve_password(var_retrieve_password, var_script_case_init, do_ajax_app3_settings_validate_retrieve_password_cb);
  } // do_ajax_app3_settings_validate_retrieve_password

  function do_ajax_app3_settings_validate_retrieve_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_retrieve_password_cb

  // ---------- Validate recover_pswd
  function do_ajax_app3_settings_validate_recover_pswd()
  {
    var nomeCampo_recover_pswd = "recover_pswd";
    var var_recover_pswd = scAjaxGetFieldSelect(nomeCampo_recover_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_recover_pswd(var_recover_pswd, var_script_case_init, do_ajax_app3_settings_validate_recover_pswd_cb);
  } // do_ajax_app3_settings_validate_recover_pswd

  function do_ajax_app3_settings_validate_recover_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_recover_pswd_cb

  // ---------- Validate password_min
  function do_ajax_app3_settings_validate_password_min()
  {
    var nomeCampo_password_min = "password_min";
    var var_password_min = scAjaxGetFieldText(nomeCampo_password_min);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_password_min(var_password_min, var_script_case_init, do_ajax_app3_settings_validate_password_min_cb);
  } // do_ajax_app3_settings_validate_password_min

  function do_ajax_app3_settings_validate_password_min_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_password_min_cb

  // ---------- Validate password_strength
  function do_ajax_app3_settings_validate_password_strength()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_password_strength(var_password_strength, var_script_case_init, do_ajax_app3_settings_validate_password_strength_cb);
  } // do_ajax_app3_settings_validate_password_strength

  function do_ajax_app3_settings_validate_password_strength_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_password_strength_cb

  // ---------- Validate group_administrator
  function do_ajax_app3_settings_validate_group_administrator()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_group_administrator(var_group_administrator, var_script_case_init, do_ajax_app3_settings_validate_group_administrator_cb);
  } // do_ajax_app3_settings_validate_group_administrator

  function do_ajax_app3_settings_validate_group_administrator_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_group_administrator_cb

  // ---------- Validate enable_2fa
  function do_ajax_app3_settings_validate_enable_2fa()
  {
    var nomeCampo_enable_2fa = "enable_2fa";
    var var_enable_2fa = scAjaxGetFieldCheckbox(nomeCampo_enable_2fa, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_enable_2fa(var_enable_2fa, var_script_case_init, do_ajax_app3_settings_validate_enable_2fa_cb);
  } // do_ajax_app3_settings_validate_enable_2fa

  function do_ajax_app3_settings_validate_enable_2fa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_enable_2fa_cb

  // ---------- Validate enable_2fa_expiration_time
  function do_ajax_app3_settings_validate_enable_2fa_expiration_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_enable_2fa_expiration_time(var_enable_2fa_expiration_time, var_script_case_init, do_ajax_app3_settings_validate_enable_2fa_expiration_time_cb);
  } // do_ajax_app3_settings_validate_enable_2fa_expiration_time

  function do_ajax_app3_settings_validate_enable_2fa_expiration_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_enable_2fa_expiration_time_cb

  // ---------- Validate enable_2fa_mode
  function do_ajax_app3_settings_validate_enable_2fa_mode()
  {
    var nomeCampo_enable_2fa_mode = "enable_2fa_mode";
    var var_enable_2fa_mode = scAjaxGetFieldSelect(nomeCampo_enable_2fa_mode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_enable_2fa_mode(var_enable_2fa_mode, var_script_case_init, do_ajax_app3_settings_validate_enable_2fa_mode_cb);
  } // do_ajax_app3_settings_validate_enable_2fa_mode

  function do_ajax_app3_settings_validate_enable_2fa_mode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_enable_2fa_mode_cb

  // ---------- Validate enable_2fa_api_type
  function do_ajax_app3_settings_validate_enable_2fa_api_type()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_enable_2fa_api_type(var_enable_2fa_api_type, var_script_case_init, do_ajax_app3_settings_validate_enable_2fa_api_type_cb);
  } // do_ajax_app3_settings_validate_enable_2fa_api_type

  function do_ajax_app3_settings_validate_enable_2fa_api_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_enable_2fa_api_type_cb

  // ---------- Validate enable_2fa_api
  function do_ajax_app3_settings_validate_enable_2fa_api()
  {
    var nomeCampo_enable_2fa_api = "enable_2fa_api";
    var var_enable_2fa_api = scAjaxGetFieldHidden(nomeCampo_enable_2fa_api);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_enable_2fa_api(var_enable_2fa_api, var_script_case_init, do_ajax_app3_settings_validate_enable_2fa_api_cb);
  } // do_ajax_app3_settings_validate_enable_2fa_api

  function do_ajax_app3_settings_validate_enable_2fa_api_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_enable_2fa_api_cb

  // ---------- Validate mfa_last_updated
  function do_ajax_app3_settings_validate_mfa_last_updated()
  {
    var nomeCampo_mfa_last_updated = "mfa_last_updated";
    var var_mfa_last_updated = scAjaxGetFieldText(nomeCampo_mfa_last_updated);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_mfa_last_updated(var_mfa_last_updated, var_script_case_init, do_ajax_app3_settings_validate_mfa_last_updated_cb);
  } // do_ajax_app3_settings_validate_mfa_last_updated

  function do_ajax_app3_settings_validate_mfa_last_updated_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_mfa_last_updated_cb

  // ---------- Validate new_users
  function do_ajax_app3_settings_validate_new_users()
  {
    var nomeCampo_new_users = "new_users";
    var var_new_users = scAjaxGetFieldCheckbox(nomeCampo_new_users, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_new_users(var_new_users, var_script_case_init, do_ajax_app3_settings_validate_new_users_cb);
  } // do_ajax_app3_settings_validate_new_users

  function do_ajax_app3_settings_validate_new_users_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_new_users_cb

  // ---------- Validate req_email_act
  function do_ajax_app3_settings_validate_req_email_act()
  {
    var nomeCampo_req_email_act = "req_email_act";
    var var_req_email_act = scAjaxGetFieldCheckbox(nomeCampo_req_email_act, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_req_email_act(var_req_email_act, var_script_case_init, do_ajax_app3_settings_validate_req_email_act_cb);
  } // do_ajax_app3_settings_validate_req_email_act

  function do_ajax_app3_settings_validate_req_email_act_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_req_email_act_cb

  // ---------- Validate send_email_adm
  function do_ajax_app3_settings_validate_send_email_adm()
  {
    var nomeCampo_send_email_adm = "send_email_adm";
    var var_send_email_adm = scAjaxGetFieldCheckbox(nomeCampo_send_email_adm, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_send_email_adm(var_send_email_adm, var_script_case_init, do_ajax_app3_settings_validate_send_email_adm_cb);
  } // do_ajax_app3_settings_validate_send_email_adm

  function do_ajax_app3_settings_validate_send_email_adm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_send_email_adm_cb

  // ---------- Validate group_default
  function do_ajax_app3_settings_validate_group_default()
  {
    var nomeCampo_group_default = "group_default";
    var var_group_default = scAjaxGetFieldSelect(nomeCampo_group_default);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_group_default(var_group_default, var_script_case_init, do_ajax_app3_settings_validate_group_default_cb);
  } // do_ajax_app3_settings_validate_group_default

  function do_ajax_app3_settings_validate_group_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_group_default_cb

  // ---------- Validate smtp_api
  function do_ajax_app3_settings_validate_smtp_api()
  {
    var nomeCampo_smtp_api = "smtp_api";
    var var_smtp_api = scAjaxGetFieldHidden(nomeCampo_smtp_api);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_api(var_smtp_api, var_script_case_init, do_ajax_app3_settings_validate_smtp_api_cb);
  } // do_ajax_app3_settings_validate_smtp_api

  function do_ajax_app3_settings_validate_smtp_api_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_api_cb

  // ---------- Validate smtp_server
  function do_ajax_app3_settings_validate_smtp_server()
  {
    var nomeCampo_smtp_server = "smtp_server";
    var var_smtp_server = scAjaxGetFieldText(nomeCampo_smtp_server);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_server(var_smtp_server, var_script_case_init, do_ajax_app3_settings_validate_smtp_server_cb);
  } // do_ajax_app3_settings_validate_smtp_server

  function do_ajax_app3_settings_validate_smtp_server_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_server_cb

  // ---------- Validate smtp_port
  function do_ajax_app3_settings_validate_smtp_port()
  {
    var nomeCampo_smtp_port = "smtp_port";
    var var_smtp_port = scAjaxGetFieldText(nomeCampo_smtp_port);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_port(var_smtp_port, var_script_case_init, do_ajax_app3_settings_validate_smtp_port_cb);
  } // do_ajax_app3_settings_validate_smtp_port

  function do_ajax_app3_settings_validate_smtp_port_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_port_cb

  // ---------- Validate smtp_security
  function do_ajax_app3_settings_validate_smtp_security()
  {
    var nomeCampo_smtp_security = "smtp_security";
    var var_smtp_security = scAjaxGetFieldSelect(nomeCampo_smtp_security);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_security(var_smtp_security, var_script_case_init, do_ajax_app3_settings_validate_smtp_security_cb);
  } // do_ajax_app3_settings_validate_smtp_security

  function do_ajax_app3_settings_validate_smtp_security_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_security_cb

  // ---------- Validate smtp_user
  function do_ajax_app3_settings_validate_smtp_user()
  {
    var nomeCampo_smtp_user = "smtp_user";
    var var_smtp_user = scAjaxGetFieldText(nomeCampo_smtp_user);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_user(var_smtp_user, var_script_case_init, do_ajax_app3_settings_validate_smtp_user_cb);
  } // do_ajax_app3_settings_validate_smtp_user

  function do_ajax_app3_settings_validate_smtp_user_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_user_cb

  // ---------- Validate smtp_pass
  function do_ajax_app3_settings_validate_smtp_pass()
  {
    var nomeCampo_smtp_pass = "smtp_pass";
    var var_smtp_pass = scAjaxGetFieldText(nomeCampo_smtp_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_pass(var_smtp_pass, var_script_case_init, do_ajax_app3_settings_validate_smtp_pass_cb);
  } // do_ajax_app3_settings_validate_smtp_pass

  function do_ajax_app3_settings_validate_smtp_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_pass_cb

  // ---------- Validate smtp_from_email
  function do_ajax_app3_settings_validate_smtp_from_email()
  {
    var nomeCampo_smtp_from_email = "smtp_from_email";
    var var_smtp_from_email = scAjaxGetFieldText(nomeCampo_smtp_from_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_from_email(var_smtp_from_email, var_script_case_init, do_ajax_app3_settings_validate_smtp_from_email_cb);
  } // do_ajax_app3_settings_validate_smtp_from_email

  function do_ajax_app3_settings_validate_smtp_from_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_from_email_cb

  // ---------- Validate smtp_from_name
  function do_ajax_app3_settings_validate_smtp_from_name()
  {
    var nomeCampo_smtp_from_name = "smtp_from_name";
    var var_smtp_from_name = scAjaxGetFieldText(nomeCampo_smtp_from_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_settings_validate_smtp_from_name(var_smtp_from_name, var_script_case_init, do_ajax_app3_settings_validate_smtp_from_name_cb);
  } // do_ajax_app3_settings_validate_smtp_from_name

  function do_ajax_app3_settings_validate_smtp_from_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_settings_validate_smtp_from_name_cb

  // ---------- Event onclick brute_force
  function do_ajax_app3_settings_event_brute_force_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_app3_settings_event_brute_force_onclick(var_brute_force, var_brute_force_time_block, var_brute_force_attempts, var_script_case_init, do_ajax_app3_settings_event_brute_force_onclick_cb);
  } // do_ajax_app3_settings_event_brute_force_onclick

  function do_ajax_app3_settings_event_brute_force_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "brute_force";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_settings_event_brute_force_onclick_cb_after_alert);
  } // do_ajax_app3_settings_event_brute_force_onclick_cb
  function do_ajax_app3_settings_event_brute_force_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_settings_event_brute_force_onclick_cb_after_alert

  // ---------- Event onclick enable_2fa_api_type
  function do_ajax_app3_settings_event_enable_2fa_api_type_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_settings_event_enable_2fa_api_type_onclick(var_enable_2fa_api_type, var_enable_2fa_api, var_script_case_init, do_ajax_app3_settings_event_enable_2fa_api_type_onclick_cb);
  } // do_ajax_app3_settings_event_enable_2fa_api_type_onclick

  function do_ajax_app3_settings_event_enable_2fa_api_type_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "enable_2fa_api_type";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_settings_event_enable_2fa_api_type_onclick_cb_after_alert);
  } // do_ajax_app3_settings_event_enable_2fa_api_type_onclick_cb
  function do_ajax_app3_settings_event_enable_2fa_api_type_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_settings_event_enable_2fa_api_type_onclick_cb_after_alert

  // ---------- Event onclick enable_2fa
  function do_ajax_app3_settings_event_enable_2fa_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_settings_event_enable_2fa_onclick(var_enable_2fa, var_enable_2fa_expiration_time, var_enable_2fa_mode, var_enable_2fa_api, var_enable_2fa_api_type, var_mfa_last_updated, var_script_case_init, do_ajax_app3_settings_event_enable_2fa_onclick_cb);
  } // do_ajax_app3_settings_event_enable_2fa_onclick

  function do_ajax_app3_settings_event_enable_2fa_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "enable_2fa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_settings_event_enable_2fa_onclick_cb_after_alert);
  } // do_ajax_app3_settings_event_enable_2fa_onclick_cb
  function do_ajax_app3_settings_event_enable_2fa_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_settings_event_enable_2fa_onclick_cb_after_alert

  // ---------- Event onclick remember_me
  function do_ajax_app3_settings_event_remember_me_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_settings_event_remember_me_onclick(var_remember_me, var_cookie_expiration_time, var_script_case_init, do_ajax_app3_settings_event_remember_me_onclick_cb);
  } // do_ajax_app3_settings_event_remember_me_onclick

  function do_ajax_app3_settings_event_remember_me_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "remember_me";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_settings_event_remember_me_onclick_cb_after_alert);
  } // do_ajax_app3_settings_event_remember_me_onclick_cb
  function do_ajax_app3_settings_event_remember_me_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_settings_event_remember_me_onclick_cb_after_alert

  // ---------- Event onclick retrieve_password
  function do_ajax_app3_settings_event_retrieve_password_onclick()
  {
    var var_retrieve_password = scAjaxGetFieldCheckbox("retrieve_password", ";");
    var var_recover_pswd = scAjaxGetFieldSelect("recover_pswd");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_settings_event_retrieve_password_onclick(var_retrieve_password, var_recover_pswd, var_script_case_init, do_ajax_app3_settings_event_retrieve_password_onclick_cb);
  } // do_ajax_app3_settings_event_retrieve_password_onclick

  function do_ajax_app3_settings_event_retrieve_password_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "retrieve_password";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_settings_event_retrieve_password_onclick_cb_after_alert);
  } // do_ajax_app3_settings_event_retrieve_password_onclick_cb
  function do_ajax_app3_settings_event_retrieve_password_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_settings_event_retrieve_password_onclick_cb_after_alert

  // ---------- Event onchange smtp_api
  function do_ajax_app3_settings_event_smtp_api_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app3_settings_event_smtp_api_onchange(var_smtp_api, var_smtp_server, var_smtp_port, var_smtp_security, var_smtp_user, var_smtp_pass, var_smtp_from_email, var_smtp_from_name, var_script_case_init, do_ajax_app3_settings_event_smtp_api_onchange_cb);
  } // do_ajax_app3_settings_event_smtp_api_onchange

  function do_ajax_app3_settings_event_smtp_api_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "smtp_api";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app3_settings_event_smtp_api_onchange_cb_after_alert);
  } // do_ajax_app3_settings_event_smtp_api_onchange_cb
  function do_ajax_app3_settings_event_smtp_api_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app3_settings_event_smtp_api_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_settings_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_settings_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_settings_submit_form(var_session_expire, var_remember_me, var_cookie_expiration_time, var_theme, var_language, var_login_mode, var_captcha, var_pswd_last_updated, var_brute_force, var_brute_force_attempts, var_brute_force_time_block, var_retrieve_password, var_recover_pswd, var_password_min, var_password_strength, var_group_administrator, var_enable_2fa, var_enable_2fa_expiration_time, var_enable_2fa_mode, var_enable_2fa_api_type, var_enable_2fa_api, var_mfa_last_updated, var_new_users, var_req_email_act, var_send_email_adm, var_group_default, var_smtp_api, var_smtp_server, var_smtp_port, var_smtp_security, var_smtp_user, var_smtp_pass, var_smtp_from_email, var_smtp_from_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_settings_submit_form_cb);
  } // do_ajax_app3_settings_submit_form

  function do_ajax_app3_settings_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_settings_submit_form_cb_after_alert);
  } // do_ajax_app3_settings_submit_form_cb
  function do_ajax_app3_settings_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_settings_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_settings_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_app3_settings_navigate_form, function() {});
    } else {
      perform_ajax_app3_settings_navigate_form();
    }
  }

  function perform_ajax_app3_settings_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app3_settings_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_settings']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_settings_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_settings_navigate_form_cb_after_alert);
  } // do_ajax_app3_settings_navigate_form_cb
  function do_ajax_app3_settings_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app3_settings_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_settings_navigate_form_cb_after_alert

  function sc_hide_app3_settings_form()
  {
