  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app3_sync_apps" == sTestField)
        {
...
?>
  ...
  // ---------- Validate sync
  function do_ajax_app3_sync_apps_validate_sync()
  {
  } // do_ajax_app3_sync_apps_validate_sync

  function do_ajax_app3_sync_apps_validate_sync_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_sync_apps_validate_sync_cb

  // ---------- Validate check_deleted
  function do_ajax_app3_sync_apps_validate_check_deleted()
  {
    var nomeCampo_check_deleted = "check_deleted";
    var var_check_deleted = scAjaxGetFieldCheckbox(nomeCampo_check_deleted, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app3_sync_apps_validate_check_deleted(var_check_deleted, var_script_case_init, do_ajax_app3_sync_apps_validate_check_deleted_cb);
  } // do_ajax_app3_sync_apps_validate_check_deleted

  function do_ajax_app3_sync_apps_validate_check_deleted_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app3_sync_apps_validate_check_deleted_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_app3_sync_apps_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_app3_sync_apps_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_app3_sync_apps_submit_form(var_sync, var_check_deleted, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app3_sync_apps_submit_form_cb);
  } // do_ajax_app3_sync_apps_submit_form

  function do_ajax_app3_sync_apps_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_app3_sync_apps_submit_form_cb_after_alert);
  } // do_ajax_app3_sync_apps_submit_form_cb
  function do_ajax_app3_sync_apps_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app3_sync_apps_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app3_sync_apps_navigate_form()
  {
    perform_ajax_app3_sync_apps_navigate_form();
  }

  function perform_ajax_app3_sync_apps_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_app3_sync_apps_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app3_sync_apps']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app3_sync_apps_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app3_sync_apps_navigate_form_cb_after_alert);
  } // do_ajax_app3_sync_apps_navigate_form_cb
  function do_ajax_app3_sync_apps_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_app3_sync_apps_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_app3_sync_apps_navigate_form_cb_after_alert

  function sc_hide_app3_sync_apps_form()
  {
