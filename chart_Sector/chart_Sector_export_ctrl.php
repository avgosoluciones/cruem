<?php
@session_start() ;
$_SESSION['scriptcase']['chart_Sector']['sc_process_barr'] = true;
require_once('../chart_Sector/index.php');
unset($_SESSION['scriptcase']['chart_Sector']['sc_process_barr']);
$ExportCtrl = new chart_Sector_export_control;
$ExportCtrl->Export_barr();

class chart_Sector_export_control
{
