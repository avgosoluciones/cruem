...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____chart_Sector"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____chart_Sector"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_Sector']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_Sector']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_Sector']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_Sector']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_Sector']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_Sector']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_Sector']['embutida_filho'] as $ind => $sc_init)
          {
