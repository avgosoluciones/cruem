...
SCEOT;
        ...
        $this->SC_APP_info = [
            'chart' => [
                ...
                'json_filename' => "sc_fc_chart_Sector_{$chartMd5}.json",
    ...
    {
        $this->SC_APP_data['md5_data'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['chart_info'] [$chartMd5];
    ...
    {
        $this->SC_APP_data['type'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_tipo'];
        $this->SC_APP_data['data_mode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['graf_opc_atual'];

        $this->SC_APP_data['width'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_larg'];
        $this->SC_APP_data['height'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_alt'];

        $this->SC_APP_data['order'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['graf_order'];

        $this->SC_APP_info['types'] ['bar'] ['orientation'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_barra_orien'];
        $this->SC_APP_info['types'] ['bar'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_barra_dimen'];
        $this->SC_APP_info['types'] ['bar'] ['stacking'] = 'Off' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_barra_empil'];
        $this->SC_APP_info['types'] ['bar'] ['stack100Percent'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_barra_empil'] ? '1' : '0';
        $this->SC_APP_info['types'] ['bar'] ['seriesMode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_barra_agrup'];

        $this->SC_APP_info['types'] ['funnel'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_funil_dimen'];

        $this->SC_APP_info['types'] ['gauge'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_gauge_forma'];

        $this->SC_APP_info['types'] ['line'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_linha_forma'];
        $this->SC_APP_info['types'] ['line'] ['seriesMode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_linha_agrup'];

        $this->SC_APP_info['types'] ['pie'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pizza_forma'];
        $this->SC_APP_info['types'] ['pie'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pizza_dimen'];
        $this->SC_APP_info['types'] ['pie'] ['order'] = strtolower($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pizza_orden']);
        $this->SC_APP_info['types'] ['pie'] ['showPercentValues'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pizza_valor'];

        $this->SC_APP_info['types'] ['pyramid'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pyram_dimen'];
        $this->SC_APP_info['types'] ['pyramid'] ['showPercentValues'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pyram_valor'];
        $this->SC_APP_info['types'] ['pyramid'] ['isSliced'] = 'S' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['cfg_graf'] ['graf_pyram_forma'];
    }
    ...
    {
        if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['has_limit_chart_items']) {
            if ('' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['limit_chart_items'] && '0' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['limit_chart_items']) {
                $this->SC_APP_data['limit_chart_items'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['limit_chart_items'];
...
SCEOT;
    ...
    function display_summaryChart_inline_initialAjaxResponse($chartMd5)
    {
        ...
        if ('' != $chartMd5 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_info'][$chartMd5])) {
    ...
    function display_summaryChart_data($chartMd5)
    {
        ...
        $chartFile = "{$this->SC_APP_info['chart'] ['json_base_dir']}sc_fc_chart_Sector_{$chartMd5}.json";
...
SCEOT;
    ...
    {
        $scPage = NM_encode_input($this->Ini->sc_page);
        $ajaxUrl = "{$this->Ini->path_link}chart_Sector/chart_Sector_config_graf_flash.php?nome_apl=chart_Sector&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es";
        $ajaxUrlDrillDown = "{$this->Ini->path_link}chart_Sector/index.php";
...
SCEOT;
    ...
    {
        return $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_Sector'] ['responsive_chart'] ['active'];
    }
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_drill_down'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_drill_down'] = true;
       }
       if (!isset($_POST['reload_comb_chart']) || (isset($_POST['reload_comb_chart']) && 'Y' == $_POST['reload_comb_chart'])) {
           $this->reload_as_analytic = !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_drill_down'];
       }
       $graf_field = false;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf'];
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_opc_atual'] == 1)
       {
           $this->sc_graf_sint = true;
       }
       ...
       {
           $b_export = true;
           $chart_key = key($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts']);
       }
       elseif ('' == $chart_key)
       {
       ...
       if ($graf_field)
       {
           ...
           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field]['graf_pyram_forma'],
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']               = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector'][$field];
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_order'];
           $this->grafico_flash($arr_param, $this->grafico_dados($chart_data, $arr_param['export'], ''), $mode);
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$chart_key]))
       {
           $chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$chart_key];

           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_pyram_forma'],
               'tit_datay'   => $chart_data['label_y'],
               'tit_label'   => $chart_data['label_x'],
               'tit_chart'   => $chart_data['title'],
           ...
           elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_full'])
           {
               $mode = 'full';
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_full']);
           }
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_bot']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_bot'])
           {
               $mode = 'full';
           }
           elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_first'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_first'] = false;
               $mode = array('js', 'chart');
           }
           else
           {
           ...
           elseif ((!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_bot']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_bot']))
           {
               exit;
           }
       }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- 
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['sector_sector'] = "Sector";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $this->label[$x] = $prep_label[$cmp_gb];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
   ...
   function monta_arrays()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_total']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_total'] as $label => $valor)
          {
          ...
          if (!$this->sc_graf_sint)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_linhas'] as $cada_elemento)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_linhas']))
      {
          if ($this->campo > 0)
          {
              $lab_quebra    = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_linhas'][$this->campo][0], 1);
              $lab_quebra    = str_replace("&nbsp;", "", $lab_quebra);
              $this->titulo .= " - " . $this->label[$this->nivel] . " = " . $lab_quebra;
          }
          if ($this->campo > 0)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_linhas'][$this->campo] as $ind => $valor)
              {
                  if ($ind > 0)
                  {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['del_graph_col']))
      {
          ...
          {
              $tst_ind = $ind + 1;
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['del_graph_col'][$tst_ind]))
              {
   ...
   function storeCombinationTable($arr_series)
   {
       foreach ($arr_series as $serie_data)
       {
           if ($serie_data['comb'])
           {
               $this->storeCombinationTableSerie($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_table_data'], $serie_data, $serie_data['param']);
           }
       }
   }
   ...
   function storeCombinationTableSerieData(&$comb_data, $serie_data)
   {
       foreach ($serie_data['db_values'] as $index => $dbval)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_table_def']['field'][ $serie_data['summ_idx'] ] = $serie_data['field_y'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_table_def']['label'][ $serie_data['summ_idx'] ] = $serie_data['name'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_table_def']['summ'][ $serie_data['summ_idx'] ]  = $serie_data['summ_idx'];
       }
   }
   ...
   function storeAnalyticTable($arr_series)
   {
       foreach ($arr_series as $serie_data)
       {
           $this->storeAnaliticTableSerie($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['anlt_table_data'], $serie_data);
       }
   }

   function storeAnaliticTableSerie(&$comb_data, $serie_data)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['anlt_table_def']['field'][ $serie_data['name'] ] = $serie_data['field_y'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['anlt_table_def']['label'][ $serie_data['name'] ] = $serie_data['name'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['anlt_table_def']['summ'][ $serie_data['name'] ]  = $serie_data['summ_idx'];
   ...
   function grafico_flash($arr_param, $arr_charts, $html_par = 'full')
   {
      global $nm_saida, $nm_retorno_graf;
         $Ind_groupby = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['SC_Ind_Groupby'];
         $orderRule  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule'];
         $orderField = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field'];

         $groupByIndex = isset($arr_charts[0][0]['param']) ? count($arr_charts[0][0]['param']) : -1;
         if (-1 != $groupByIndex && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_forced']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_forced'])) {
             $i = 0;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['SC_Gb_Free_cmp'] as $groupById => $groupByLabel) {
                 if ($i == $groupByIndex) {
                     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule_groupby'][$groupById]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field_groupby'][$groupById])) {
                         $orderRule  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule_groupby'][$groupById];
                         $orderField = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field_groupby'][$groupById];
                     }
       ...
       if (!isset($arr_charts[0][0]['reload_analytic']) || !$arr_charts[0][0]['reload_analytic'])
       {
           ...
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_fields_order'][$Ind_groupby] as $idx_order)
               {
                   foreach ($dat_serie as $idx_chart => $dat_chart)
                   {
                       ...
                       if ($idx_order == $temp + 1)
                       {
                           $dat_summ = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_fields_display'][$Ind_groupby][$idx_order];
                           if ($dat_summ['display'])
                           {
...
<?php
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['phantomjs_export_process']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['phantomjs_export_process'])
         {
             return;
         }
...
<?php
   ...
   {
       $sChartTheme = '__theme';
       if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['opcao'] == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['opcao'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       {
           $sChartTheme = 'scriptcase__NM__sc_GrayScale.php';
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['export_print_bw']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['export_print_bw'])
       {
           $sChartTheme = 'scriptcase__NM__sc_GrayScale.php';
       }
       $prjFallback = '';
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       if ($is_combinat)
       {
           if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('angulargauge', 'hlineargauge', 'msstepline', 'stackedarea', 'stackedbar2d', 'stackedbar3d', 'stackedcolumn2d', 'stackedcolumn3d')))
           {
               $bDisableLinks = true;
           }
       ...
       if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('angulargauge', 'semicirculargauge')))
       {
           $tipo        = 'Gauge';
           $is_combinat = false;
           $is_semi     = 'semicirculargauge' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'];
       ...
       elseif ('hlineargauge' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'])
       {
           $tipo        = 'LinearGauge';
           $is_combinat = false;
           if (sizeof($arr_series) > 1)
       ...
       elseif ('bubble' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'])
       {
           $tipo        = 'Bubble';
           $is_combinat = false;
       }
       elseif ('radar' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'])
       {
           $tipo        = 'Radar';
           $is_combinat = false;
       }
       elseif ('scatter' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'])
       {
           $tipo        = 'Scatter';
           $is_combinat = false;
       }
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('mscombidy2d', 'mscombi2d', 'mscolumn3dlinedy')))
       {
           $tipo = 'Bar';
       }
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('funnel', 'funnel2d')))
       {
           $tipo        = 'Funnel';
           $is_combinat = false;
           $is_2d       = 'funnel2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'];
           if (sizeof($arr_series) > 1)
           {
               $tmp_arr_series = $arr_series[0];
               $arr_series     = array($tmp_arr_series);
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('pyramid', 'pyramid2d')))
       {
           $tipo        = 'Pyramid';
           $is_combinat = false;
           $is_2d       = 'pyramid2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'];
           if (sizeof($arr_series) > 1)
           {
               $tmp_arr_series = $arr_series[0];
               $arr_series     = array($tmp_arr_series);
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('pie2d', 'pie3d', 'doughnut2d', 'doughnut3d')))
       {
           $tipo = 'Pie';
           $is_combinat = false;
           if (sizeof($arr_series) > 1)
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('bar2d', 'bar3d', 'msbar2d', 'msbar3d', 'column2d', 'column3d', 'mscolumn2d', 'mscolumn3d', 'stackedbar2d', 'stackedbar3d', 'stackedcolumn2d', 'stackedcolumn3d')))
       {
           $tipo = 'Bar';
           $is_combinat = false;
           if (isset($arr_series[0]['summ_idx']) && !empty($arr_series[0]['summ_idx']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ]))
           {
               $chart_attr_j['showvalues'] = 1 == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ] ? '1' : '0';
           }
           else
           {
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('msarea', 'area2d', 'mssplinearea', 'splinearea', 'stackedarea', 'stackedarea2d')))
       {
           $tipo = 'Area';
           $is_combinat = false;
           if (isset($arr_series[0]['summ_idx']) && !empty($arr_series[0]['summ_idx']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ]))
       ...
       elseif (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('msline', 'line', 'msspline', 'spline', 'msstepline')))
       {
           $tipo = 'Line';
           $is_combinat = false;
           if (isset($arr_series[0]['summ_idx']) && !empty($arr_series[0]['summ_idx']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ ($arr_series[0]['summ_idx'] + 1) ]))
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_font']))
       {
           $chart_attr_j['baseFontSize'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_font'];
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['chartpallet']) && false == $chart_theme)
       {
           $chart_attr_j['palette'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['chartpallet'];
       }
       ...
       $chart_attr_j['exportFileName'] = "chart_Sector";

       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['this_chart_label'] = $chart_attr_j['caption'];
       if (isset($chart_attr_j['subCaption']) && '' != $chart_attr_j['subCaption']) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['this_chart_label'] .= $chart_attr_j['subCaption'];
       }
       ...
       elseif (1 < sizeof($arr_series) || 'Radar' == $tipo || 'Step' == $arr_param['linha_forma'] || $is_combinat || 'ms' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], 0, 2))
       {
           $label = $arr_series[0]['label'];
           $datay = $arr_series[0]['data'];
           $link  = $arr_series[0]['xml_link'];
           $a_json['categories'] = [];
           $a_categories = [];
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_chart_data'] = array('label' => array(), 'series' => array());
           foreach ($label as $iIndex => $sLabel)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_chart_data']['label'][] = $this->formatFusionLabel($sLabel);
           ...
           foreach ($arr_series as $i_serie => $arr_serie)
           {
               ...
               if (isset($arr_serie['summ_idx']) && !empty($arr_serie['summ_idx']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ ($arr_serie['summ_idx'] + 1) ]))
               {
                   $a_dataset['showvalues'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ ($arr_serie['summ_idx'] + 1) ] ? '1' : '0';
               }
               if ($is_combinat)
               {
                   if (isset($arr_serie['summ_idx']) && !empty($arr_serie['summ_idx']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ]))
                   {
                       $a_dataset['renderas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ];
                   }
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_chart_data']['series'][] = $a_comb_serie_data;
...
<?php
   ...
   function grafico_combination()
   {
        ...
        $aGroupbyFields['available']['sector_sector'] = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['labels']['sector_sector'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['labels']['sector_sector'] : "Sector";
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['SC_Gb_Free_cmp'] as $idx_groupby_field => $lab_groupby_field)
        {
        ...
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_fields_control'][$Ind_groupby] as $l_field => $d_field)
        {
        ...
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_fields_order'][$Ind_groupby] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_fields_display'][$Ind_groupby][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_fields_display'][$Ind_groupby][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
...
?>
 ...
 var sc_groupby_info, sc_summ_info, sc_chart_type = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'] ?>", fc_chart_type = "<?php echo $this->getChartType($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['bmulti'], $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['bcomb']) ?>";
...
?>
 ...
 function scSaveChartChanges() {
  ...
  $.ajax({
   type: "POST",
   url: "chart_Sector_sel_groupby.php",
   data: {
...
?>
 ...
 function scShowCombinationImage(chartLevel, exportType, imagePassword) {
  ...
  $.ajax({
   ...
   if ("email" == exportType) {
    ...
    scUnblockUI();
    nm_submit_modal("<?php echo $this->Ini->path_link ?>chart_Sector/chart_Sector_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=image_res&sAdd=__E__sc_create_charts=S__E__sc_graf_pdf=S__E__chart_level=" + chartLevel + "&KeepThis=true&TB_iframe=true&modal=true", false);
   }
   else {
 ...
 function scProgressCombinationImage(progressFile) {
  $.ajax({
   type: "POST",
   url: "chart_Sector_check_image_export.php",
   data: {
    nmgp_opcao: "ajax_CombinationImage",
    script_case_init: "<?php echo NM_encode_input($this->Ini->sc_page); ?>",
    export_progress_file: "<?php echo "{$this->Ini->root}{$_SESSION['scriptcase']['chart_Sector']['glo_nm_path_imag_temp']}/"; ?>" + progressFile,
   }
  }).done(function(data) {
   if (data == '{"ss_time_out":true}') {
       nm_move();
...
?>
  ...
  if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_drill_down']))
  {
      if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['summarizing_drill_down'])
      {
          $strDrillDown = ' checked';
          $strDrillDownVal = 'Y';
      }
...
<?php
       ...
       {
           $s_test_value = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_field_display_type'][ $a_summ_fld['index'] ]) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['comb_field_display_type'][ $a_summ_fld['index'] ] : '';
           if (true === $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ $a_summ_fld['index'] ]) {
               $checkYes = ' checked';
               $checkNo  = '';
           }
           elseif (false === $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_display_values'][ $a_summ_fld['index'] ]) {
               $checkYes = '';
               $checkNo  = ' checked';
           }
           else {
...
<?php
       foreach ($aSumAll as $i_summ_fld => $a_summ_fld)
       {
           ...
           if ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule'] && $a_summ_fld['index'] - 2 === $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field'])
           {
               $sImgAsc = 'scSortOptionChecked';
           }
           elseif ('desc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule'] && $a_summ_fld['index'] - 2 === $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field'])
           {
...
<?php
       ...
       $sImgAsc  = 'scSortOptionNotChecked';
       $sImgDesc = 'scSortOptionNotChecked';
       if ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule'] && 'label' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field'])
       {
           $sImgAsc = 'scSortOptionChecked';
       }
       elseif ('desc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_rule'] && 'label' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_field'])
       {
           $sImgDesc = 'scSortOptionChecked';
       }
?>
...
<?php
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_forced']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_order_forced'])
       {
...
<?php
   ...
   function grafico_flash_config_js()
   {
      ...
      $sUrlConfigSave = $this->Ini->path_link . "chart_Sector/chart_Sector_config_graf_flash.php?nome_apl=chart_Sector&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es";
      ...
      $nm_saida->saida("          nome_apl: \"chart_Sector\",\r\n");
   ...
   function grafico_flash_config_div()
   {
      ...
      $aChartDisp        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_disp'])      && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_disp']))    ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_disp']      : array('Bar');
      $sChartType        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_tipo'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_tipo'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_tipo']      : 'Bar';
      $iSinteticAnalitic = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_opc_atual']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_opc_atual']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_opc_atual'] : '1';
      $iChartWidth       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_larg'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_larg'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_larg']      : '800';
      $iChartHeight      = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_alt'])       && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_alt'])       ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['cfg_graf']['graf_alt']       : '600';
      $sChartOrder       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_order'])     && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_order'])     ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['graf_order']     : '';
...
if (!$_SESSION['scriptcase']['proc_mobile']) {
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['skip_charts']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['skip_charts']) {
          return;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['bmulti'] = $bMulti;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['bcomb']  = $bComb;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['phantomjs_export_process']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['phantomjs_export_process'])
      {
 ...
 { 
      ...
      else
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['charts_html'] .= $sPDFHtmlCall;
      }
   }
   ...
   function generatePhantom($sFileLocal, $width, $height, $bMulti, $bComb)
   {
          ...
          $sTmpId       = md5($sTmpId . 'chart_Sector');
          $sImageName   = 'sc_pjs_png_' . $sTmpId . '.png';
          $sImageUrl    = $_SESSION['scriptcase']['chart_Sector']['glo_nm_path_imag_temp'] . '/' . $sImageName;
          $sImageFile   = $this->Ini->root . $sImageUrl;
          $sPDFHtmlCall = "";
          $sAppDir      = getcwd();
          $aOS          = $this->Ini->getRunningOS();
          $sPhantomCmd  = 'phantomjs --ignore-ssl-errors=true "' . $this->Ini->root . $_SESSION['scriptcase']['chart_Sector']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js"';
          $iJsDelay     = 150;
          if ('win' != $aOS['os'])
          {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['phantomjs_export_file'] = $sImageName;
          return $sImageUrl;
   }
   function generatePhantomJs($sTmpId, $sImageFile, $iDelay)
   {
       $server_phanton = $this->Ini->server_pdf;
       $fPhantomJs = @fopen($this->Ini->root . $_SESSION['scriptcase']['chart_Sector']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js', 'w');
   ...
   {
       $fPhantomChart = @fopen($this->Ini->root . $_SESSION['scriptcase']['chart_Sector']['glo_nm_path_imag_temp'] . '/sc_pjs_php_' . $sTmpId . '.html', 'w');
       ...
       if ('Y' != $export)
       {
           if (isset($cht_data['combination']) && $cht_data['combination'])
           {
               ...
               foreach ($cht_data['charts'] as $s_comb_chart_index)
               {
                   if (empty($label))
                   {
                       $label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['labels'];
                   }
                   if (empty($dbval))
                   {
                       $dbval = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['db_values'];
                   }
                   if (empty($lbord))
                   {
                       $lbord = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['label_order'];
                   }
                   if (empty($param))
                   {
                       $param = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['param'];
                   }
                   if ('' == $name)
                   {
                       $name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['label_x'];
                   }
                   if ('' == $fld_x)
                   {
                       $fld_x = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['field_x'];
                   }
                   if ('' == $subt)
                   {
                       $subt = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['subtitle'];
                   }
                   if ('' == $legnd && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['legend']))
                   {
                       $legnd = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['legend'];
                   }
                   $fld_y[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['field_y'];
                   $lab_y[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['label_y'];
                   $sum_i[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['summ_idx'];
                   $sum_f[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['summ_fn'];
                   $fmt[]           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['format'];
                   $datay['anal'][] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['values']['sint'][0];
                   $tmp_xml_links   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$s_comb_chart_index]['xml_links'];
                   $xml_l[]         = $cht_data['xml_pholder'];
               }
               if ($this->reload_as_analytic && 'C|' == substr($chart_key, 0, 2) && 1 == count($cht_data['charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type']) || !in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type'], array('combination2d', 'combination3d'))))
               {
                   $nonCombKey      = substr($chart_key, 2);
                   $fld_y           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['field_y'];
                   $lab_y           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['label_y'];
                   $sum_i           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['summ_idx'];
                   $sum_f           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['summ_fn'];
                   $fmt             = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['format'];
                   $datay           = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['values'];
                   $tmp_xml_links   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_charts'][$nonCombKey]['xml_links'];
                   $xml_l           = $cht_data['xml_pholder'];
   ...
   function getChartRenderer($bMulti, $bComb)
   {
       ...
       if (1)
       {
           ...
           switch ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['chart_combination_type']) {
               case 'angulargauge':
                   $newChartType = "angulargauge";
                   break;
               case 'semicirculargauge':
       ...
       $sChart = '';
       $sMulti = $bMulti ? 'MS' : '';
       switch ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_tipo'])
       {
           case 'Bar':
               if ('Horizontal' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_barra_orien'])
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       $sChart .= 'StackedBar';
                       $sChart .= '3d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_barra_dimen']  ? '3D' : '2D';
                   }
                   else
                   {
                       $sChart .= $sMulti . 'Bar';
               ...
               else
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       ...
                       $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_barra_dimen'] ? '2D' : '3D';
                   }
                   else
                   {
               ...
               break;
           case 'Pie':
               if ('Pie' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_pizza_forma'])
               {
                   $sChart .= 'Pie';
               }
               else
               ...
               $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_pizza_dimen'] ? '2D' : '3D';
               break;
           case 'Line':
               if ('Line' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_linha_forma'])
               {
                   $sChart .= $sMulti . 'Line';
               }
               elseif ('Spline' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_linha_forma'])
               {
               ...
               break;
           case 'Area':
               if ('Area' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_area_forma'])
               {
                   if ($bMulti)
                   {
                       $sChart .= $sMulti . 'Area';
   ...
   function getChartModule($sChartType = '')
   {
       if ('' == $sChartType)
       {
           $sChartType = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_tipo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['parms_graf']['graf_tipo'] : "";
       }
       switch ($sChartType)
       {
           case 'Bar':
