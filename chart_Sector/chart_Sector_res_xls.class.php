...
class chart_Sector_res_xls
{
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Tit_doc    = "chart_Sector" . $this->Xls_tp;
      $this->Tit_zip    = "chart_Sector.zip";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'] .= $this->Xls_tp ;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_name']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_return']);
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['pivot_group_by'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_res_sheet'] = $this->Xls_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['chart_Sector']['xls_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
