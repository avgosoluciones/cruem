<?php
@session_start() ;
$_SESSION['scriptcase']['chart_mes']['sc_process_barr'] = true;
require_once('../chart_mes/index.php');
unset($_SESSION['scriptcase']['chart_mes']['sc_process_barr']);
$ExportCtrl = new chart_mes_export_control;
$ExportCtrl->Export_barr();

class chart_mes_export_control
{
