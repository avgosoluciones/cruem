...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____chart_mes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____chart_mes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_filho'] as $ind => $sc_init)
          {
