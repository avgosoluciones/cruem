...
$oExportPdf = new chart_mes_export_pdf;
$oExportPdf->exportPdf();

class chart_mes_export_pdf {
...
$STR_lang           = '';
$str_google_fonts   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']))
{
    $STR_schema         = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']['str_schema'];
    $STR_tmp            = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']['str_tmp'];
    $STR_prod           = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']['str_prod'];
    $STR_btn            = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']['str_btn'];
    $STR_lang           = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']['str_lang'];
    $str_google_fonts   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_mes_iframe_params']['str_google_fonts'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['chart_mes']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['opc_pdf']['pdf_zip']     = (isset($aParams['pdf_zip']))         ? $aParams['pdf_zip']         : "N";
$Nm_lang     = array();
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_chart_mes.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['pdf_name'] : "chart_mes.pdf";
$NM_pdf_output = $NM_pdfbase;
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['opc_pdf']['pdf_zip']) && $_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes']['opc_pdf']['pdf_zip'] == "S")
 {
...
$_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes'][$path_doc_md5][0] = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
$_SESSION['sc_session'][$aParams['script_case_init']]['chart_mes'][$path_doc_md5][1] = $NM_tit_doc;
