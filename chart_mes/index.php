<?php
   include_once('chart_mes_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['chart_mes']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['chart_mes']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['chart_mes']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['chart_mes']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['chart_mes']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['chart_mes']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['chart_mes']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['chart_mes']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['chart_mes']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['chart_mes']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_mes']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['chart_mes']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['chart_mes']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_mes']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "chart_mes"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      $this->nm_grupo        = "CRUE"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['chart_mes']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['chart_mes']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['chart_mes']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/chart_mes';
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_mes']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['chart_mes']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['chart_mes']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['chart_mes']['actual_lang']) || $_SESSION['scriptcase']['chart_mes']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['chart_mes']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("chart_mes_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['chart_mes']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['chart_mes']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_border']   = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_mes"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_mes"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info']['remove_border'] = true;
        }
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_mes']['link_info']['margin_top'] = $link_margin_top;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['responsive_chart'] = array(
              'enabled' => true,
              'active'  => true,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_mes']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['chart_mes']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['chart_mes']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_mes']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "chart_mes_erro.class.php"); 
      $this->Erro = new chart_mes_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('chart_mes'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['chart_mes']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['chart_mes']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['chart_mes']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['chart_mes']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['chart_mes']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['chart_mes']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_mes']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['chart_mes']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['chart_mes']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao']) && $_SESSION['scriptcase']['chart_mes']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_mes']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_mes']['glo_nm_perfil']) && $_SESSION['scriptcase']['chart_mes']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_mes']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_mes']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['chart_mes']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['chart_mes']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['chart_mes']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['chart_mes']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['chart_mes']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['chart_mes']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_mes']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['chart_mes']['glo_nm_conexao'], $this->root . $this->path_prod, 'CRUE', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['chart_mes']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_sep_date1'];
           }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'chart_mes', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'chart_mes', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'chart_mes', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_mes']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class chart_mes_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['chart_mes']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['chart_mes']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['chart_mes'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_mes']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_mes'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_chart_mes($cadapar[1]);
                       nm_protect_num_chart_mes($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_ibase'])) 
      { 
          $this->Ini = new chart_mes_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           foreach ($todo as $param)
           {
                ...
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'] == "sc_free_group_by")
                { 
                    ...
                    elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_orig'][$cadapar[0]]))
                    {
                        list ($Sql_orig, $Sql_order) = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_sql'][$cadapar[0]];
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_mes']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_mes'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_mes']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_mes']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('chart_mes') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_mes']['label'] = "" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " procedimiento1";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "chart_mes/chart_mes_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "chart_mes_erro.class.php"); 
      } 
      $this->Erro      = new chart_mes_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "chart_mes/chart_mes_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "chart_mes_lookup.class.php"); 
      } 
      $this->Lookup       = new chart_mes_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_chart_mes_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['chart_mes']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['chart_mes']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['arr_total']);
              }
              if ($nmgp_opcao == "ordem")
              {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_prefix_date_format']['sc_free_group_by']['fecha'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMM'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_date_format']['sc_free_group_by']['fecha'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_date_format']['sc_free_group_by']['fecha'] = 'YYYYMM';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_All_Groupby'] = array('sc_free_group_by' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_cmp']['fecha'] = "fecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_sql']['fecha']["fecha"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['fecha'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_chart_title_YYYYMM'] . " fecha", "Fecha") . "";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_display']['sc_free_group_by'][2]['display'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "chart_mes_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "chart_mes_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_chart_mes_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_chart_mes_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['chart_mes']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_disp']        = array('Bar');
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_exibe_val']    = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_procedimiento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "secad";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "consecutivo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "quien_reporta";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "direccion_servicio";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_barrio";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "tipo_servicio";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "numero_contacto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "radicado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "nombre_apellido";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "tipo_documento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "documento_identidad";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "edad";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "genero";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "circunstancias_emergencia";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_seguridad_social";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_eps";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "fecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "ip";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "login";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "hora_ingreso_llamada";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "hora_notifica_movil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "hora_llegada_sitio";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "hora_llegada_ips";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "hora_salida_ips";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_movil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_ips";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "tipo_caso";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "operador";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_medico";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "id_tipo_evento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "observaciones";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "zona";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'][] = "discapacidad";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_procedimiento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['secad'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['consecutivo'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['quien_reporta'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['direccion_servicio'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_barrio'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['tipo_servicio'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['numero_contacto'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['radicado'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['nombre_apellido'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['tipo_documento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['documento_identidad'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['edad'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['genero'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['circunstancias_emergencia'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_seguridad_social'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_eps'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['fecha'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['ip'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['login'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['hora_ingreso_llamada'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['hora_notifica_movil'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['hora_llegada_sitio'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['hora_llegada_ips'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['hora_salida_ips'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_movil'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_ips'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['tipo_caso'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['operador'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_medico'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['id_tipo_evento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['observaciones'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['zona'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel']['discapacidad'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_mes']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_mes']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['chart_mes']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_mes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_mes']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "pdf")
      { 
      ...
      if (isset($_POST['nmgp_opcao']) && 'resumo' == $_POST['nmgp_opcao']
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_array_resumo'] = 'NAO';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_total_geral'] = 'NAO';
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tot_geral']);
      }

      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq'] = 'res';
          } 
          $this->SC_proc_grid_search($_POST['parm']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_array_resumo'] = "NAO";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_total_geral']  = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = 'pesq';
          ob_end_clean();
          $this->Ini->Arr_result = array();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_mes_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "chart_mes_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new chart_mes_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_orig'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_array_resumo'] = "NAO";
      } 
      if (!in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'], array('config_print', 'word_res', 'xls_res', 'xml_res', 'json_res', 'csv_res', 'rtf_res', 'image_res', 'ajax_comb_table', 'ajax_comb_save', 'ajax_comb_file_view', 'ajax_comb_file_download'))) {
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['where_pesq_ant'];  
      }
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_mes_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_chart_mes.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_mes_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_chart_mes_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "word_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "doc_word_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
          }
          else 
          {
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo);
          }
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']);
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['comb_field_display_type'][ $_POST['sumcfg_field'] ] = $_POST['sumcfg_value'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_display_values'][ $_POST['sumcfg_field'] ]    = 1 == $_POST['sumcfg_display'];
          echo 'ok';
          exit;
      }
      else
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_combination_order_rule']   = 'asc' == $_POST['sort_option'] || 'desc' == $_POST['sort_option'] ? $_POST['sort_option'] : '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_combination_order_field']  = $_POST['sort_field'];
          if ('orig' == $_POST['sort_option'])
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_combination_order_forced'] = false;
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_combination_order_forced'] = true;
          }
          echo 'ok';
          exit;
      }
      ...
      {
          if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_mes']) || !isset($_SESSION['scriptcase']['chart_export_file']['chart_mes'][ $_REQUEST['chart_file_md5'] ]))
          {
              echo 'error_file_not_found';
          }
          else
          {
              echo $this->Ini->path_imag_temp . '/' . $_SESSION['scriptcase']['chart_export_file']['chart_mes'][ $_REQUEST['chart_file_md5'] ]['name'];
          }
          exit;
      }
      else
      if ($nmgp_opcao == "ajax_comb_file_download")
      {
          ...
          {
              $filename = $_SESSION['scriptcase']['chart_export_file']['chart_mes'][ $_REQUEST['chart_file_md5'] ]['name'];
              $path     = $_SESSION['scriptcase']['chart_export_file']['chart_mes'][ $_REQUEST['chart_file_md5'] ]['dir'] . $filename;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "print_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "res_print")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_progress_file']  = $_POST['export_progress_file'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_progress_step']  = 'init';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_progress_count'] = 0;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_progress_total'] = 0;
          $this->outputCombinationPrint();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "config_print")
      { 
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']);
          $this->outputCombinationPrintConfig();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "xls_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "xml_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "json_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "csv_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "rtf_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "image_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "img_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_mes/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "config_image")
      { 
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao']);
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . chart_mes . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new chart_mes_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_POST['summary_chart_data']) && 'Y' == $_POST['summary_chart_data'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_data($_POST['chart_md5']);
              }
              elseif (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_mes_pesq.class.php"); 
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['opcao'] != "ajax_detalhe")  
             {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    chart_mes_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        chart_mes_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        chart_mes_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pdf_det'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "chart_mes.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['label'] as $series_name)
        {
...
<?php
        $this->outputCombinationTableRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, $tableDef);
?>
</table>
<?php
        exit;
...
<?php
            ...
            {
?>
  <td class="scGridFieldOdd scGridFieldOddFont" style="text-align: right"><?php echo chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value); ?></td>
<?php
            }
?>
 </tr>
<?php
	...
	function outputCombinationZipPassword($type, $fileName, $password) {
		$zipCommand  = "";
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . '/';
	...
	function outputCombinationData() {
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['anlt_table_def']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['anlt_table_def'])) {
	...
	function outputCombinationExport($type, $content, $password) {
		...
		$fileName = "sc_{$type}_{$dateTime}_{$fileSeq}_chart_mes.{$type}";
		...
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$testFilename . '_name'])) {
			$fileName = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$testFilename . '_name'];
		}
		...
		if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_mes'])) {
			$_SESSION['scriptcase']['chart_export_file']['chart_mes'] = array();
		}
		$_SESSION['scriptcase']['chart_export_file']['chart_mes'][$fileMd5] = array(
			'dir'  => $fileDir,
			'name' => $fileName
		);
		...
		switch ($type) {
			...
			case 'html':
				if ($this->Ini->sc_export_ajax) {
					$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_print_files'][] = $fileName;

					$this->outputCombinationEmail($this->Res->zipFileList($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_print_files']));
				}
				else {
...
SCEOT;
	...
	function outputCombinationPrintConfig() {
		...
		$hasOneGroupByLevel = 1 >= count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Labels_GB']);
		$isMultiSeriesChart = !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['summarizing_drill_down'];
...
SCEOT;
		...
		$lastGroupby = count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Labels_GB']) - 1;
		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['Labels_GB'] as $groupbyIndex => $groupbyLabel) {
...
SCEOT;
	...
	function outputCombinationPrintCss() {
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_export_print_css'] = 'color';

		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_export_print_css']) {
	...
	function outputCombinationPrintCharts() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_print_bw'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'];

		$chartImages = $this->Res->generateChartImages();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_print_bw'] = false;
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['export_print_files'] = $chartImages;
    ...
    {
        $jsonData = $this->outputCombinationJsonRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, $tableDef);
...
/* mantis 0019720  */
            ...
            foreach ($data['values'] as $index => $value) {
                $thisMetric = array(
                    'field' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['field'][$index],
                    'value' => $this->outputCombinationJsonProtectNumber($value)
                );

                if ($this->jsonShowFormatted) {
                	$thisMetric['formatted'] = $this->outputCombinationJsonProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value));
                }
                if ($this->jsonShowLabel) {
                	$thisMetric['label'] = $this->outputCombinationJsonProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['label'][$index]);
                }
	...
	function outputCombinationXmlContent($tableDef, $tableData) {
		return "<?xml version=\"1.0\" encoding=\"{$_SESSION['scriptcase']['charset']}\" ?>\r\n" .
		       "<chart_mes>\r\n" .
		       $this->outputCombinationXmlRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, $tableDef) .
		       "</chart_mes>";
	...
	function outputCombinationXmlRow($rows, $level, $tableDef) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$aggregateLabelTag = $this->xmlLabel ? $this->outputCombinationXmlProtectTag($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['label'][$index]) : $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['field'][$index];

				if ($this->xmlDisplayAsAttributes) {
					$outputData .= "<aggregate_{$aggregateLabelTag} label=\"" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['label'][$index]) . "\" value=\"" . $this->outputCombinationXmlProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value)) . "\" />\r\n";
				} else {
					$outputData .= "<aggregate_{$aggregateLabelTag}>\r\n";
					$outputData .= "<label>" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['label'][$index]) . "</label>\r\n";
					$outputData .= "<value>" . $this->outputCombinationXmlProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value)) . "</value>\r\n";
					$outputData .= "</aggregate_{$aggregateLabelTag}>\r\n";
				}
			}
	...
	function outputCombinationCsvContent($tableDef, $tableData) {
        $hasChildren = $this->outputCombinationHasChildren($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData]);

		if ($this->csvHeader) {
			return $this->outputCombinationCsvHeader($tableDef, $hasChildren) .
			       $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_y_axys']), $hasChildren);
		} else {
			return $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_y_axys']), $hasChildren);
		}
	...
	function outputCombinationCsvHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by'] as $groupByName) {
				$headers[] = $groupByName;
			}
		}
		else {
			$headers[] = current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by']);
		}

		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['label'] as $summName) {
			$headers[] = $summName;
		}
	...
	function outputCombinationCsvRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$thisRow[] = $this->outputCombinationCsvProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value));
			}
	...
	function outputCombinationRtfContent($tableDef, $tableData) {
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n" .
		       ...
		       $this->outputCombinationRtfRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_y_axys']), $hasChildren) .
			   "</table>\r\n" .
		       "</DOC>\r\n";
	...
	function outputCombinationRtfHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td>" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationRtfRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td>" . $this->outputCombinationRtfProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
	...
	function outputCombinationXlsContent($tableDef, $tableData) {
		...
		$this->outputCombinationXlsRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_y_axys']), $hasChildren);
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by'] as $groupByName) {
				$this->addXlsCell(array(
					...
					'align'   => 'left'
                         ...
                         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by'] == null) {
                             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by'] = array();
                         }
			$this->addXlsCell(array(
				'col'     => $column++,
				'row'     => $this->thisRow,
				'content' => current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by']),
				'size'    => 'auto',
				'bold'    => true,
				'align'   => 'left'
			));
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$this->addXlsCell(array(
					'col'     => $column++,
					'row'     => $this->thisRow,
					'content' => $this->outputCombinationXlsProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value)),
					'align'   => 'right'
				));
			}
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_export_word_css'] = 'color';

        if (isset($_REQUEST['nmgp_cor_word'])) {
            if ('pb' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_export_word_css'] = 'bw';
	...
	function outputCombinationWordContent($tableDef, $tableData) {
		...
		return "<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:word\" xmlns=\"http://www.w3.org/TR/REC-html40\"{$_SESSION['scriptcase']['reg_conf']['html_dir']}>\r\n" .
		       ...
		       $this->outputCombinationWordRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_y_axys']), $hasChildren) .
		       "</table>\r\n" .
		       "</body>\r\n" .
		       "</html>\r\n";
	...
	function outputCombinationWordCss() {
		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['chart_export_word_css']) {
			$cssFile    = "{$this->Ini->str_schema_all}_grid_bw.css";
			$cssDirFile = "{$this->Ini->str_schema_all}_grid_bw{$_SESSION['scriptcase']['reg_conf']['css_dir']}.css";
		}
		else {
	...
	function outputCombinationWordHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td class=\"scGridLabelFont\">" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationWordRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td class=\"scGridFieldOdd scGridFieldOddFont\">" . $this->outputCombinationWordProtectNumber(chart_mes_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
...
SCEOT;
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "chart_mes_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . "/");
...
<form name="Fdown" method="get" action="chart_mes_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="chart_mes"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_mes'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['chart_mes']['sc_process_barr'])) {
       return;
   }
   ...
   SC_dir_app_ini('CRUE');
   $_SESSION['scriptcase']['chart_mes']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_chart_mes($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_chart_mes($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (!isset($_SERVER['HTTP_REFERER']) && !isset($nmgp_parms) && !isset($script_case_init) && !isset($nmgp_start) && !isset($_SESSION['scriptcase']['refresh']['chart_mes']))
   {
       $Sem_Session = false;
   }
   $NM_dir_atual = getcwd();
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . "/sc_apl_default_CRUE.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['chart_mes']['glo_nm_path_imag_temp'] . "/sc_apl_default_CRUE.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "chart_mes") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['chart_mes']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['chart_mes']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['chart_mes']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CRUE'])) {
               $_SESSION['scriptcase']['chart_mes']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CRUE'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['chart_mes']['master_pai']) && $_SESSION['sc_session'][$init_filho]['chart_mes']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['chart_mes']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_mes']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['chart_mes']);
               $_SESSION['sc_session'][$script_case_init]['chart_mes']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   {
       unset($_SESSION['scriptcase']['refresh']['chart_mes']);
   }
   if (isset($_SESSION['scriptcase']['refresh']['chart_mes']))
   {
       if (!isset($script_case_init) && isset($_SESSION['scriptcase']['refresh']['chart_mes']['init'])) {
           $script_case_init = $_SESSION['scriptcase']['refresh']['chart_mes']['init'];
       }
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['contr_total_geral'] = "NAO";
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['contr_array_resumo'] = "NAO";
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['tot_geral']);
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida']) && $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true' && !isset($_SESSION['scriptcase']['refresh']['chart_mes']))
   {
       $script_case_init = "";
   }
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['chart_mes']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['chart_mes']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['chart_mes']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['chart_mes']['protect_modal']) && !empty($_SESSION['scriptcase']['chart_mes']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['chart_mes']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "chart_mes";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'chart_mes' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['chart_mes']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/chart_mes/'))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['chart_mes']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'chart_mes')
   {
       $_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['chart_mes']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/chart_mes_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['chart_mes']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = $nmgp_opcao ;  
       }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['chart_mes']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['chart_mes']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['chart_mes']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['volta_redirect_tp'] = "";
           $nm_url_saida = "chart_mes_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['chart_mes']['sc_modal'] = true;
               }
               $nm_url_saida = "chart_mes_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['chart_mes']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['chart_mes']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['chart_mes']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['chart_mes']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['chart_mes']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['chart_mes']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['chart_mes']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['chart_mes']['mostra_edit'] = "N";   
           } 
       ...
       $contr_chart_mes = new chart_mes_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = "busca";
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = "busca";
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = "busca";
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] = "busca";
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_comb_table' == $nmgp_opcao)
      {
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = "ajax_comb_table";
      }
      if ('ajax_comb_save' == $nmgp_opcao)
      {
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = "ajax_comb_save";
      }
      if ('ajax_comb_sort' == $nmgp_opcao)
      {
          $contr_chart_mes->NM_ajax_flag = true;
          $contr_chart_mes->NM_ajax_opcao = "ajax_comb_sort";
      }
       $contr_chart_mes->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['chart_mes']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_chart_mes(&$str)
   {
   }
   function nm_protect_num_chart_mes($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function chart_mes_pack_protect_string($sString)
   {
    ...
    function chart_mes_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['chart_mes']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
