<?php
@session_start() ;
$_SESSION['scriptcase']['chart_procedimiento1']['sc_process_barr'] = true;
require_once('../chart_procedimiento1/index.php');
unset($_SESSION['scriptcase']['chart_procedimiento1']['sc_process_barr']);
$ExportCtrl = new chart_procedimiento1_export_control;
$ExportCtrl->Export_barr();

class chart_procedimiento1_export_control
{
