...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____chart_procedimiento1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____chart_procedimiento1"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_procedimiento1</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_procedimiento1']['embutida_filho'] as $ind => $sc_init)
          {
