<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['chart_procedimiento1']['glo_nm_path_imag_temp'] . "/sc_apl_default_CRUE.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new chart_procedimiento1_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class chart_procedimiento1_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       if (isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['using_summary_cache'])) {
           unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['using_summary_cache']);
       }
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_tabular']);
           ...
           $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       if (array_key_exists('pivot_x_axys', $_SESSION['sc_session'][$sc_init]['chart_procedimiento1'])) {
           if ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_x_axys'] != $xaxys_list || $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_y_axys'] != $yaxys_list) {
               $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['contr_array_resumo'] = "NAO";
               $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['contr_total_geral']  = "NAO";
           }
       }
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['fecha'] = "" . sprintf("" . $this->Nm_lang['lang_othr_chart_title_YYYYMMDD2'] . " fecha", "Fecha") . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> procedimiento1</TITLE>
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['chart_procedimiento1'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['chart_procedimiento1']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['chart_procedimiento1'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['chart_procedimiento1'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
