<?php
//
class editar_procedimiento_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new editar_procedimiento_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['editar_procedimiento']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['editar_procedimiento']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['editar_procedimiento'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['editar_procedimiento']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['editar_procedimiento']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('editar_procedimiento') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['editar_procedimiento']['label'] = "Actualizar procedimiento";
      ...
      $_SESSION['scriptcase']['error_icon']['editar_procedimiento']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['editar_procedimiento'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['editar_procedimiento']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['editar_procedimiento'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['editar_procedimiento'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("editar_procedimiento", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'editar_procedimiento_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'editar_procedimiento_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'editar_procedimiento/editar_procedimiento_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "editar_procedimiento_erro.class.php"); 
      }
      $this->Erro      = new editar_procedimiento_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao']))
         { 
             if ($this->id_procedimiento != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['editar_procedimiento']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao'] = "novo";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['editar_procedimiento']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['editar_procedimiento']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "editar_procedimiento.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="editar_procedimiento_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="editar_procedimiento"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'editar_procedimiento', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'editar_procedimiento', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'editar_procedimiento', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_editar_procedimiento']) || !is_array($this->NM_ajax_info['errList']['geral_editar_procedimiento']))
              {
                  $this->NM_ajax_info['errList']['geral_editar_procedimiento'] = array();
              }
              $this->NM_ajax_info['errList']['geral_editar_procedimiento'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   if (isset($this->Field_no_validate['genero'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero']) && !in_array($this->genero, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['id_tipo_evento'])) {
       return;
               ...
               if (!empty($this->id_tipo_evento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento']) && !in_array($this->id_tipo_evento, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['id_eps'])) {
       return;
               ...
               if (!empty($this->id_eps) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps']) && !in_array($this->id_eps, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['id_seguridad_social'])) {
       return;
               ...
               if (!empty($this->id_seguridad_social) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social']) && !in_array($this->id_seguridad_social, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['id_barrio'])) {
       return;
               ...
               if (!empty($this->id_barrio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio']) && !in_array($this->id_barrio, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['id_movil'])) {
       return;
               ...
               if (!empty($this->id_movil) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil']) && !in_array($this->id_movil, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['id_ips'])) {
       return;
               ...
               if (!empty($this->id_ips) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips']) && !in_array($this->id_ips, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['id_medico'])) {
       return;
               ...
               if (!empty($this->id_medico) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico']) && !in_array($this->id_medico, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_procedimiento']['keyVal'] = editar_procedimiento_pack_protect_string($this->nmgp_dados_form['id_procedimiento']);
          }
   } // ajax_return_values
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('PONAL ') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("PONAL ")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('BOMBEROS ') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("BOMBEROS ")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('CRUZ ROJA ') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("CRUZ ROJA ")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('CRUEB') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("CRUEB")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('SCOUTS') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("SCOUTS")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('USUARIO A NUMERO CRUEMT') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("USUARIO A NUMERO CRUEMT")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('PS SALUD MENTAL') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("PS SALUD MENTAL")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('MOVIL 1') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("MOVIL 1")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('MOVIL 2') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("MOVIL 2")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'PONAL ';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'BOMBEROS ';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'CRUZ ROJA ';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'CRUEB';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'SCOUTS';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'USUARIO A NUMERO CRUEMT';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'PS SALUD MENTAL';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'MOVIL 1';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'MOVIL 2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['quien_reporta']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('VISUAL') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("VISUAL")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('AUDITIVA') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("AUDITIVA")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('FISICA') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("FISICA")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('SORDOCEGUERA') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("SORDOCEGUERA")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('MULTIPLE') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("MULTIPLE")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('INTELECTUAL ') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("INTELECTUAL ")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('PSICOSOCIAL') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("PSICOSOCIAL")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'VISUAL';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'AUDITIVA';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'FISICA';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'SORDOCEGUERA';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'MULTIPLE';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'INTELECTUAL ';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'PSICOSOCIAL';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['discapacidad']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('CC') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("CC")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('RC') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("RC")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('CE') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("CE")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('PEP') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("PEP")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('TI') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("TI")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('SC') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("SC")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('PAS') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("PAS")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('NI') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("NI")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('SIN DATO') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("SIN DATO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'CC';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'RC';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'CE';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'PEP';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'TI';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'SC';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'PAS';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'NI';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'SIN DATO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_documento']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('M') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("M")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('T') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("T")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('F') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("F")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('N') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("N")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('O') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("O")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'T';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'N';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'O';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['genero']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(editar_procedimiento_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', editar_procedimiento_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_tipo_evento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_tipo_evento']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_eps'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_eps']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_seguridad_social'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_seguridad_social']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('SUR') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("SUR")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('NORTE') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("NORTE")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('ORIENTE') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("ORIENTE")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('OCCIDENTE') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("OCCIDENBTE")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('RURAL') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("RURAL")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('CENTRO') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("CENTRO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'SUR';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'NORTE';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'ORIENTE';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'OCCIDENTE';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'RURAL';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'CENTRO';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"zona\"";
          ...
          {
              $this->NM_ajax_info['fldList']['zona']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('Ambulancia') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("Ambulancia")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('Referencia y contrareferencia') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("Referencia y contrareferencia")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('TAB') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("TAB")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('Otros') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("Otros")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'Ambulancia';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'Referencia y contrareferencia';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'TAB';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'Otros';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_servicio']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_barrio'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_barrio']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_movil'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_movil']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_ips'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_ips']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(editar_procedimiento_pack_protect_string('EFECTIVO') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("EFECTIVO")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('NO EFECTIVO') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("NO EFECTIVO")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('FALLIDO') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("FALLIDO")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('APOYO PSICOSOCIAL') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("APOYO PSICOSOCIAL")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('APH') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("APH")));
$aLookup[] = array(editar_procedimiento_pack_protect_string('ASESORIA MEDICA TELEFONICA') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string("ASESORIA MEDICA TELEFONICA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'EFECTIVO';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'NO EFECTIVO';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'FALLIDO';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'APOYO PSICOSOCIAL';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'APH';
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'ASESORIA MEDICA TELEFONICA';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_caso']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico'] = array(); 
}
$aLookup[] = array(editar_procedimiento_pack_protect_string('') => str_replace('<', '&lt;',editar_procedimiento_pack_protect_string('Seleccione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_id_medico'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_medico']['valList'][$i] = editar_procedimiento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['editar_procedimiento']['contr_erro'] = 'on';
             /* atencion */
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_editar_procedimiento';
...
$_SESSION['scriptcase']['editar_procedimiento']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['parms'] = "id_procedimiento?#?$this->id_procedimiento?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_editar_procedimiento = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] = $qt_geral_reg_editar_procedimiento;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_procedimiento))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_editar_procedimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] > $qt_geral_reg_editar_procedimiento)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] = $qt_geral_reg_editar_procedimiento; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_editar_procedimiento) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] < $qt_geral_reg_editar_procedimiento;
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("editar_procedimiento_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_editar_procedimiento = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] = $qt_geral_reg_editar_procedimiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          editar_procedimiento_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "editar_procedimiento_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['nm_run_menu'] = 2;
       $nmgp_saida_form = "editar_procedimiento_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['ordem_ord'] == " desc") {
