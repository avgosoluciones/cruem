...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Procedimiento"); } else { echo strip_tags("Actualizar procedimiento"); } ?></TITLE>
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>editar_procedimiento/editar_procedimiento_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("editar_procedimiento_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('editar_procedimiento_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['link_info']['remove_border']) {
...
<?php
 include_once("editar_procedimiento_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['editar_procedimiento'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['editar_procedimiento'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
?>
<table id="main_table_form"  align="center" cellpadding=0 cellspacing=0  width="20%">
 <tr>
  <td>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_consecutivo_line" id="hidden_field_data_consecutivo" style="<?php echo $sStyleHidden_consecutivo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consecutivo_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="consecutivo" value="<?php echo $this->form_encode_input($consecutivo); ?>"><span id="id_ajax_label_consecutivo"><?php echo nl2br($consecutivo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_secad_label" id="hidden_field_label_secad" style="<?php echo $sStyleHidden_secad; ?>"><span id="id_label_secad"><?php echo $this->nm_new_label['secad']; ?></span></TD>
    <TD class="scFormDataOdd css_secad_line" id="hidden_field_data_secad" style="<?php echo $sStyleHidden_secad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_secad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_quien_reporta_label" id="hidden_field_label_quien_reporta" style="<?php echo $sStyleHidden_quien_reporta; ?>"><span id="id_label_quien_reporta"><?php echo $this->nm_new_label['quien_reporta']; ?></span></TD>
    <TD class="scFormDataOdd css_quien_reporta_line" id="hidden_field_data_quien_reporta" style="<?php echo $sStyleHidden_quien_reporta; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_quien_reporta_line" style="vertical-align: top;padding: 0px">
...
$quien_reporta_look = "";
 ...
 if ($this->quien_reporta == "CRUEB") { $quien_reporta_look .= "CRUEB" ;} 
 if ($this->quien_reporta == "SCOUTS") { $quien_reporta_look .= "SCOUTS" ;} 
 if ($this->quien_reporta == "USUARIO A NUMERO CRUEMT") { $quien_reporta_look .= "USUARIO A NUMERO CRUEMT" ;} 
 if ($this->quien_reporta == "PS SALUD MENTAL") { $quien_reporta_look .= "PS SALUD MENTAL" ;} 
 if ($this->quien_reporta == "MOVIL 1") { $quien_reporta_look .= "MOVIL 1" ;} 
 if ($this->quien_reporta == "MOVIL 2") { $quien_reporta_look .= "MOVIL 2" ;} 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="PONAL " <?php  if ($this->quien_reporta == "PONAL ") { echo " selected" ;} ?>>PONAL </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'PONAL '; ?>
 <option  value="BOMBEROS " <?php  if ($this->quien_reporta == "BOMBEROS ") { echo " selected" ;} ?>>BOMBEROS </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'BOMBEROS '; ?>
 <option  value="CRUZ ROJA " <?php  if ($this->quien_reporta == "CRUZ ROJA ") { echo " selected" ;} ?>>CRUZ ROJA </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'CRUZ ROJA '; ?>
 <option  value="CRUEB" <?php  if ($this->quien_reporta == "CRUEB") { echo " selected" ;} ?>>CRUEB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'CRUEB'; ?>
 <option  value="SCOUTS" <?php  if ($this->quien_reporta == "SCOUTS") { echo " selected" ;} ?>>SCOUTS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'SCOUTS'; ?>
 <option  value="USUARIO A NUMERO CRUEMT" <?php  if ($this->quien_reporta == "USUARIO A NUMERO CRUEMT") { echo " selected" ;} ?>>USUARIO A NUMERO CRUEMT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'USUARIO A NUMERO CRUEMT'; ?>
 <option  value="PS SALUD MENTAL" <?php  if ($this->quien_reporta == "PS SALUD MENTAL") { echo " selected" ;} ?>>PS SALUD MENTAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'PS SALUD MENTAL'; ?>
 <option  value="MOVIL 1" <?php  if ($this->quien_reporta == "MOVIL 1") { echo " selected" ;} ?>>MOVIL 1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'MOVIL 1'; ?>
 <option  value="MOVIL 2" <?php  if ($this->quien_reporta == "MOVIL 2") { echo " selected" ;} ?>>MOVIL 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_quien_reporta'][] = 'MOVIL 2'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="VISUAL" <?php  if ($this->discapacidad == "VISUAL") { echo " selected" ;} ?>>VISUAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'VISUAL'; ?>
 <option  value="AUDITIVA" <?php  if ($this->discapacidad == "AUDITIVA") { echo " selected" ;} ?>>AUDITIVA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'AUDITIVA'; ?>
 <option  value="FISICA" <?php  if ($this->discapacidad == "FISICA") { echo " selected" ;} ?>>FISICA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'FISICA'; ?>
 <option  value="SORDOCEGUERA" <?php  if ($this->discapacidad == "SORDOCEGUERA") { echo " selected" ;} ?>>SORDOCEGUERA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'SORDOCEGUERA'; ?>
 <option  value="MULTIPLE" <?php  if ($this->discapacidad == "MULTIPLE") { echo " selected" ;} ?>>MULTIPLE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'MULTIPLE'; ?>
 <option  value="INTELECTUAL " <?php  if ($this->discapacidad == "INTELECTUAL ") { echo " selected" ;} ?>>INTELECTUAL </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'INTELECTUAL '; ?>
 <option  value="PSICOSOCIAL" <?php  if ($this->discapacidad == "PSICOSOCIAL") { echo " selected" ;} ?>>PSICOSOCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_discapacidad'][] = 'PSICOSOCIAL'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombre_apellido_label" id="hidden_field_label_nombre_apellido" style="<?php echo $sStyleHidden_nombre_apellido; ?>"><span id="id_label_nombre_apellido"><?php echo $this->nm_new_label['nombre_apellido']; ?></span></TD>
    <TD class="scFormDataOdd css_nombre_apellido_line" id="hidden_field_data_nombre_apellido" style="<?php echo $sStyleHidden_nombre_apellido; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_apellido_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_documento_label" id="hidden_field_label_tipo_documento" style="<?php echo $sStyleHidden_tipo_documento; ?>"><span id="id_label_tipo_documento"><?php echo $this->nm_new_label['tipo_documento']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_documento_line" id="hidden_field_data_tipo_documento" style="<?php echo $sStyleHidden_tipo_documento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_documento_line" style="vertical-align: top;padding: 0px">
...
$tipo_documento_look = "";
 if ($this->tipo_documento == "CC") { $tipo_documento_look .= "CC" ;} 
 if ($this->tipo_documento == "RC") { $tipo_documento_look .= "RC" ;} 
 if ($this->tipo_documento == "CE") { $tipo_documento_look .= "CE" ;} 
 if ($this->tipo_documento == "PEP") { $tipo_documento_look .= "PEP" ;} 
 if ($this->tipo_documento == "TI") { $tipo_documento_look .= "TI" ;} 
 if ($this->tipo_documento == "SC") { $tipo_documento_look .= "SC" ;} 
 if ($this->tipo_documento == "PAS") { $tipo_documento_look .= "PAS" ;} 
 if ($this->tipo_documento == "NI") { $tipo_documento_look .= "NI" ;} 
 if ($this->tipo_documento == "SIN DATO") { $tipo_documento_look .= "SIN DATO" ;} 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="CC" <?php  if ($this->tipo_documento == "CC") { echo " selected" ;} ?>>CC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'CC'; ?>
 <option  value="RC" <?php  if ($this->tipo_documento == "RC") { echo " selected" ;} ?>>RC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'RC'; ?>
 <option  value="CE" <?php  if ($this->tipo_documento == "CE") { echo " selected" ;} ?>>CE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'CE'; ?>
 <option  value="PEP" <?php  if ($this->tipo_documento == "PEP") { echo " selected" ;} ?>>PEP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'PEP'; ?>
 <option  value="TI" <?php  if ($this->tipo_documento == "TI") { echo " selected" ;} ?>>TI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'TI'; ?>
 <option  value="SC" <?php  if ($this->tipo_documento == "SC") { echo " selected" ;} ?>>SC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'SC'; ?>
 <option  value="PAS" <?php  if ($this->tipo_documento == "PAS") { echo " selected" ;} ?>>PAS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'PAS'; ?>
 <option  value="NI" <?php  if ($this->tipo_documento == "NI") { echo " selected" ;} ?>>NI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'NI'; ?>
 <option  value="SIN DATO" <?php  if ($this->tipo_documento == "SIN DATO") { echo " selected" ;} ?>>SIN DATO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_documento'][] = 'SIN DATO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_documento_identidad_label" id="hidden_field_label_documento_identidad" style="<?php echo $sStyleHidden_documento_identidad; ?>"><span id="id_label_documento_identidad"><?php echo $this->nm_new_label['documento_identidad']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_contacto_label" id="hidden_field_label_numero_contacto" style="<?php echo $sStyleHidden_numero_contacto; ?>"><span id="id_label_numero_contacto"><?php echo $this->nm_new_label['numero_contacto']; ?></span></TD>
    <TD class="scFormDataOdd css_numero_contacto_line" id="hidden_field_data_numero_contacto" style="<?php echo $sStyleHidden_numero_contacto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_contacto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_genero_label" id="hidden_field_label_genero" style="<?php echo $sStyleHidden_genero; ?>"><span id="id_label_genero"><?php echo $this->nm_new_label['genero']; ?></span></TD>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["genero"]) &&  $this->nmgp_cmp_readonly["genero"] == "on") { 
 ...
 if ("M" == $this->genero) { $genero_look = "M";} 
 if ("T" == $this->genero) { $genero_look = "T";} 
 if ("F" == $this->genero) { $genero_look = "F";} 
 if ("N" == $this->genero) { $genero_look = "N";} 
 if ("O" == $this->genero) { $genero_look = "O";} 
?>
...
<?php
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['pdf_view']) {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'M'; ?>
<?php  if ("M" == $this->genero)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php $tempOptionId = "id-opt-genero" . $sc_seq_vert . "-2"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-genero sc-ui-radio-genero" type=radio name="genero" value="T"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'T'; ?>
<?php  if ("T" == $this->genero)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'F'; ?>
<?php  if ("F" == $this->genero)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php $tempOptionId = "id-opt-genero" . $sc_seq_vert . "-4"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-genero sc-ui-radio-genero" type=radio name="genero" value="N"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'N'; ?>
<?php  if ("N" == $this->genero)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php $tempOptionId = "id-opt-genero" . $sc_seq_vert . "-5"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-genero sc-ui-radio-genero" type=radio name="genero" value="O"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_genero'][] = 'O'; ?>
<?php  if ("O" == $this->genero)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tipo_evento_label" id="hidden_field_label_id_tipo_evento" style="<?php echo $sStyleHidden_id_tipo_evento; ?>"><span id="id_label_id_tipo_evento"><?php echo $this->nm_new_label['id_tipo_evento']; ?></span></TD>
    <TD class="scFormDataOdd css_id_tipo_evento_line" id="hidden_field_data_id_tipo_evento" style="<?php echo $sStyleHidden_id_tipo_evento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tipo_evento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_circunstancias_emergencia_label" id="hidden_field_label_circunstancias_emergencia" style="<?php echo $sStyleHidden_circunstancias_emergencia; ?>"><span id="id_label_circunstancias_emergencia"><?php echo $this->nm_new_label['circunstancias_emergencia']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_eps_label" id="hidden_field_label_id_eps" style="<?php echo $sStyleHidden_id_eps; ?>"><span id="id_label_id_eps"><?php echo $this->nm_new_label['id_eps']; ?></span></TD>
    <TD class="scFormDataOdd css_id_eps_line" id="hidden_field_data_id_eps" style="<?php echo $sStyleHidden_id_eps; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_eps_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_seguridad_social_label" id="hidden_field_label_id_seguridad_social" style="<?php echo $sStyleHidden_id_seguridad_social; ?>"><span id="id_label_id_seguridad_social"><?php echo $this->nm_new_label['id_seguridad_social']; ?></span></TD>
    <TD class="scFormDataOdd css_id_seguridad_social_line" id="hidden_field_data_id_seguridad_social" style="<?php echo $sStyleHidden_id_seguridad_social; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_seguridad_social_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zona_label" id="hidden_field_label_zona" style="<?php echo $sStyleHidden_zona; ?>"><span id="id_label_zona"><?php echo $this->nm_new_label['zona']; ?></span></TD>
    <TD class="scFormDataOdd css_zona_line" id="hidden_field_data_zona" style="<?php echo $sStyleHidden_zona; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zona_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="SUR" <?php  if ($this->zona == "SUR") { echo " selected" ;} ?>>SUR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'SUR'; ?>
 <option  value="NORTE" <?php  if ($this->zona == "NORTE") { echo " selected" ;} ?>>NORTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'NORTE'; ?>
 <option  value="ORIENTE" <?php  if ($this->zona == "ORIENTE") { echo " selected" ;} ?>>ORIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'ORIENTE'; ?>
 <option  value="OCCIDENTE" <?php  if ($this->zona == "OCCIDENTE") { echo " selected" ;} ?>>OCCIDENBTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'OCCIDENTE'; ?>
 <option  value="RURAL" <?php  if ($this->zona == "RURAL") { echo " selected" ;} ?>>RURAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'RURAL'; ?>
 <option  value="CENTRO" <?php  if ($this->zona == "CENTRO") { echo " selected" ;} ?>>CENTRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_zona'][] = 'CENTRO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_servicio_label" id="hidden_field_label_tipo_servicio" style="<?php echo $sStyleHidden_tipo_servicio; ?>"><span id="id_label_tipo_servicio"><?php echo $this->nm_new_label['tipo_servicio']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_servicio_line" id="hidden_field_data_tipo_servicio" style="<?php echo $sStyleHidden_tipo_servicio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_servicio_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="Ambulancia" <?php  if ($this->tipo_servicio == "Ambulancia") { echo " selected" ;} ?>>Ambulancia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'Ambulancia'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'Referencia y contrareferencia'; ?>
 <option  value="TAB" <?php  if ($this->tipo_servicio == "TAB") { echo " selected" ;} ?>>TAB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'TAB'; ?>
 <option  value="Otros" <?php  if ($this->tipo_servicio == "Otros") { echo " selected" ;} ?>>Otros</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_servicio'][] = 'Otros'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_barrio_label" id="hidden_field_label_id_barrio" style="<?php echo $sStyleHidden_id_barrio; ?>"><span id="id_label_id_barrio"><?php echo $this->nm_new_label['id_barrio']; ?></span></TD>
    <TD class="scFormDataOdd css_id_barrio_line" id="hidden_field_data_id_barrio" style="<?php echo $sStyleHidden_id_barrio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_barrio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_servicio_label" id="hidden_field_label_direccion_servicio" style="<?php echo $sStyleHidden_direccion_servicio; ?>"><span id="id_label_direccion_servicio"><?php echo $this->nm_new_label['direccion_servicio']; ?></span></TD>
    <TD class="scFormDataOdd css_direccion_servicio_line" id="hidden_field_data_direccion_servicio" style="<?php echo $sStyleHidden_direccion_servicio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_servicio_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_ingreso_llamada_label" id="hidden_field_label_hora_ingreso_llamada" style="<?php echo $sStyleHidden_hora_ingreso_llamada; ?>"><span id="id_label_hora_ingreso_llamada"><?php echo $this->nm_new_label['hora_ingreso_llamada']; ?></span></TD>
    <TD class="scFormDataOdd css_hora_ingreso_llamada_line" id="hidden_field_data_hora_ingreso_llamada" style="<?php echo $sStyleHidden_hora_ingreso_llamada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hora_ingreso_llamada_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_notifica_movil_label" id="hidden_field_label_hora_notifica_movil" style="<?php echo $sStyleHidden_hora_notifica_movil; ?>"><span id="id_label_hora_notifica_movil"><?php echo $this->nm_new_label['hora_notifica_movil']; ?></span></TD>
    <TD class="scFormDataOdd css_hora_notifica_movil_line" id="hidden_field_data_hora_notifica_movil" style="<?php echo $sStyleHidden_hora_notifica_movil; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hora_notifica_movil_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_llegada_sitio_label" id="hidden_field_label_hora_llegada_sitio" style="<?php echo $sStyleHidden_hora_llegada_sitio; ?>"><span id="id_label_hora_llegada_sitio"><?php echo $this->nm_new_label['hora_llegada_sitio']; ?></span></TD>
    <TD class="scFormDataOdd css_hora_llegada_sitio_line" id="hidden_field_data_hora_llegada_sitio" style="<?php echo $sStyleHidden_hora_llegada_sitio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hora_llegada_sitio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_llegada_ips_label" id="hidden_field_label_hora_llegada_ips" style="<?php echo $sStyleHidden_hora_llegada_ips; ?>"><span id="id_label_hora_llegada_ips"><?php echo $this->nm_new_label['hora_llegada_ips']; ?></span></TD>
    <TD class="scFormDataOdd css_hora_llegada_ips_line" id="hidden_field_data_hora_llegada_ips" style="<?php echo $sStyleHidden_hora_llegada_ips; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hora_llegada_ips_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_salida_ips_label" id="hidden_field_label_hora_salida_ips" style="<?php echo $sStyleHidden_hora_salida_ips; ?>"><span id="id_label_hora_salida_ips"><?php echo $this->nm_new_label['hora_salida_ips']; ?></span></TD>
    <TD class="scFormDataOdd css_hora_salida_ips_line" id="hidden_field_data_hora_salida_ips" style="<?php echo $sStyleHidden_hora_salida_ips; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hora_salida_ips_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_movil_label" id="hidden_field_label_id_movil" style="<?php echo $sStyleHidden_id_movil; ?>"><span id="id_label_id_movil"><?php echo $this->nm_new_label['id_movil']; ?></span></TD>
    <TD class="scFormDataOdd css_id_movil_line" id="hidden_field_data_id_movil" style="<?php echo $sStyleHidden_id_movil; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_movil_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_ips_label" id="hidden_field_label_id_ips" style="<?php echo $sStyleHidden_id_ips; ?>"><span id="id_label_id_ips"><?php echo $this->nm_new_label['id_ips']; ?></span></TD>
    <TD class="scFormDataOdd css_id_ips_line" id="hidden_field_data_id_ips" style="<?php echo $sStyleHidden_id_ips; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_ips_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_caso_label" id="hidden_field_label_tipo_caso" style="<?php echo $sStyleHidden_tipo_caso; ?>"><span id="id_label_tipo_caso"><?php echo $this->nm_new_label['tipo_caso']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_caso_line" id="hidden_field_data_tipo_caso" style="<?php echo $sStyleHidden_tipo_caso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_caso_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="EFECTIVO" <?php  if ($this->tipo_caso == "EFECTIVO") { echo " selected" ;} ?>>EFECTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'EFECTIVO'; ?>
 <option  value="NO EFECTIVO" <?php  if ($this->tipo_caso == "NO EFECTIVO") { echo " selected" ;} ?>>NO EFECTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'NO EFECTIVO'; ?>
 <option  value="FALLIDO" <?php  if ($this->tipo_caso == "FALLIDO") { echo " selected" ;} ?>>FALLIDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'FALLIDO'; ?>
 <option  value="APOYO PSICOSOCIAL" <?php  if ($this->tipo_caso == "APOYO PSICOSOCIAL") { echo " selected" ;} ?>>APOYO PSICOSOCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'APOYO PSICOSOCIAL'; ?>
 <option  value="APH" <?php  if ($this->tipo_caso == "APH") { echo " selected" ;} ?>>APH</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'APH'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['Lookup_tipo_caso'][] = 'ASESORIA MEDICA TELEFONICA'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_medico_label" id="hidden_field_label_id_medico" style="<?php echo $sStyleHidden_id_medico; ?>"><span id="id_label_id_medico"><?php echo $this->nm_new_label['id_medico']; ?></span></TD>
    <TD class="scFormDataOdd css_id_medico_line" id="hidden_field_data_id_medico" style="<?php echo $sStyleHidden_id_medico; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_medico_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("editar_procedimiento");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("editar_procedimiento");
 parent.scAjaxDetailHeight("editar_procedimiento", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
