...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>editar_procedimiento/editar_procedimiento_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("editar_procedimiento_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('editar_procedimiento_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['editar_procedimiento']['error_buffer']) && '' != $_SESSION['scriptcase']['editar_procedimiento']['error_buffer'])
{
    echo $_SESSION['scriptcase']['editar_procedimiento']['error_buffer'];
}
...
<?php
 include_once("editar_procedimiento_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="editar_procedimiento_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['editar_procedimiento_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['editar_procedimiento_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="PONAL " <?php  if ($this->quien_reporta == "PONAL ") { echo " selected" ;} ?>>PONAL </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'PONAL '; ?>
 <option  value="BOMBEROS " <?php  if ($this->quien_reporta == "BOMBEROS ") { echo " selected" ;} ?>>BOMBEROS </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'BOMBEROS '; ?>
 <option  value="CRUZ ROJA " <?php  if ($this->quien_reporta == "CRUZ ROJA ") { echo " selected" ;} ?>>CRUZ ROJA </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'CRUZ ROJA '; ?>
 <option  value="CRUEB" <?php  if ($this->quien_reporta == "CRUEB") { echo " selected" ;} ?>>CRUEB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'CRUEB'; ?>
 <option  value="SCOUTS" <?php  if ($this->quien_reporta == "SCOUTS") { echo " selected" ;} ?>>SCOUTS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'SCOUTS'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'USUARIO A NUMERO CRUEMT'; ?>
 <option  value="PS SALUD MENTAL" <?php  if ($this->quien_reporta == "PS SALUD MENTAL") { echo " selected" ;} ?>>PS SALUD MENTAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'PS SALUD MENTAL'; ?>
 <option  value="MOVIL 1" <?php  if ($this->quien_reporta == "MOVIL 1") { echo " selected" ;} ?>>MOVIL 1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'MOVIL 1'; ?>
 <option  value="MOVIL 2" <?php  if ($this->quien_reporta == "MOVIL 2") { echo " selected" ;} ?>>MOVIL 2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_quien_reporta'][] = 'MOVIL 2'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="VISUAL" <?php  if ($this->discapacidad == "VISUAL") { echo " selected" ;} ?>>VISUAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'VISUAL'; ?>
 <option  value="AUDITIVA" <?php  if ($this->discapacidad == "AUDITIVA") { echo " selected" ;} ?>>AUDITIVA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'AUDITIVA'; ?>
 <option  value="FISICA" <?php  if ($this->discapacidad == "FISICA") { echo " selected" ;} ?>>FISICA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'FISICA'; ?>
 <option  value="SORDOCEGUERA" <?php  if ($this->discapacidad == "SORDOCEGUERA") { echo " selected" ;} ?>>SORDOCEGUERA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'SORDOCEGUERA'; ?>
 <option  value="MULTIPLE" <?php  if ($this->discapacidad == "MULTIPLE") { echo " selected" ;} ?>>MULTIPLE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'MULTIPLE'; ?>
 <option  value="INTELECTUAL " <?php  if ($this->discapacidad == "INTELECTUAL ") { echo " selected" ;} ?>>INTELECTUAL </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'INTELECTUAL '; ?>
 <option  value="PSICOSOCIAL" <?php  if ($this->discapacidad == "PSICOSOCIAL") { echo " selected" ;} ?>>PSICOSOCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_discapacidad'][] = 'PSICOSOCIAL'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="CC" <?php  if ($this->tipo_documento == "CC") { echo " selected" ;} ?>>CC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'CC'; ?>
 <option  value="RC" <?php  if ($this->tipo_documento == "RC") { echo " selected" ;} ?>>RC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'RC'; ?>
 <option  value="CE" <?php  if ($this->tipo_documento == "CE") { echo " selected" ;} ?>>CE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'CE'; ?>
 <option  value="PEP" <?php  if ($this->tipo_documento == "PEP") { echo " selected" ;} ?>>PEP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'PEP'; ?>
 <option  value="TI" <?php  if ($this->tipo_documento == "TI") { echo " selected" ;} ?>>TI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'TI'; ?>
 <option  value="SC" <?php  if ($this->tipo_documento == "SC") { echo " selected" ;} ?>>SC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'SC'; ?>
 <option  value="PAS" <?php  if ($this->tipo_documento == "PAS") { echo " selected" ;} ?>>PAS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'PAS'; ?>
 <option  value="NI" <?php  if ($this->tipo_documento == "NI") { echo " selected" ;} ?>>NI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'NI'; ?>
 <option  value="SIN DATO" <?php  if ($this->tipo_documento == "SIN DATO") { echo " selected" ;} ?>>SIN DATO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_documento'][] = 'SIN DATO'; ?>
 </select></span>
</span><?php  }?>
...
<?php
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['pdf_view']) {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_genero'][] = 'M'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_genero'][] = 'T'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_genero'][] = 'F'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_genero'][] = 'N'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_genero'][] = 'O'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="SUR" <?php  if ($this->zona == "SUR") { echo " selected" ;} ?>>SUR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = 'SUR'; ?>
 <option  value="NORTE" <?php  if ($this->zona == "NORTE") { echo " selected" ;} ?>>NORTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = 'NORTE'; ?>
 <option  value="ORIENTE" <?php  if ($this->zona == "ORIENTE") { echo " selected" ;} ?>>ORIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = 'ORIENTE'; ?>
 <option  value="OCCIDENTE" <?php  if ($this->zona == "OCCIDENTE") { echo " selected" ;} ?>>OCCIDENBTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = 'OCCIDENTE'; ?>
 <option  value="RURAL" <?php  if ($this->zona == "RURAL") { echo " selected" ;} ?>>RURAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = 'RURAL'; ?>
 <option  value="CENTRO" <?php  if ($this->zona == "CENTRO") { echo " selected" ;} ?>>CENTRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_zona'][] = 'CENTRO'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_servicio'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="Ambulancia" <?php  if ($this->tipo_servicio == "Ambulancia") { echo " selected" ;} ?>>Ambulancia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_servicio'][] = 'Ambulancia'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_servicio'][] = 'Referencia y contrareferencia'; ?>
 <option  value="TAB" <?php  if ($this->tipo_servicio == "TAB") { echo " selected" ;} ?>>TAB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_servicio'][] = 'TAB'; ?>
 <option  value="Otros" <?php  if ($this->tipo_servicio == "Otros") { echo " selected" ;} ?>>Otros</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_servicio'][] = 'Otros'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="EFECTIVO" <?php  if ($this->tipo_caso == "EFECTIVO") { echo " selected" ;} ?>>EFECTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = 'EFECTIVO'; ?>
 <option  value="NO EFECTIVO" <?php  if ($this->tipo_caso == "NO EFECTIVO") { echo " selected" ;} ?>>NO EFECTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = 'NO EFECTIVO'; ?>
 <option  value="FALLIDO" <?php  if ($this->tipo_caso == "FALLIDO") { echo " selected" ;} ?>>FALLIDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = 'FALLIDO'; ?>
 <option  value="APOYO PSICOSOCIAL" <?php  if ($this->tipo_caso == "APOYO PSICOSOCIAL") { echo " selected" ;} ?>>APOYO PSICOSOCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = 'APOYO PSICOSOCIAL'; ?>
 <option  value="APH" <?php  if ($this->tipo_caso == "APH") { echo " selected" ;} ?>>APH</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = 'APH'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['Lookup_tipo_caso'][] = 'ASESORIA MEDICA TELEFONICA'; ?>
 </select></span>
</span><?php  }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("editar_procedimiento_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("editar_procedimiento_mob");
 parent.scAjaxDetailHeight("editar_procedimiento_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['editar_procedimiento_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
