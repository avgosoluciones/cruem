...
$old_error_handler = set_error_handler("form_ciudad_scriptcase_error_handler");

function form_ciudad_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_ciudad']['contr_erro']) && $_SESSION['scriptcase']['form_ciudad']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_ciudad->contr_form_ciudad->Apl_com_erro = true;
            if ($inicial_form_ciudad->contr_form_ciudad->NM_ajax_flag)
            {
                $inicial_form_ciudad->contr_form_ciudad->NM_ajax_info['errList']['geral_form_ciudad'][] = $msg;
                return;
            }
            form_ciudad_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_ciudad_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_ciudad'])  && '' != $_SESSION['scriptcase']['error_icon']['form_ciudad'])  ? $_SESSION['scriptcase']['error_icon']['form_ciudad']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_ciudad']) && '' != $_SESSION['scriptcase']['error_span_title']['form_ciudad']) ? $_SESSION['scriptcase']['error_span_title']['form_ciudad'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_ciudad']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_ciudad']) ? $_SESSION['scriptcase']['error_icon_title']['form_ciudad'] : '';
?>
