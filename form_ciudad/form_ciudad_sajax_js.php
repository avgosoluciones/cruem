  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ciudad" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_ciudad
  function do_ajax_form_ciudad_validate_id_ciudad()
  {
    var nomeCampo_id_ciudad = "id_ciudad";
    var var_id_ciudad = scAjaxGetFieldHidden(nomeCampo_id_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudad_validate_id_ciudad(var_id_ciudad, var_script_case_init, do_ajax_form_ciudad_validate_id_ciudad_cb);
  } // do_ajax_form_ciudad_validate_id_ciudad

  function do_ajax_form_ciudad_validate_id_ciudad_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudad_validate_id_ciudad_cb

  // ---------- Validate ciudad
  function do_ajax_form_ciudad_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldText(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciudad_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_ciudad_validate_ciudad_cb);
  } // do_ajax_form_ciudad_validate_ciudad

  function do_ajax_form_ciudad_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciudad_validate_ciudad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ciudad_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ciudad_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ciudad_submit_form(var_id_ciudad, var_ciudad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciudad_submit_form_cb);
  } // do_ajax_form_ciudad_submit_form

  function do_ajax_form_ciudad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ciudad_submit_form_cb_after_alert);
  } // do_ajax_form_ciudad_submit_form_cb
  function do_ajax_form_ciudad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ciudad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ciudad_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ciudad_navigate_form, function() {});
    } else {
      perform_ajax_form_ciudad_navigate_form();
    }
  }

  function perform_ajax_form_ciudad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ciudad_navigate_form(var_id_ciudad, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ciudad_navigate_form_cb);
  } // do_ajax_form_ciudad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciudad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ciudad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ciudad_navigate_form_cb_after_alert);
  } // do_ajax_form_ciudad_navigate_form_cb
  function do_ajax_form_ciudad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ciudad_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ciudad_navigate_form_cb_after_alert

  function sc_hide_form_ciudad_form()
  {
