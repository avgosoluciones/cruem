  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_disponibilidad_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_disponibilidad_mob_form();
        }
...
?>
  ...
  // ---------- Validate id_ips
  function do_ajax_form_disponibilidad_mob_validate_id_ips()
  {
    var nomeCampo_id_ips = "id_ips";
    var var_id_ips = scAjaxGetFieldSelect(nomeCampo_id_ips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_disponibilidad_mob_validate_id_ips(var_id_ips, var_script_case_init, do_ajax_form_disponibilidad_mob_validate_id_ips_cb);
  } // do_ajax_form_disponibilidad_mob_validate_id_ips

  function do_ajax_form_disponibilidad_mob_validate_id_ips_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_disponibilidad_mob_validate_id_ips_cb

  // ---------- Validate camas
  function do_ajax_form_disponibilidad_mob_validate_camas()
  {
    var nomeCampo_camas = "camas";
    var var_camas = scAjaxGetFieldText(nomeCampo_camas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_disponibilidad_mob_validate_camas(var_camas, var_script_case_init, do_ajax_form_disponibilidad_mob_validate_camas_cb);
  } // do_ajax_form_disponibilidad_mob_validate_camas

  function do_ajax_form_disponibilidad_mob_validate_camas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "camas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_disponibilidad_mob_validate_camas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_disponibilidad_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_disponibilidad_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_ips = scAjaxGetFieldSelect("id_ips");
    var var_camas = scAjaxGetFieldText("camas");
    var var_id_disponibilidad = scAjaxGetFieldText("id_disponibilidad");
    ...
    scAjaxProcOn();
    x_ajax_form_disponibilidad_mob_submit_form(var_id_ips, var_camas, var_id_disponibilidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_disponibilidad_mob_submit_form_cb);
  } // do_ajax_form_disponibilidad_mob_submit_form

  function do_ajax_form_disponibilidad_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_disponibilidad_mob_submit_form_cb_after_alert);
  } // do_ajax_form_disponibilidad_mob_submit_form_cb
  function do_ajax_form_disponibilidad_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_disponibilidad_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_disponibilidad_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_disponibilidad_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_disponibilidad_mob_navigate_form();
    }
  }

  function perform_ajax_form_disponibilidad_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_ips");
    scAjaxHideErrorDisplay("camas");
    var var_id_disponibilidad = document.F2.id_disponibilidad.value;
    ...
    scAjaxProcOn();
    x_ajax_form_disponibilidad_mob_navigate_form(var_id_disponibilidad, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_disponibilidad_mob_navigate_form_cb);
  } // do_ajax_form_disponibilidad_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_disponibilidad_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_disponibilidad_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_disponibilidad.value = scAjaxGetKeyValue("id_disponibilidad");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_disponibilidad_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_disponibilidad_mob_navigate_form_cb
  function do_ajax_form_disponibilidad_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_disponibilidad_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_disponibilidad_mob_navigate_form_cb_after_alert

  function sc_hide_form_disponibilidad_mob_form()
  {
  ...
  ajax_field_list[0] = "id_ips";
  ajax_field_list[1] = "camas";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_ips": {"label": "Entidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "camas": {"label": "Camas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["camas"][1] = "camas";

  var ajax_field_id = {
    "id_ips": new Array("hidden_field_label_id_ips", "hidden_field_data_id_ips"),
    "camas": new Array("hidden_field_label_camas", "hidden_field_data_camas")
  };
