  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_id_tipo_evento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_id_tipo_evento_form();
        }
...
?>
  ...
  function do_ajax_form_id_tipo_evento_validate_id_tipo_evento_(iNumLinha)
  {
    var nomeCampo_id_tipo_evento_ = "id_tipo_evento_" + iNumLinha;
    var var_id_tipo_evento_ = scAjaxGetFieldHidden(nomeCampo_id_tipo_evento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_id_tipo_evento_validate_id_tipo_evento_(var_id_tipo_evento_, iNumLinha, var_script_case_init, do_ajax_form_id_tipo_evento_validate_id_tipo_evento__cb);
  } // do_ajax_form_id_tipo_evento_validate_id_tipo_evento_

  function do_ajax_form_id_tipo_evento_validate_id_tipo_evento__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_id_tipo_evento_validate_id_tipo_evento__cb

  // ---------- Validate evento_
  function do_ajax_form_id_tipo_evento_validate_evento_(iNumLinha)
  {
    var nomeCampo_evento_ = "evento_" + iNumLinha;
    var var_evento_ = scAjaxGetFieldText(nomeCampo_evento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_id_tipo_evento_validate_evento_(var_evento_, iNumLinha, var_script_case_init, do_ajax_form_id_tipo_evento_validate_evento__cb);
  } // do_ajax_form_id_tipo_evento_validate_evento_

  function do_ajax_form_id_tipo_evento_validate_evento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "evento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "evento_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "evento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "evento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_id_tipo_evento_validate_evento__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_id_tipo_evento_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_id_tipo_evento_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_id_tipo_evento_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_id_tipo_evento_add_new_line_cb);
  } // do_ajax_form_id_tipo_evento_add_new_line

  function do_ajax_form_id_tipo_evento_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_id_tipo_evento_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_id_tipo_evento_backup_line(iNumLinha)
  {
    var var_id_tipo_evento_ = scAjaxGetFieldHidden("id_tipo_evento_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_id_tipo_evento_backup_line(var_id_tipo_evento_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_id_tipo_evento_backup_line_cb);
  } // do_ajax_form_id_tipo_evento_backup_line

  function do_ajax_form_id_tipo_evento_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_id_tipo_evento_backup_line_cb

  function do_ajax_form_id_tipo_evento_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_id_tipo_evento_cancel_insert

  function do_ajax_form_id_tipo_evento_cancel_update(iSeqVert)
  {
    do_ajax_form_id_tipo_evento_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_id_tipo_evento_cancel_update

  function do_ajax_form_id_tipo_evento_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_id_tipo_evento_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_id_tipo_evento_table_refresh()
  {
    var var_id_tipo_evento_ = document.F2.id_tipo_evento_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_id_tipo_evento_table_refresh(var_id_tipo_evento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_id_tipo_evento_table_refresh_cb);
  } //  do_ajax_form_id_tipo_evento_table_refresh

  function do_ajax_form_id_tipo_evento_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_tipo_evento_.value = scAjaxGetKeyValue("id_tipo_evento_");
    ...
    scAjaxAlert(do_ajax_form_id_tipo_evento_table_refresh_cb_after_alert);
  } // do_ajax_form_id_tipo_evento_table_refresh_cb
  function do_ajax_form_id_tipo_evento_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_id_tipo_evento_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_id_tipo_evento_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_id_tipo_evento_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_tipo_evento_ = scAjaxGetFieldHidden("id_tipo_evento_" + iNumLinha);
    var var_evento_ = scAjaxGetFieldText("evento_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_id_tipo_evento_submit_form(var_id_tipo_evento_, var_evento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_id_tipo_evento_submit_form_cb);
  } // do_ajax_form_id_tipo_evento_submit_form

  function do_ajax_form_id_tipo_evento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("evento_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_id_tipo_evento_submit_form_cb_after_alert);
  } // do_ajax_form_id_tipo_evento_submit_form_cb
  function do_ajax_form_id_tipo_evento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_id_tipo_evento_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_id_tipo_evento_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_id_tipo_evento_navigate_form, function() {});
    } else {
      perform_ajax_form_id_tipo_evento_navigate_form();
    }
  }

  function perform_ajax_form_id_tipo_evento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("evento_" + iNavForm);
    }
    var var_id_tipo_evento_ = document.F2.id_tipo_evento_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_id_tipo_evento_navigate_form(var_id_tipo_evento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_id_tipo_evento_navigate_form_cb);
  } // do_ajax_form_id_tipo_evento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_id_tipo_evento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_id_tipo_evento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_tipo_evento_.value = scAjaxGetKeyValue("id_tipo_evento_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_id_tipo_evento_navigate_form_cb_after_alert);
  } // do_ajax_form_id_tipo_evento_navigate_form_cb
  function do_ajax_form_id_tipo_evento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_id_tipo_evento_navigate_form_cb_after_alert

    function sc_form_id_tipo_evento_get_last_line_number()
    {
    ...
    } //sc_form_id_tipo_evento_get_last_line_number

  function sc_hide_form_id_tipo_evento_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "evento_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_tipo_evento_" + iNumLinha] = {"label": "Id Tipo Evento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["evento_" + iNumLinha] = {"label": "Evento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_tipo_evento_"][iNumLinha] = "id_tipo_evento_" + iNumLinha;
    ajax_field_mult["evento_"][iNumLinha] = "evento_" + iNumLinha;
    ...
    ajax_field_id["evento_" + iNumLinha] = new Array("hidden_field_label_evento_", "hidden_field_data_evento_" + iNumLinha);
    ajax_error_count["id_tipo_evento_" + iNumLinha] = "off";
    ajax_error_count["evento_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_tipo_evento_" + iNumLinha] = "on";
    ajax_read_only["evento_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_tipo_evento_" + iNumLinha] = "on";
    ajax_read_only["evento_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["evento_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["evento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["evento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["evento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["evento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["evento_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tipo_evento_'])) ? $this->nmgp_cmp_readonly['id_tipo_evento_'] : 'on';
?>
    scAjaxFieldRead("id_tipo_evento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['evento_'])) ? $this->nmgp_cmp_readonly['evento_'] : 'off';
?>
    scAjaxFieldRead("evento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_tipo_evento_" + iSeq, "on");
    scAjaxFieldRead("evento_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_tipo_evento_" + iRow] || "on" == ajax_error_count["evento_" + iRow]))
    {
      ...
      $("#hidden_field_data_evento_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_tipo_evento_" + iRow] && "off" == ajax_error_count["evento_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_tipo_evento_" + iRow] = "off";
        ajax_error_count["evento_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_evento_" + iRow).removeClass("scFormErrorLine");
    }
  }
