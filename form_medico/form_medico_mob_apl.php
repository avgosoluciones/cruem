...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_medico_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_medico_mob']['opc_ant'] = "inicio";
      }
      ...
      $_SESSION['scriptcase']['error_icon']['form_medico_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['sc_max_reg']) == "all")
      {
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['opc_ant'] : "";
      } 
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_medico_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_medico_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form" && !$this->Apl_com_erro)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_medico_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_medico_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_medico_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
    ...
    function ValidateField_medico(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['php_cmp_required']['medico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['php_cmp_required']['medico'] == "on")) 
      { 
          if ($this->medico == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_registro_medico(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['php_cmp_required']['registro_medico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['php_cmp_required']['registro_medico'] == "on")) 
      { 
   ...
   if (isset($this->Field_no_validate['estado'])) {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['php_cmp_required']['estado'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Estado" ;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_medico']['keyVal'] = form_medico_mob_pack_protect_string($this->nmgp_dados_form['id_medico']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_medico_mob_pack_protect_string('Activo') => str_replace('<', '&lt;',form_medico_mob_pack_protect_string("Activo")));
$aLookup[] = array(form_medico_mob_pack_protect_string('Inactivo') => str_replace('<', '&lt;',form_medico_mob_pack_protect_string("Inactivo")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Lookup_estado'][] = 'Activo';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Lookup_estado'][] = 'Inactivo';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['estado']['valList'][$i] = form_medico_mob_pack_protect_string($v);
          }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_medico_mob';
...
$_SESSION['scriptcase']['form_medico_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['parms'] = "id_medico?#?$this->id_medico?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
//---------- 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dados_select'];
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dyn_search_cache']);
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico_mob']['ordem_ord'] == " desc") {
