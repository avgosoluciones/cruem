  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_observaciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_observaciones_mob_form();
        }
...
?>
  ...
  // ---------- Validate observa
  function do_ajax_form_observaciones_mob_validate_observa()
  {
    var nomeCampo_observa = "observa";
    var var_observa = scAjaxGetFieldText(nomeCampo_observa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_observaciones_mob_validate_observa(var_observa, var_script_case_init, do_ajax_form_observaciones_mob_validate_observa_cb);
  } // do_ajax_form_observaciones_mob_validate_observa

  function do_ajax_form_observaciones_mob_validate_observa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_observaciones_mob_validate_observa_cb

  // ---------- Validate fecha
  function do_ajax_form_observaciones_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_observaciones_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_observaciones_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_observaciones_mob_validate_fecha

  function do_ajax_form_observaciones_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_observaciones_mob_validate_fecha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_observaciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_observaciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_observa = scAjaxGetFieldText("observa");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_id_observacion = scAjaxGetFieldText("id_observacion");
    ...
    scAjaxProcOn();
    x_ajax_form_observaciones_mob_submit_form(var_observa, var_fecha, var_id_observacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_observaciones_mob_submit_form_cb);
  } // do_ajax_form_observaciones_mob_submit_form

  function do_ajax_form_observaciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_observaciones_mob_submit_form_cb_after_alert);
  } // do_ajax_form_observaciones_mob_submit_form_cb
  function do_ajax_form_observaciones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_observaciones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_observaciones_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_observaciones_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_observaciones_mob_navigate_form();
    }
  }

  function perform_ajax_form_observaciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_observaciones_mob_navigate_form(var_id_observacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_observaciones_mob_navigate_form_cb);
  } // do_ajax_form_observaciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_observaciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_observaciones_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_observaciones_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_observaciones_mob_navigate_form_cb
  function do_ajax_form_observaciones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_observaciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_observaciones_mob_navigate_form_cb_after_alert

  function sc_hide_form_observaciones_mob_form()
  {
