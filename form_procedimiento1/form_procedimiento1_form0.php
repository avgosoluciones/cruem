...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_procedimiento1/form_procedimiento1_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_procedimiento1_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_procedimiento1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['link_info']['remove_border']) {
...
<?php
 include_once("form_procedimiento1_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_procedimiento1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_procedimiento1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="PONAL " <?php  if ($this->quien_reporta == "PONAL ") { echo " selected" ;} ?>>PONAL </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'PONAL '; ?>
 <option  value="BOMBEROS " <?php  if ($this->quien_reporta == "BOMBEROS ") { echo " selected" ;} ?>>BOMBEROS </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'BOMBEROS '; ?>
 <option  value="DEFENSA CIVIL" <?php  if ($this->quien_reporta == "DEFENSA CIVIL") { echo " selected" ;} ?>>DEFENSA CIVIL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'DEFENSA CIVIL'; ?>
 <option  value="CRUZ ROJA " <?php  if ($this->quien_reporta == "CRUZ ROJA ") { echo " selected" ;} ?>>CRUZ ROJA </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'CRUZ ROJA '; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'LINEA DE SALUD MENTAL'; ?>
 <option  value="USUARIO" <?php  if ($this->quien_reporta == "USUARIO") { echo " selected" ;} ?>>USUARIO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'USUARIO'; ?>
 <option  value="EMERCAPS" <?php  if ($this->quien_reporta == "EMERCAPS") { echo " selected" ;} ?>>EMERCAPS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_quien_reporta'][] = 'EMERCAPS'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="VISUAL" <?php  if ($this->discapacidad == "VISUAL") { echo " selected" ;} ?>>VISUAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'VISUAL'; ?>
 <option  value="AUDITIVA" <?php  if ($this->discapacidad == "AUDITIVA") { echo " selected" ;} ?>>AUDITIVA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'AUDITIVA'; ?>
 <option  value="FISICA" <?php  if ($this->discapacidad == "FISICA") { echo " selected" ;} ?>>FISICA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'FISICA'; ?>
 <option  value="SORDOCEGUERA" <?php  if ($this->discapacidad == "SORDOCEGUERA") { echo " selected" ;} ?>>SORDOCEGUERA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'SORDOCEGUERA'; ?>
 <option  value="MULTIPLE" <?php  if ($this->discapacidad == "MULTIPLE") { echo " selected" ;} ?>>MULTIPLE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'MULTIPLE'; ?>
 <option  value="INTELECTUAL " <?php  if ($this->discapacidad == "INTELECTUAL ") { echo " selected" ;} ?>>INTELECTUAL </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'INTELECTUAL '; ?>
 <option  value="PSICOSOCIAL" <?php  if ($this->discapacidad == "PSICOSOCIAL") { echo " selected" ;} ?>>PSICOSOCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_discapacidad'][] = 'PSICOSOCIAL'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = ''; ?>
 <option value="">Seleccione...</option>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Cedula de ciudadanía'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Tarjeta de identidad'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Tarjeta de extranjería'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Cedula de ciudadanía de primera vez '; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Duplicado de cédula de ciudadanía '; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Renovación de cédula de ciudadanía '; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Tarjeta de identidad de primera vez'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Duplicado de tarjeta de identidad'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Renovación de tarjeta de identidad '; ?>
 <option  value="Registro civil " <?php  if ($this->tipo_documento == "Registro civil ") { echo " selected" ;} ?>>Registro civil </option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_documento'][] = 'Registro civil '; ?>
 </select></span>
</span><?php  }?>
...
<?php
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['pdf_view']) {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_genero'][] = 'Masculino'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_genero'][] = 'Transexual'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_genero'][] = 'Femenino'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_genero'][] = 'No binario'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_genero'][] = 'Otro'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_seguridad_social_label" id="hidden_field_label_id_seguridad_social" style="<?php echo $sStyleHidden_id_seguridad_social; ?>"><span id="id_label_id_seguridad_social"><?php echo $this->nm_new_label['id_seguridad_social']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['php_cmp_required']['id_seguridad_social']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['php_cmp_required']['id_seguridad_social'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="SUR" <?php  if ($this->zona == "SUR") { echo " selected" ;} ?>>SUR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = 'SUR'; ?>
 <option  value="NORTE" <?php  if ($this->zona == "NORTE") { echo " selected" ;} ?>>NORTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = 'NORTE'; ?>
 <option  value="ORIENTE" <?php  if ($this->zona == "ORIENTE") { echo " selected" ;} ?>>ORIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = 'ORIENTE'; ?>
 <option  value="OCCIDENTE" <?php  if ($this->zona == "OCCIDENTE") { echo " selected" ;} ?>>OCCIDENBTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = 'OCCIDENTE'; ?>
 <option  value="RURAL" <?php  if ($this->zona == "RURAL") { echo " selected" ;} ?>>RURAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = 'RURAL'; ?>
 <option  value="CENTRO" <?php  if ($this->zona == "CENTRO") { echo " selected" ;} ?>>CENTRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_zona'][] = 'CENTRO'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_servicio'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="Ambulancia" <?php  if ($this->tipo_servicio == "Ambulancia") { echo " selected" ;} ?>>Ambulancia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_servicio'][] = 'Ambulancia'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_servicio'][] = 'Referencia y contrareferencia'; ?>
 <option  value="TAB" <?php  if ($this->tipo_servicio == "TAB") { echo " selected" ;} ?>>TAB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_servicio'][] = 'TAB'; ?>
 <option  value="Otros" <?php  if ($this->tipo_servicio == "Otros") { echo " selected" ;} ?>>Otros</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_servicio'][] = 'Otros'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_movil_label" id="hidden_field_label_id_movil" style="<?php echo $sStyleHidden_id_movil; ?>"><span id="id_label_id_movil"><?php echo $this->nm_new_label['id_movil']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['php_cmp_required']['id_movil']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['php_cmp_required']['id_movil'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = ''; ?>
 <option value="">Seleccione...</option>
 <option  value="EFECTIVO" <?php  if ($this->tipo_caso == "EFECTIVO") { echo " selected" ;} ?>>EFECTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = 'EFECTIVO'; ?>
 <option  value="NO EFECTIVO" <?php  if ($this->tipo_caso == "NO EFECTIVO") { echo " selected" ;} ?>>NO EFECTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = 'NO EFECTIVO'; ?>
 <option  value="FALLIDO" <?php  if ($this->tipo_caso == "FALLIDO") { echo " selected" ;} ?>>FALLIDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = 'FALLIDO'; ?>
 <option  value="APOYO PSICOSOCIAL" <?php  if ($this->tipo_caso == "APOYO PSICOSOCIAL") { echo " selected" ;} ?>>APOYO PSICOSOCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = 'APOYO PSICOSOCIAL'; ?>
 <option  value="APH" <?php  if ($this->tipo_caso == "APH") { echo " selected" ;} ?>>APH</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = 'APH'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['Lookup_tipo_caso'][] = 'ASESORIA MEDICA TELEFONICA'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_medico_label" id="hidden_field_label_id_medico" style="<?php echo $sStyleHidden_id_medico; ?>"><span id="id_label_id_medico"><?php echo $this->nm_new_label['id_medico']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['php_cmp_required']['id_medico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['php_cmp_required']['id_medico'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_ciudad_label" id="hidden_field_label_id_ciudad" style="<?php echo $sStyleHidden_id_ciudad; ?>"><span id="id_label_id_ciudad"><?php echo $this->nm_new_label['id_ciudad']; ?></span></TD>
    <TD class="scFormDataOdd css_id_ciudad_line" id="hidden_field_data_id_ciudad" style="<?php echo $sStyleHidden_id_ciudad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_ciudad_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_procedimiento1");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_procedimiento1");
 parent.scAjaxDetailHeight("form_procedimiento1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_procedimiento1']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
