...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["id_ciudad" + iSeqRow] && scEventControl_data["id_ciudad" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["id_ciudad" + iSeqRow] && scEventControl_data["id_ciudad" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_procedimiento' + iSeqRow).bind('change', function() { sc_form_procedimiento1_id_procedimiento_onchange(this, iSeqRow) });
  $('#id_sc_field_secad' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_secad_onblur('#id_sc_field_secad' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_procedimiento1_secad_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_procedimiento1_secad_onfocus(this, iSeqRow) });
  $('#id_sc_field_consecutivo' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_consecutivo_onblur('#id_sc_field_consecutivo' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_procedimiento1_consecutivo_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_procedimiento1_consecutivo_onfocus(this, iSeqRow) });
  $('#id_sc_field_quien_reporta' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_quien_reporta_onblur('#id_sc_field_quien_reporta' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_procedimiento1_quien_reporta_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_procedimiento1_quien_reporta_onfocus(this, iSeqRow) });
  $('#id_sc_field_direccion_servicio' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_direccion_servicio_onblur('#id_sc_field_direccion_servicio' + iSeqRow, iSeqRow) })
                                                .bind('change', function() { sc_form_procedimiento1_direccion_servicio_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_procedimiento1_direccion_servicio_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_barrio' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_id_barrio_onblur('#id_sc_field_id_barrio' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_procedimiento1_id_barrio_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_procedimiento1_id_barrio_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_servicio' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_tipo_servicio_onblur('#id_sc_field_tipo_servicio' + iSeqRow, iSeqRow) })
                                           .bind('change', function() { sc_form_procedimiento1_tipo_servicio_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_procedimiento1_tipo_servicio_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero_contacto' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_numero_contacto_onblur('#id_sc_field_numero_contacto' + iSeqRow, iSeqRow) })
                                             .bind('change', function() { sc_form_procedimiento1_numero_contacto_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_procedimiento1_numero_contacto_onfocus(this, iSeqRow) });
  $('#id_sc_field_radicado' + iSeqRow).bind('change', function() { sc_form_procedimiento1_radicado_onchange(this, iSeqRow) });
  $('#id_sc_field_nombre_apellido' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_nombre_apellido_onblur('#id_sc_field_nombre_apellido' + iSeqRow, iSeqRow) })
                                             .bind('change', function() { sc_form_procedimiento1_nombre_apellido_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_procedimiento1_nombre_apellido_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_documento' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_tipo_documento_onblur('#id_sc_field_tipo_documento' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_form_procedimiento1_tipo_documento_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_procedimiento1_tipo_documento_onfocus(this, iSeqRow) });
  $('#id_sc_field_documento_identidad' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_documento_identidad_onblur('#id_sc_field_documento_identidad' + iSeqRow, iSeqRow) })
                                                 .bind('change', function() { sc_form_procedimiento1_documento_identidad_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_procedimiento1_documento_identidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_edad' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_edad_onblur('#id_sc_field_edad' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_procedimiento1_edad_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_procedimiento1_edad_onfocus(this, iSeqRow) });
  $('#id_sc_field_genero' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_genero_onblur('#id_sc_field_genero' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_procedimiento1_genero_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_procedimiento1_genero_onfocus(this, iSeqRow) });
  $('#id_sc_field_circunstancias_emergencia' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_circunstancias_emergencia_onblur('#id_sc_field_circunstancias_emergencia' + iSeqRow, iSeqRow) })
                                                       .bind('change', function() { sc_form_procedimiento1_circunstancias_emergencia_onchange(this, iSeqRow) })
                                                       .bind('focus', function() { sc_form_procedimiento1_circunstancias_emergencia_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_seguridad_social' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_procedimiento1_id_seguridad_social_onblur('#id_sc_field_id_seguridad_social' + iSeqRow, iSeqRow);}, 300) })
                                                 .bind('change', function() { sc_form_procedimiento1_id_seguridad_social_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_procedimiento1_id_seguridad_social_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_eps' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_id_eps_onblur('#id_sc_field_id_eps' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_procedimiento1_id_eps_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_procedimiento1_id_eps_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha' + iSeqRow).bind('change', function() { sc_form_procedimiento1_fecha_onchange(this, iSeqRow) });
  $('#id_sc_field_ip' + iSeqRow).bind('change', function() { sc_form_procedimiento1_ip_onchange(this, iSeqRow) });
  $('#id_sc_field_login' + iSeqRow).bind('change', function() { sc_form_procedimiento1_login_onchange(this, iSeqRow) });
  $('#id_sc_field_hora_ingreso_llamada' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_hora_ingreso_llamada_onblur('#id_sc_field_hora_ingreso_llamada' + iSeqRow, iSeqRow) })
                                                  .bind('change', function() { sc_form_procedimiento1_hora_ingreso_llamada_onchange(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_procedimiento1_hora_ingreso_llamada_onfocus(this, iSeqRow) });
  $('#id_sc_field_hora_notifica_movil' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_hora_notifica_movil_onblur('#id_sc_field_hora_notifica_movil' + iSeqRow, iSeqRow) })
                                                 .bind('change', function() { sc_form_procedimiento1_hora_notifica_movil_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_procedimiento1_hora_notifica_movil_onfocus(this, iSeqRow) });
  $('#id_sc_field_hora_llegada_sitio' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_hora_llegada_sitio_onblur('#id_sc_field_hora_llegada_sitio' + iSeqRow, iSeqRow) })
                                                .bind('change', function() { sc_form_procedimiento1_hora_llegada_sitio_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_procedimiento1_hora_llegada_sitio_onfocus(this, iSeqRow) });
  $('#id_sc_field_hora_llegada_ips' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_hora_llegada_ips_onblur('#id_sc_field_hora_llegada_ips' + iSeqRow, iSeqRow) })
                                              .bind('change', function() { sc_form_procedimiento1_hora_llegada_ips_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_procedimiento1_hora_llegada_ips_onfocus(this, iSeqRow) });
  $('#id_sc_field_hora_salida_ips' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_hora_salida_ips_onblur('#id_sc_field_hora_salida_ips' + iSeqRow, iSeqRow) })
                                             .bind('change', function() { sc_form_procedimiento1_hora_salida_ips_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_procedimiento1_hora_salida_ips_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_movil' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_procedimiento1_id_movil_onblur('#id_sc_field_id_movil' + iSeqRow, iSeqRow);}, 300) })
                                      .bind('change', function() { sc_form_procedimiento1_id_movil_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_procedimiento1_id_movil_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_ips' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_id_ips_onblur('#id_sc_field_id_ips' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_procedimiento1_id_ips_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_procedimiento1_id_ips_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_caso' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_tipo_caso_onblur('#id_sc_field_tipo_caso' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_procedimiento1_tipo_caso_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_procedimiento1_tipo_caso_onfocus(this, iSeqRow) });
  $('#id_sc_field_operador' + iSeqRow).bind('change', function() { sc_form_procedimiento1_operador_onchange(this, iSeqRow) });
  $('#id_sc_field_id_medico' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_procedimiento1_id_medico_onblur('#id_sc_field_id_medico' + iSeqRow, iSeqRow);}, 300) })
                                       .bind('change', function() { sc_form_procedimiento1_id_medico_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_procedimiento1_id_medico_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_tipo_evento' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_id_tipo_evento_onblur('#id_sc_field_id_tipo_evento' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_form_procedimiento1_id_tipo_evento_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_procedimiento1_id_tipo_evento_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('change', function() { sc_form_procedimiento1_observaciones_onchange(this, iSeqRow) });
  $('#id_sc_field_zona' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_zona_onblur('#id_sc_field_zona' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_procedimiento1_zona_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_procedimiento1_zona_onfocus(this, iSeqRow) });
  $('#id_sc_field_discapacidad' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_discapacidad_onblur('#id_sc_field_discapacidad' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_form_procedimiento1_discapacidad_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_procedimiento1_discapacidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_ciudad' + iSeqRow).bind('blur', function() { sc_form_procedimiento1_id_ciudad_onblur('#id_sc_field_id_ciudad' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_procedimiento1_id_ciudad_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_procedimiento1_id_ciudad_onfocus(this, iSeqRow) });
  $('.sc-ui-radio-genero' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_procedimiento1_id_procedimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_secad_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_secad();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_secad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_secad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_consecutivo_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_consecutivo();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_consecutivo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_consecutivo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_quien_reporta_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_quien_reporta();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_quien_reporta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_quien_reporta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_direccion_servicio_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_direccion_servicio();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_direccion_servicio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_direccion_servicio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_barrio_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_barrio();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_barrio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_barrio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_tipo_servicio_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_tipo_servicio();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_tipo_servicio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_tipo_servicio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_numero_contacto_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_numero_contacto();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_numero_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_numero_contacto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_radicado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_nombre_apellido_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_nombre_apellido();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_nombre_apellido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_nombre_apellido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_form_procedimiento1_event_nombre_apellido_onfocus();
}

function sc_form_procedimiento1_tipo_documento_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_tipo_documento();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_tipo_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_tipo_documento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_documento_identidad_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_documento_identidad();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_documento_identidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_documento_identidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_edad_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_edad();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_edad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_edad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_genero_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_genero();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_genero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_genero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_circunstancias_emergencia_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_circunstancias_emergencia();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_circunstancias_emergencia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_circunstancias_emergencia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_seguridad_social_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_seguridad_social();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_seguridad_social_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_seguridad_social_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_eps_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_eps();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_eps_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_eps_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_ip_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_login_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_hora_ingreso_llamada_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_hora_ingreso_llamada();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_hora_ingreso_llamada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_hora_ingreso_llamada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_hora_notifica_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_hora_notifica_movil();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_hora_notifica_movil_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_hora_notifica_movil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_hora_llegada_sitio_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_hora_llegada_sitio();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_hora_llegada_sitio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_hora_llegada_sitio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_hora_llegada_ips_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_hora_llegada_ips();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_hora_llegada_ips_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_hora_llegada_ips_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_hora_salida_ips_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_hora_salida_ips();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_hora_salida_ips_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_hora_salida_ips_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_movil();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_movil_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_movil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_ips_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_ips();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_ips_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_ips_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_tipo_caso_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_tipo_caso();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_tipo_caso_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_tipo_caso_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_operador_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_medico_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_medico();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_medico_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_medico_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_tipo_evento_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_tipo_evento();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_tipo_evento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_tipo_evento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_zona_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_zona();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_zona_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_zona_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_discapacidad_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_discapacidad();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_discapacidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_discapacidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_procedimiento1_id_ciudad_onblur(oThis, iSeqRow) {
  do_ajax_form_procedimiento1_validate_id_ciudad();
  scCssBlur(oThis);
}

function sc_form_procedimiento1_id_ciudad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_procedimiento1_id_ciudad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
        $("#id_form_procedimiento1_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_procedimiento1_validate_fecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_procedimiento1')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
