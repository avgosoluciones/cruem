...
function scHidePage(pageNo) {
        $("#id_form_procedimiento1_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_procedimiento1_mob_validate_fecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_procedimiento1_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
