...
?>
  ...
  // ---------- Validate id_sector
  function do_ajax_form_sector_mob_validate_id_sector()
  {
    var nomeCampo_id_sector = "id_sector";
    var var_id_sector = scAjaxGetFieldHidden(nomeCampo_id_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sector_mob_validate_id_sector(var_id_sector, var_script_case_init, do_ajax_form_sector_mob_validate_id_sector_cb);
  } // do_ajax_form_sector_mob_validate_id_sector

  function do_ajax_form_sector_mob_validate_id_sector_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sector_mob_validate_id_sector_cb

  // ---------- Validate sector
  function do_ajax_form_sector_mob_validate_sector()
  {
    var nomeCampo_sector = "sector";
    var var_sector = scAjaxGetFieldText(nomeCampo_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sector_mob_validate_sector(var_sector, var_script_case_init, do_ajax_form_sector_mob_validate_sector_cb);
  } // do_ajax_form_sector_mob_validate_sector

  function do_ajax_form_sector_mob_validate_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sector";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sector_mob_validate_sector_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_sector_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_id_sector = scAjaxGetFieldHidden("id_sector");
    ...
    scAjaxProcOn();
    x_ajax_form_sector_mob_submit_form(var_id_sector, var_sector, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sector_mob_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sector_mob_navigate_form, function() {});
    } else {
  ...
  function perform_ajax_form_sector_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("id_sector");
    scAjaxHideErrorDisplay("sector");
    var var_id_sector = document.F2.id_sector.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sector_mob_navigate_form(var_id_sector, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sector_mob_navigate_form_cb);
...
?>
  function do_ajax_form_sector_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_sector.value = scAjaxGetKeyValue("id_sector");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
?>
  ...
  ajax_field_list[0] = "id_sector";
  ajax_field_list[1] = "sector";
  ...
  var ajax_error_list = {
    ...
    "sector": {"label": "Sector", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
