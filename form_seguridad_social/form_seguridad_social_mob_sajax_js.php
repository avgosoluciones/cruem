  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_seguridad_social_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_seguridad_social_mob_form();
        }
...
?>
  ...
  function do_ajax_form_seguridad_social_mob_validate_id_seguridad_social()
  {
    var nomeCampo_id_seguridad_social = "id_seguridad_social";
    var var_id_seguridad_social = scAjaxGetFieldHidden(nomeCampo_id_seguridad_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seguridad_social_mob_validate_id_seguridad_social(var_id_seguridad_social, var_script_case_init, do_ajax_form_seguridad_social_mob_validate_id_seguridad_social_cb);
  } // do_ajax_form_seguridad_social_mob_validate_id_seguridad_social

  function do_ajax_form_seguridad_social_mob_validate_id_seguridad_social_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seguridad_social_mob_validate_id_seguridad_social_cb

  // ---------- Validate seguridad_social
  function do_ajax_form_seguridad_social_mob_validate_seguridad_social()
  {
    var nomeCampo_seguridad_social = "seguridad_social";
    var var_seguridad_social = scAjaxGetFieldText(nomeCampo_seguridad_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seguridad_social_mob_validate_seguridad_social(var_seguridad_social, var_script_case_init, do_ajax_form_seguridad_social_mob_validate_seguridad_social_cb);
  } // do_ajax_form_seguridad_social_mob_validate_seguridad_social

  function do_ajax_form_seguridad_social_mob_validate_seguridad_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "seguridad_social";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seguridad_social_mob_validate_seguridad_social_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_seguridad_social_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_seguridad_social_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_seguridad_social = scAjaxGetFieldHidden("id_seguridad_social");
    var var_seguridad_social = scAjaxGetFieldText("seguridad_social");
    ...
    scAjaxProcOn();
    x_ajax_form_seguridad_social_mob_submit_form(var_id_seguridad_social, var_seguridad_social, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_seguridad_social_mob_submit_form_cb);
  } // do_ajax_form_seguridad_social_mob_submit_form

  function do_ajax_form_seguridad_social_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("seguridad_social");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_seguridad_social_mob_submit_form_cb_after_alert);
  } // do_ajax_form_seguridad_social_mob_submit_form_cb
  function do_ajax_form_seguridad_social_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_seguridad_social_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_seguridad_social_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_seguridad_social_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_seguridad_social_mob_navigate_form();
    }
  }

  function perform_ajax_form_seguridad_social_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_seguridad_social");
    scAjaxHideErrorDisplay("seguridad_social");
    var var_id_seguridad_social = document.F2.id_seguridad_social.value;
    ...
    scAjaxProcOn();
    x_ajax_form_seguridad_social_mob_navigate_form(var_id_seguridad_social, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_seguridad_social_mob_navigate_form_cb);
  } // do_ajax_form_seguridad_social_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_seguridad_social_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_seguridad_social_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_seguridad_social.value = scAjaxGetKeyValue("id_seguridad_social");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_seguridad_social_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_seguridad_social_mob_navigate_form_cb
  function do_ajax_form_seguridad_social_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_seguridad_social_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_seguridad_social_mob_navigate_form_cb_after_alert

  function sc_hide_form_seguridad_social_mob_form()
  {
  ...
  ajax_field_list[0] = "id_seguridad_social";
  ajax_field_list[1] = "seguridad_social";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_seguridad_social": {"label": "Id Seguridad Social", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "seguridad_social": {"label": "Seguridad Social", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "seguridad_social": new Array()
  };
  ajax_field_mult["id_seguridad_social"][1] = "id_seguridad_social";
  ajax_field_mult["seguridad_social"][1] = "seguridad_social";

  var ajax_field_id = {
    "id_seguridad_social": new Array("hidden_field_label_id_seguridad_social", "hidden_field_data_id_seguridad_social"),
    "seguridad_social": new Array("hidden_field_label_seguridad_social", "hidden_field_data_seguridad_social")
  };

  var ajax_read_only = {
    "id_seguridad_social": "on",
    "seguridad_social": "off"
  };
