  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servicios_ips_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_servicios_ips_mob_form();
        }
...
?>
  ...
  // ---------- Validate id_servicios_ips
  function do_ajax_form_servicios_ips_mob_validate_id_servicios_ips()
  {
    var nomeCampo_id_servicios_ips = "id_servicios_ips";
    var var_id_servicios_ips = scAjaxGetFieldHidden(nomeCampo_id_servicios_ips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_mob_validate_id_servicios_ips(var_id_servicios_ips, var_script_case_init, do_ajax_form_servicios_ips_mob_validate_id_servicios_ips_cb);
  } // do_ajax_form_servicios_ips_mob_validate_id_servicios_ips

  function do_ajax_form_servicios_ips_mob_validate_id_servicios_ips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_servicios_ips";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_mob_validate_id_servicios_ips_cb

  // ---------- Validate id_ips
  function do_ajax_form_servicios_ips_mob_validate_id_ips()
  {
    var nomeCampo_id_ips = "id_ips";
    var var_id_ips = scAjaxGetFieldSelect(nomeCampo_id_ips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_mob_validate_id_ips(var_id_ips, var_script_case_init, do_ajax_form_servicios_ips_mob_validate_id_ips_cb);
  } // do_ajax_form_servicios_ips_mob_validate_id_ips

  function do_ajax_form_servicios_ips_mob_validate_id_ips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_ips";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_mob_validate_id_ips_cb

  // ---------- Validate id_servicios
  function do_ajax_form_servicios_ips_mob_validate_id_servicios()
  {
    var nomeCampo_id_servicios = "id_servicios";
    var var_id_servicios = scAjaxGetFieldSelect(nomeCampo_id_servicios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_mob_validate_id_servicios(var_id_servicios, var_script_case_init, do_ajax_form_servicios_ips_mob_validate_id_servicios_cb);
  } // do_ajax_form_servicios_ips_mob_validate_id_servicios

  function do_ajax_form_servicios_ips_mob_validate_id_servicios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_servicios";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_mob_validate_id_servicios_cb

  // ---------- Validate estado
  function do_ajax_form_servicios_ips_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldRadio(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_servicios_ips_mob_validate_estado_cb);
  } // do_ajax_form_servicios_ips_mob_validate_estado

  function do_ajax_form_servicios_ips_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_mob_validate_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_servicios_ips_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_servicios_ips_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_servicios_ips = scAjaxGetFieldHidden("id_servicios_ips");
    var var_id_ips = scAjaxGetFieldSelect("id_ips");
    var var_id_servicios = scAjaxGetFieldSelect("id_servicios");
    ...
    scAjaxProcOn();
    x_ajax_form_servicios_ips_mob_submit_form(var_id_servicios_ips, var_id_ips, var_id_servicios, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servicios_ips_mob_submit_form_cb);
  } // do_ajax_form_servicios_ips_mob_submit_form

  function do_ajax_form_servicios_ips_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_servicios_ips");
      scAjaxHideErrorDisplay("id_ips");
      scAjaxHideErrorDisplay("id_servicios");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_servicios_ips_mob_submit_form_cb_after_alert);
  } // do_ajax_form_servicios_ips_mob_submit_form_cb
  function do_ajax_form_servicios_ips_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_servicios_ips_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_servicios_ips_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_servicios_ips_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_servicios_ips_mob_navigate_form();
    }
  }

  function perform_ajax_form_servicios_ips_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_servicios");
    scAjaxHideErrorDisplay("estado");
    var var_id_servicios_ips = document.F2.id_servicios_ips.value;
    ...
    scAjaxProcOn();
    x_ajax_form_servicios_ips_mob_navigate_form(var_id_servicios_ips, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servicios_ips_mob_navigate_form_cb);
  } // do_ajax_form_servicios_ips_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicios_ips_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_servicios_ips_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.id_servicios_ips.value = scAjaxGetKeyValue("id_servicios_ips");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_servicios_ips_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_servicios_ips_mob_navigate_form_cb
  function do_ajax_form_servicios_ips_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_servicios_ips_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_servicios_ips_mob_navigate_form_cb_after_alert

  function sc_hide_form_servicios_ips_mob_form()
  {
  ...
  ajax_field_list[0] = "id_servicios_ips";
  ajax_field_list[1] = "id_ips";
  ajax_field_list[2] = "id_servicios";
  ...
  var ajax_error_list = {
    "id_servicios_ips": {"label": "Id Servicios Ips", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_ips": {"label": "Ips", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_servicios": {"label": "Servicios", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_servicios_ips": new Array(),
    "id_ips": new Array(),
    "id_servicios": new Array(),
    "estado": new Array()
  };
  ajax_field_mult["id_servicios_ips"][1] = "id_servicios_ips";
  ajax_field_mult["id_ips"][1] = "id_ips";
  ajax_field_mult["id_servicios"][1] = "id_servicios";
  ajax_field_mult["estado"][1] = "estado";

  var ajax_field_id = {
    "id_servicios_ips": new Array("hidden_field_label_id_servicios_ips", "hidden_field_data_id_servicios_ips"),
    "id_ips": new Array("hidden_field_label_id_ips", "hidden_field_data_id_ips"),
    "id_servicios": new Array("hidden_field_label_id_servicios", "hidden_field_data_id_servicios"),
