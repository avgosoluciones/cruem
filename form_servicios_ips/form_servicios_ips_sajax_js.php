  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servicios_ips" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_servicios_ips_form();
        }
...
?>
  ...
  function do_ajax_form_servicios_ips_validate_id_servicios_ips()
  {
    ...
    x_ajax_form_servicios_ips_validate_id_servicios_ips(var_id_servicios_ips, var_script_case_init, do_ajax_form_servicios_ips_validate_id_servicios_ips_cb);
  } // do_ajax_form_servicios_ips_validate_id_servicios_ips

  function do_ajax_form_servicios_ips_validate_id_servicios_ips_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_validate_id_servicios_ips_cb

  // ---------- Validate id_ips
  function do_ajax_form_servicios_ips_validate_id_ips()
  {
    var nomeCampo_id_ips = "id_ips";
    var var_id_ips = scAjaxGetFieldSelect(nomeCampo_id_ips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_validate_id_ips(var_id_ips, var_script_case_init, do_ajax_form_servicios_ips_validate_id_ips_cb);
  } // do_ajax_form_servicios_ips_validate_id_ips

  function do_ajax_form_servicios_ips_validate_id_ips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_ips";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_validate_id_ips_cb

  // ---------- Validate id_servicios
  function do_ajax_form_servicios_ips_validate_id_servicios()
  {
    var nomeCampo_id_servicios = "id_servicios";
    var var_id_servicios = scAjaxGetFieldSelect(nomeCampo_id_servicios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_validate_id_servicios(var_id_servicios, var_script_case_init, do_ajax_form_servicios_ips_validate_id_servicios_cb);
  } // do_ajax_form_servicios_ips_validate_id_servicios

  function do_ajax_form_servicios_ips_validate_id_servicios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_validate_id_servicios_cb

  // ---------- Validate estado
  function do_ajax_form_servicios_ips_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldRadio(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicios_ips_validate_estado(var_estado, var_script_case_init, do_ajax_form_servicios_ips_validate_estado_cb);
  } // do_ajax_form_servicios_ips_validate_estado

  function do_ajax_form_servicios_ips_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicios_ips_validate_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_servicios_ips_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_servicios_ips_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_servicios_ips_submit_form(var_id_servicios_ips, var_id_ips, var_id_servicios, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servicios_ips_submit_form_cb);
  } // do_ajax_form_servicios_ips_submit_form

  function do_ajax_form_servicios_ips_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_servicios_ips_submit_form_cb_after_alert);
  } // do_ajax_form_servicios_ips_submit_form_cb
  function do_ajax_form_servicios_ips_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_servicios_ips_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_servicios_ips_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_servicios_ips_navigate_form, function() {});
    } else {
      perform_ajax_form_servicios_ips_navigate_form();
    }
  }

  function perform_ajax_form_servicios_ips_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_servicios_ips_navigate_form(var_id_servicios_ips, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servicios_ips_navigate_form_cb);
  } // do_ajax_form_servicios_ips_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicios_ips']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_servicios_ips_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_servicios_ips_navigate_form_cb_after_alert);
  } // do_ajax_form_servicios_ips_navigate_form_cb
  function do_ajax_form_servicios_ips_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_servicios_ips_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_servicios_ips_navigate_form_cb_after_alert

  function sc_hide_form_servicios_ips_form()
  {
