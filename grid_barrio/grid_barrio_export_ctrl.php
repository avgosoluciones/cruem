<?php
@session_start() ;
$_SESSION['scriptcase']['grid_barrio']['sc_process_barr'] = true;
require_once('../grid_barrio/index.php');
unset($_SESSION['scriptcase']['grid_barrio']['sc_process_barr']);
$ExportCtrl = new grid_barrio_export_control;
$ExportCtrl->Export_barr();

class grid_barrio_export_control
{
