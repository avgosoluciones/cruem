...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_barrio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_barrio"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_barrio'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_barrio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_barrio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_barrio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_barrio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_barrio']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_barrio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_barrio']['embutida_filho'] as $ind => $sc_init)
          {
