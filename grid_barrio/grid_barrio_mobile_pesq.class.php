...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_barrio";$Nm_numeric[] = "id_sector";$Nm_numeric[] = "id_barrio";$Nm_numeric[] = "id_sector";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_barrio_cond" name="id_barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_barrio'), this, 'id_barrio')">
      ...
      <br><span id="id_hide_id_barrio"  <?php echo $str_hide_id_barrio?>><INPUT  type="text" id="SC_id_barrio" name="id_barrio" value="<?php echo NM_encode_input($id_barrio) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_barrio_cond" name="barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio'), this, 'barrio')">
      ...
      <br><span id="id_hide_barrio"  <?php echo $str_hide_barrio?>><?php
      if ($barrio != "")
      {
      $barrio_look = (is_string($barrio) ? substr($this->Db->qstr($barrio), 1, -1) : $barrio); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_sector_cond" name="id_sector_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sector'), this, 'id_sector')">
      ...
      <br><span id="id_hide_id_sector"  <?php echo $str_hide_id_sector?>><INPUT  type="text" id="SC_id_sector" name="id_sector" value="<?php echo NM_encode_input($id_sector) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
