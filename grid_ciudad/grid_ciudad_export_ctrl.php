<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ciudad']['sc_process_barr'] = true;
require_once('../grid_ciudad/index.php');
unset($_SESSION['scriptcase']['grid_ciudad']['sc_process_barr']);
$ExportCtrl = new grid_ciudad_export_control;
$ExportCtrl->Export_barr();

class grid_ciudad_export_control
{
