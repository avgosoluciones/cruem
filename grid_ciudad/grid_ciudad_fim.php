...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_ciudad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_ciudad"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ciudad'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ciudad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ciudad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ciudad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ciudad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ciudad']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ciudad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ciudad']['embutida_filho'] as $ind => $sc_init)
          {
