...
$oExportPdf = new grid_ciudad_export_pdf;
$oExportPdf->exportPdf();

class grid_ciudad_export_pdf {
...
$STR_lang           = '';
$str_google_fonts   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']))
{
    $STR_schema         = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']['str_schema'];
    $STR_tmp            = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']['str_tmp'];
    $STR_prod           = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']['str_prod'];
    $STR_btn            = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']['str_btn'];
    $STR_lang           = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']['str_lang'];
    $str_google_fonts   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['grid_ciudad_iframe_params']['str_google_fonts'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_ciudad']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['opc_pdf']['pdf_zip']     = (isset($aParams['pdf_zip']))         ? $aParams['pdf_zip']         : "N";
$Nm_lang     = array();
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_title'] ?> ciudad :: PDF</title>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_grid_ciudad.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['pdf_name'] : "grid_ciudad.pdf";
$NM_pdf_output = $NM_pdfbase;
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['opc_pdf']['pdf_zip']) && $_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad']['opc_pdf']['pdf_zip'] == "S")
 {
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad'][$path_doc_md5][0] = $_SESSION['scriptcase']['grid_ciudad']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_ciudad'][$path_doc_md5][1] = $NM_tit_doc;
$NM_volta   = "volta_grid";
