...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_ciudad";$Nm_numeric[] = "id_ciudad";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_ciudad_cond" name="id_ciudad_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_ciudad'), this, 'id_ciudad')">
      ...
      <br><span id="id_hide_id_ciudad"  <?php echo $str_hide_id_ciudad?>><INPUT  type="text" id="SC_id_ciudad" name="id_ciudad" value="<?php echo NM_encode_input($id_ciudad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ciudad_cond" name="ciudad_cond" onChange="nm_campos_between(document.getElementById('id_vis_ciudad'), this, 'ciudad')">
      ...
      <br><span id="id_hide_ciudad"  <?php echo $str_hide_ciudad?>><?php
      if ($ciudad != "")
      {
      $ciudad_look = (is_string($ciudad) ? substr($this->Db->qstr($ciudad), 1, -1) : $ciudad); 
      $nmgp_def_dados = array(); 
