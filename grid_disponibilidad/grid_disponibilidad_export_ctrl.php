<?php
@session_start() ;
$_SESSION['scriptcase']['grid_disponibilidad']['sc_process_barr'] = true;
require_once('../grid_disponibilidad/index.php');
unset($_SESSION['scriptcase']['grid_disponibilidad']['sc_process_barr']);
$ExportCtrl = new grid_disponibilidad_export_control;
$ExportCtrl->Export_barr();

class grid_disponibilidad_export_control
{
