...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_disponibilidad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_disponibilidad"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_disponibilidad'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_disponibilidad</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_disponibilidad']['embutida_filho'] as $ind => $sc_init)
          {
