...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "disponi.fecha";$Nm_datas[] = "disponi_fecha";$Nm_numeric[] = "disponi_id_disponibilidad";$Nm_numeric[] = "disponi_id_ips";$Nm_numeric[] = "disponi_camas";$Nm_numeric[] = "entidad_id_ips";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_disponi_login_cond" name="disponi_login_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_login'), this, 'disponi_login')">
      ...
      <br><span id="id_hide_disponi_login"  <?php echo $str_hide_disponi_login?>><?php
      if ($disponi_login != "")
      {
      $disponi_login_look = (is_string($disponi_login) ? substr($this->Db->qstr($disponi_login), 1, -1) : $disponi_login); 
      $nmgp_def_dados = array(); 
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_disponi_id_disponibilidad_cond" name="disponi_id_disponibilidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_id_disponibilidad'), this, 'disponi_id_disponibilidad')">
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_disponi_id_ips_cond" name="disponi_id_ips_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_id_ips'), this, 'disponi_id_ips')">
      ...
      <br><span id="id_hide_disponi_id_ips"  <?php echo $str_hide_disponi_id_ips?>><INPUT  type="text" id="SC_disponi_id_ips" name="disponi_id_ips" value="<?php echo NM_encode_input($disponi_id_ips) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_disponi_camas_cond" name="disponi_camas_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_camas'), this, 'disponi_camas')">
