...
<?php
   ...
   $Ord_Cmp = new grid_disponibilidad_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_disponibilidad_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['disponi_camas'] = "disponi_camas";
   }
   else
   {
       $tab_def_campos['disponi_camas'] = "disponi.camas";
   }
   $tab_labels["disponi_camas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_camas"])) ? $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_camas"] : "Camas";
   $tab_ger_campos['disponi_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disponi_fecha'] = "disponi_fecha";
   }
   else
   {
       $tab_def_campos['disponi_fecha'] = "disponi.fecha";
   }
   $tab_labels["disponi_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_fecha"] : "Fecha";
   $tab_ger_campos['entidad_nombre_ips'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['entidad_nombre_ips'] = "entidad_nombre_ips";
   }
   else
   {
       $tab_def_campos['entidad_nombre_ips'] = "entidad.nombre_ips";
   }
   $tab_labels["entidad_nombre_ips"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["entidad_nombre_ips"])) ? $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["entidad_nombre_ips"] : "Nombre Ips";
   $tab_ger_campos['disponi_login'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disponi_login'] = "disponi_login";
   }
   else
   {
       $tab_def_campos['disponi_login'] = "disponi.login";
   }
   $tab_labels["disponi_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_login"] : "Login";
   $tab_ger_campos['disponi_ip'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disponi_ip'] = "disponi_ip";
   }
   else
   {
       $tab_def_campos['disponi_ip'] = "disponi.ip";
   }
   $tab_labels["disponi_ip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_ip"])) ? $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['labels']["disponi_ip"] : "Ip";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_disponibilidad_order_campos.php",
    data: {
...
<div class="sc_ui_sortable-wrapper" id="sorting_list_ord_campos">
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_disponibilidad']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
