...
class grid_disponibilidad_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_disponibilidad_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_disponibilidad_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_disponibilidad_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_disponi_login')
      {
          $disponi_login = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_disponi_login($disponi_login);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "disponi.fecha";$Nm_datas[] = "disponi_fecha";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $NM_cond = str_replace(array("##ini##","##fim##"), array("",""),$NM_cond);
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_disponibilidad/grid_disponibilidad_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
<?php
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_disponibilidad_ajax_search.js"></script>
 <script type="text/javascript" src="grid_disponibilidad_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_disponibilidad_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_disponibilidad']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_disponibilidad']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_disponi_login_cond#NMF#' + search_get_sel_txt('SC_disponi_login_cond') + '@NMF@';
  str_out += 'SC_disponi_login#NMF#' + search_get_text('SC_disponi_login') + '@NMF@';
  str_out += 'id_ac_disponi_login#NMF#' + search_get_text('id_ac_disponi_login') + '@NMF@';
  str_out += 'SC_disponi_id_disponibilidad_cond#NMF#' + search_get_sel_txt('SC_disponi_id_disponibilidad_cond') + '@NMF@';
  str_out += 'SC_disponi_id_disponibilidad#NMF#' + search_get_text('SC_disponi_id_disponibilidad') + '@NMF@';
  str_out += 'SC_disponi_id_ips_cond#NMF#' + search_get_sel_txt('SC_disponi_id_ips_cond') + '@NMF@';
  str_out += 'SC_disponi_id_ips#NMF#' + search_get_text('SC_disponi_id_ips') + '@NMF@';
  str_out += 'SC_disponi_camas_cond#NMF#' + search_get_sel_txt('SC_disponi_camas_cond') + '@NMF@';
  str_out += 'SC_disponi_camas#NMF#' + search_get_text('SC_disponi_camas') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_disponi_login").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_disponi_login").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_disponi_login",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_disponi_login").val(ui.item.value);
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $disponi_login_cond, $disponi_login, $disponi_login_autocomp,
             $disponi_id_disponibilidad_cond, $disponi_id_disponibilidad,
             $disponi_id_ips_cond, $disponi_id_ips,
             $disponi_camas_cond, $disponi_camas,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $disponi_login = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_login']; 
          $disponi_login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_login_cond']; 
          $disponi_id_disponibilidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_disponibilidad']; 
          $disponi_id_disponibilidad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_disponibilidad_cond']; 
          $disponi_id_ips = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_ips']; 
          $disponi_id_ips_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_ips_cond']; 
          $disponi_camas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_camas']; 
          $disponi_camas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_camas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['NM_operador']; 
          if (strtoupper($disponi_id_disponibilidad_cond) != "II" && strtoupper($disponi_id_disponibilidad_cond) != "QP" && strtoupper($disponi_id_disponibilidad_cond) != "NP" && strtoupper($disponi_id_disponibilidad_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($disponi_id_disponibilidad, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($disponi_id_ips_cond) != "II" && strtoupper($disponi_id_ips_cond) != "QP" && strtoupper($disponi_id_ips_cond) != "NP" && strtoupper($disponi_id_ips_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($disponi_id_ips, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($disponi_camas_cond) != "II" && strtoupper($disponi_camas_cond) != "QP" && strtoupper($disponi_camas_cond) != "NP" && strtoupper($disponi_camas_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($disponi_camas, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($disponi_login_cond) || empty($disponi_login_cond))
      {
         $disponi_login_cond = "qp";
      }
      if (!isset($disponi_id_disponibilidad_cond) || empty($disponi_id_disponibilidad_cond))
      {
         $disponi_id_disponibilidad_cond = "gt";
      }
      if (!isset($disponi_id_ips_cond) || empty($disponi_id_ips_cond))
      {
         $disponi_id_ips_cond = "gt";
      }
      if (!isset($disponi_camas_cond) || empty($disponi_camas_cond))
      {
         $disponi_camas_cond = "gt";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_disponi_login = (in_array($disponi_login_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_disponi_id_disponibilidad = (in_array($disponi_id_disponibilidad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_disponi_id_ips = (in_array($disponi_id_ips_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_disponi_camas = (in_array($disponi_camas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($disponi_login) || $disponi_login == "")
      {
          $disponi_login = "";
      }
      if (isset($disponi_login) && !empty($disponi_login))
      {
         $tmp_pos = (is_string($disponi_login)) ? strpos($disponi_login, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $disponi_login = substr($disponi_login, 0, $tmp_pos);
         }
      }
      if (!isset($disponi_id_disponibilidad) || $disponi_id_disponibilidad == "")
      {
          $disponi_id_disponibilidad = "";
      }
      if (isset($disponi_id_disponibilidad) && !empty($disponi_id_disponibilidad))
      {
         $tmp_pos = (is_string($disponi_id_disponibilidad)) ? strpos($disponi_id_disponibilidad, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $disponi_id_disponibilidad = substr($disponi_id_disponibilidad, 0, $tmp_pos);
         }
      }
      if (!isset($disponi_id_ips) || $disponi_id_ips == "")
      {
          $disponi_id_ips = "";
      }
      if (isset($disponi_id_ips) && !empty($disponi_id_ips))
      {
         $tmp_pos = (is_string($disponi_id_ips)) ? strpos($disponi_id_ips, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $disponi_id_ips = substr($disponi_id_ips, 0, $tmp_pos);
         }
      }
      if (!isset($disponi_camas) || $disponi_camas == "")
      {
          $disponi_camas = "";
      }
      if (isset($disponi_camas) && !empty($disponi_camas))
      {
         $tmp_pos = (is_string($disponi_camas)) ? strpos($disponi_camas, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $disponi_camas = substr($disponi_camas, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_disponibilidad_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_disponibilidad']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_disponibilidad']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_disponi_login_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['disponi_login'])) ? $this->New_label['disponi_login'] : "Login"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_disponi_login_cond" name="disponi_login_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_login'), this, 'disponi_login')">
       <OPTION value="qp" <?php if ("qp" == $disponi_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $disponi_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $disponi_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $disponi_login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_disponi_login" <?php echo $str_hide_disponi_login?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['disponi_login'])) ? $this->New_label['disponi_login'] : "Login";
 $nmgp_tab_label .= "disponi_login?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $disponi_login;
      }
?>
<INPUT  type="text" id="SC_disponi_login" name="disponi_login" value="<?php echo NM_encode_input($disponi_login) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_disponi_login" name="disponi_login_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_disponi_id_disponibilidad_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['disponi_id_disponibilidad'])) ? $this->New_label['disponi_id_disponibilidad'] : "Id Disponibilidad"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_disponi_id_disponibilidad_cond" name="disponi_id_disponibilidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_id_disponibilidad'), this, 'disponi_id_disponibilidad')">
       <OPTION value="gt" <?php if ("gt" == $disponi_id_disponibilidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $disponi_id_disponibilidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $disponi_id_disponibilidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_disponi_id_disponibilidad" <?php echo $str_hide_disponi_id_disponibilidad?> valign="top">
 ...
 $nmgp_tab_label .= "disponi_id_disponibilidad?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_disponi_id_disponibilidad" name="disponi_id_disponibilidad" value="<?php echo NM_encode_input($disponi_id_disponibilidad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_disponi_id_ips_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['disponi_id_ips'])) ? $this->New_label['disponi_id_ips'] : "Id Ips"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_disponi_id_ips_cond" name="disponi_id_ips_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_id_ips'), this, 'disponi_id_ips')">
       <OPTION value="gt" <?php if ("gt" == $disponi_id_ips_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $disponi_id_ips_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $disponi_id_ips_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_disponi_id_ips" <?php echo $str_hide_disponi_id_ips?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['disponi_id_ips'])) ? $this->New_label['disponi_id_ips'] : "Id Ips";
 $nmgp_tab_label .= "disponi_id_ips?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_disponi_id_ips" name="disponi_id_ips" value="<?php echo NM_encode_input($disponi_id_ips) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_disponi_camas_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['disponi_camas'])) ? $this->New_label['disponi_camas'] : "Camas"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_disponi_camas_cond" name="disponi_camas_cond" onChange="nm_campos_between(document.getElementById('id_vis_disponi_camas'), this, 'disponi_camas')">
       <OPTION value="gt" <?php if ("gt" == $disponi_camas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $disponi_camas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $disponi_camas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_disponi_camas" <?php echo $str_hide_disponi_camas?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['disponi_camas'])) ? $this->New_label['disponi_camas'] : "Camas";
 $nmgp_tab_label .= "disponi_camas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_disponi_camas" name="disponi_camas" value="<?php echo NM_encode_input($disponi_camas) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.disponi_login_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_disponi_login'), document.F1.disponi_login_cond, 'disponi_login');
   document.F1.disponi_login.value = "";
   document.F1.disponi_login_autocomp.value = "";
   document.F1.disponi_id_disponibilidad_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_disponi_id_disponibilidad'), document.F1.disponi_id_disponibilidad_cond, 'disponi_id_disponibilidad');
   document.F1.disponi_id_disponibilidad.value = "";
   document.F1.disponi_id_ips_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_disponi_id_ips'), document.F1.disponi_id_ips_cond, 'disponi_id_ips');
   document.F1.disponi_id_ips.value = "";
   document.F1.disponi_camas_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_disponi_camas'), document.F1.disponi_camas_cond, 'disponi_camas');
   document.F1.disponi_camas.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_disponi_login_cond'] = 'cond';
      $tp_fields['SC_disponi_login'] = 'text_aut';
      $tp_fields['id_ac_disponi_login'] = 'text_aut';
      $tp_fields['SC_disponi_id_disponibilidad_cond'] = 'cond';
      $tp_fields['SC_disponi_id_disponibilidad'] = 'text';
      $tp_fields['SC_disponi_id_ips_cond'] = 'cond';
      $tp_fields['SC_disponi_id_ips'] = 'text';
      $tp_fields['SC_disponi_camas_cond'] = 'cond';
      $tp_fields['SC_disponi_camas'] = 'text';
   ...
   {
      global $disponi_login_cond, $disponi_login, $disponi_login_autocomp,
             $disponi_id_disponibilidad_cond, $disponi_id_disponibilidad,
             $disponi_id_ips_cond, $disponi_id_ips,
             $disponi_camas_cond, $disponi_camas, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($disponi_login_autocomp) && empty($disponi_login))
      {
          $disponi_login = $disponi_login_autocomp;
      }
      $disponi_login_cond_salva = $disponi_login_cond; 
      if (!isset($disponi_login_input_2) || $disponi_login_input_2 == "")
      {
          $disponi_login_input_2 = $disponi_login;
      }
      $disponi_id_disponibilidad_cond_salva = $disponi_id_disponibilidad_cond; 
      if (!isset($disponi_id_disponibilidad_input_2) || $disponi_id_disponibilidad_input_2 == "")
      {
          $disponi_id_disponibilidad_input_2 = $disponi_id_disponibilidad;
      }
      $disponi_id_ips_cond_salva = $disponi_id_ips_cond; 
      if (!isset($disponi_id_ips_input_2) || $disponi_id_ips_input_2 == "")
      {
          $disponi_id_ips_input_2 = $disponi_id_ips;
      }
      $disponi_camas_cond_salva = $disponi_camas_cond; 
      if (!isset($disponi_camas_input_2) || $disponi_camas_input_2 == "")
      {
          $disponi_camas_input_2 = $disponi_camas;
      }
      if ($disponi_id_disponibilidad_cond != "in")
      {
          nm_limpa_numero($disponi_id_disponibilidad, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($disponi_id_ips_cond != "in")
      {
          nm_limpa_numero($disponi_id_ips, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($disponi_camas_cond != "in")
      {
          nm_limpa_numero($disponi_camas, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_login'] = $disponi_login; 
      if (is_array($disponi_login) && !empty($disponi_login))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0] = $disponi_login;
      }
      elseif ($disponi_login_cond_salva == "nu" || $disponi_login_cond_salva == "nn" || $disponi_login_cond_salva == "ep" || $disponi_login_cond_salva == "ne" || !empty($disponi_login))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0][0] = $disponi_login;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_login_cond'] = $disponi_login_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['cmp'] = "disponi_login"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['opc'] = $disponi_login_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq']['disponi_login'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_disponibilidad'] = $disponi_id_disponibilidad; 
      if (is_array($disponi_id_disponibilidad) && !empty($disponi_id_disponibilidad))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0] = $disponi_id_disponibilidad;
      }
      elseif ($disponi_id_disponibilidad_cond_salva == "nu" || $disponi_id_disponibilidad_cond_salva == "nn" || $disponi_id_disponibilidad_cond_salva == "ep" || $disponi_id_disponibilidad_cond_salva == "ne" || !empty($disponi_id_disponibilidad))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0][0] = $disponi_id_disponibilidad;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_disponibilidad_cond'] = $disponi_id_disponibilidad_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['cmp'] = "disponi_id_disponibilidad"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['opc'] = $disponi_id_disponibilidad_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq']['disponi_id_disponibilidad'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_ips'] = $disponi_id_ips; 
      if (is_array($disponi_id_ips) && !empty($disponi_id_ips))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0] = $disponi_id_ips;
      }
      elseif ($disponi_id_ips_cond_salva == "nu" || $disponi_id_ips_cond_salva == "nn" || $disponi_id_ips_cond_salva == "ep" || $disponi_id_ips_cond_salva == "ne" || !empty($disponi_id_ips))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0][0] = $disponi_id_ips;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_id_ips_cond'] = $disponi_id_ips_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['cmp'] = "disponi_id_ips"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['opc'] = $disponi_id_ips_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq']['disponi_id_ips'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_camas'] = $disponi_camas; 
      if (is_array($disponi_camas) && !empty($disponi_camas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0] = $disponi_camas;
      }
      elseif ($disponi_camas_cond_salva == "nu" || $disponi_camas_cond_salva == "nn" || $disponi_camas_cond_salva == "ep" || $disponi_camas_cond_salva == "ne" || !empty($disponi_camas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['val'][0][0] = $disponi_camas;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['disponi_camas_cond'] = $disponi_camas_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['cmp'] = "disponi_camas"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid]['opc'] = $disponi_camas_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['grid_pesq']['disponi_camas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($disponi_login != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['disponi_login'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['disponi_login'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['disponi_login'] = $disponi_login;
      }
      $this->cmp_formatado['disponi_login'] = "'" . $this->cmp_formatado['disponi_login'] . "'";
      if (isset($this->cmp_formatado['disponi_login_input_2'])  && !empty($this->cmp_formatado['disponi_login_input_2'])) {
          $this->cmp_formatado['disponi_login_input_2'] = "'" . $this->cmp_formatado['disponi_login_input_2'] . "'";
      }
      $Conteudo = $disponi_id_disponibilidad;
      if (strtoupper($disponi_id_disponibilidad_cond) != "II" && strtoupper($disponi_id_disponibilidad_cond) != "QP" && strtoupper($disponi_id_disponibilidad_cond) != "NP" && strtoupper($disponi_id_disponibilidad_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['disponi_id_disponibilidad'] = $Conteudo;
      $this->cmp_formatado['disponi_id_disponibilidad'] = "'" . $this->cmp_formatado['disponi_id_disponibilidad'] . "'";
      if (isset($this->cmp_formatado['disponi_id_disponibilidad_input_2'])  && !empty($this->cmp_formatado['disponi_id_disponibilidad_input_2'])) {
          $this->cmp_formatado['disponi_id_disponibilidad_input_2'] = "'" . $this->cmp_formatado['disponi_id_disponibilidad_input_2'] . "'";
      }
      $Conteudo = $disponi_id_ips;
      if (strtoupper($disponi_id_ips_cond) != "II" && strtoupper($disponi_id_ips_cond) != "QP" && strtoupper($disponi_id_ips_cond) != "NP" && strtoupper($disponi_id_ips_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['disponi_id_ips'] = $Conteudo;
      $this->cmp_formatado['disponi_id_ips'] = "'" . $this->cmp_formatado['disponi_id_ips'] . "'";
      if (isset($this->cmp_formatado['disponi_id_ips_input_2'])  && !empty($this->cmp_formatado['disponi_id_ips_input_2'])) {
          $this->cmp_formatado['disponi_id_ips_input_2'] = "'" . $this->cmp_formatado['disponi_id_ips_input_2'] . "'";
      }
      $Conteudo = $disponi_camas;
      if (strtoupper($disponi_camas_cond) != "II" && strtoupper($disponi_camas_cond) != "QP" && strtoupper($disponi_camas_cond) != "NP" && strtoupper($disponi_camas_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['disponi_camas'] = $Conteudo;
      $this->cmp_formatado['disponi_camas'] = "'" . $this->cmp_formatado['disponi_camas'] . "'";
      if (isset($this->cmp_formatado['disponi_camas_input_2'])  && !empty($this->cmp_formatado['disponi_camas_input_2'])) {
          $this->cmp_formatado['disponi_camas_input_2'] = "'" . $this->cmp_formatado['disponi_camas_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($disponi_login) || $disponi_login_cond == "nu" || $disponi_login_cond == "nn" || $disponi_login_cond == "ep" || $disponi_login_cond == "ne")
      {
         $this->monta_condicao("disponi.login", $disponi_login_cond, $disponi_login, "", "disponi_login", "VARCHAR", false);
      }

      //----- $disponi_id_disponibilidad
      $this->Date_part = false;
      if (isset($disponi_id_disponibilidad) || $disponi_id_disponibilidad_cond == "nu" || $disponi_id_disponibilidad_cond == "nn" || $disponi_id_disponibilidad_cond == "ep" || $disponi_id_disponibilidad_cond == "ne")
      {
         $this->monta_condicao("disponi.Id_disponibilidad", $disponi_id_disponibilidad_cond, $disponi_id_disponibilidad, "", "disponi_id_disponibilidad", "INT", false);
      }

      //----- $disponi_id_ips
      $this->Date_part = false;
      if (isset($disponi_id_ips) || $disponi_id_ips_cond == "nu" || $disponi_id_ips_cond == "nn" || $disponi_id_ips_cond == "ep" || $disponi_id_ips_cond == "ne")
      {
         $this->monta_condicao("disponi.Id_Ips", $disponi_id_ips_cond, $disponi_id_ips, "", "disponi_id_ips", "INT", false);
      }

      //----- $disponi_camas
      $this->Date_part = false;
      if (isset($disponi_camas) || $disponi_camas_cond == "nu" || $disponi_camas_cond == "nn" || $disponi_camas_cond == "ep" || $disponi_camas_cond == "ne")
      {
         $this->monta_condicao("disponi.camas", $disponi_camas_cond, $disponi_camas, "", "disponi_camas", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['cond_pesq'] .= $this->NM_operador;
