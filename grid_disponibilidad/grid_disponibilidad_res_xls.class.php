...
class grid_disponibilidad_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['pivot_group_by'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_disponibilidad']['xls_res_sheet'] = $this->Xls_f;
      }
