<?php
@session_start() ;
$_SESSION['scriptcase']['grid_eps']['sc_process_barr'] = true;
require_once('../grid_eps/index.php');
unset($_SESSION['scriptcase']['grid_eps']['sc_process_barr']);
$ExportCtrl = new grid_eps_export_control;
$ExportCtrl->Export_barr();

class grid_eps_export_control
{
