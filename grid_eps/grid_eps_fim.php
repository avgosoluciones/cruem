...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_eps"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_eps"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_eps'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eps']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eps']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eps']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eps']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eps']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_eps']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_eps']['embutida_filho'] as $ind => $sc_init)
          {
