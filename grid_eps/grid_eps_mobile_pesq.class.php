...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_eps";$Nm_numeric[] = "id_eps";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_eps_cond" name="id_eps_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_eps'), this, 'id_eps')">
      ...
      <br><span id="id_hide_id_eps"  <?php echo $str_hide_id_eps?>><INPUT  type="text" id="SC_id_eps" name="id_eps" value="<?php echo NM_encode_input($id_eps) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_eps_cond" name="eps_cond" onChange="nm_campos_between(document.getElementById('id_vis_eps'), this, 'eps')">
      ...
      <br><span id="id_hide_eps"  <?php echo $str_hide_eps?>><?php
      if ($eps != "")
      {
      $eps_look = (is_string($eps) ? substr($this->Db->qstr($eps), 1, -1) : $eps); 
      $nmgp_def_dados = array(); 
