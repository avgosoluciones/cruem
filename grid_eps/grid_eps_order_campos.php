...
<?php
   ...
   $Ord_Cmp = new grid_eps_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_eps_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_eps'] = "Id_Eps";
   $tab_labels["id_eps"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eps']['labels']["id_eps"])) ? $_SESSION['sc_session'][$sc_init]['grid_eps']['labels']["id_eps"] : "Id Eps";
   $tab_ger_campos['eps'] = "on";
   $tab_def_campos['eps'] = "eps";
   $tab_labels["eps"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eps']['labels']["eps"])) ? $_SESSION['sc_session'][$sc_init]['grid_eps']['labels']["eps"] : "Eps";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eps']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eps']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eps']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_eps']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
