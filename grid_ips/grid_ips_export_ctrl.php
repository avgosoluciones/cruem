<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ips']['sc_process_barr'] = true;
require_once('../grid_ips/index.php');
unset($_SESSION['scriptcase']['grid_ips']['sc_process_barr']);
$ExportCtrl = new grid_ips_export_control;
$ExportCtrl->Export_barr();

class grid_ips_export_control
{
