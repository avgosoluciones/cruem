...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_ips";$Nm_numeric[] = "id_ips";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_ips_cond" name="id_ips_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_ips'), this, 'id_ips')">
      ...
      <br><span id="id_hide_id_ips"  <?php echo $str_hide_id_ips?>><INPUT  type="text" id="SC_id_ips" name="id_ips" value="<?php echo NM_encode_input($id_ips) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombre_ips_cond" name="nombre_ips_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_ips'), this, 'nombre_ips')">
      ...
      <br><span id="id_hide_nombre_ips"  <?php echo $str_hide_nombre_ips?>><?php
      if ($nombre_ips != "")
      {
      $nombre_ips_look = (is_string($nombre_ips) ? substr($this->Db->qstr($nombre_ips), 1, -1) : $nombre_ips); 
      $nmgp_def_dados = array(); 
