<?php
@session_start() ;
$_SESSION['scriptcase']['grid_medico']['sc_process_barr'] = true;
require_once('../grid_medico/index.php');
unset($_SESSION['scriptcase']['grid_medico']['sc_process_barr']);
$ExportCtrl = new grid_medico_export_control;
$ExportCtrl->Export_barr();

class grid_medico_export_control
{
