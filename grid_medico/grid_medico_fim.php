...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_medico"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_medico"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_medico'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_medico']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_medico']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_medico']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_medico']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_medico']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_medico']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_medico']['embutida_filho'] as $ind => $sc_init)
          {
