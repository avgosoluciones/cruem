...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_medico";$Nm_numeric[] = "id_medico";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_telefono_cond" name="telefono_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono'), this, 'telefono')">
      ...
      <br><span id="id_hide_telefono"  <?php echo $str_hide_telefono?>><?php
      if ($telefono != "")
      {
      $telefono_look = (is_string($telefono) ? substr($this->Db->qstr($telefono), 1, -1) : $telefono); 
      $nmgp_def_dados = array(); 
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_medico_cond" name="id_medico_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_medico'), this, 'id_medico')">
      ...
      <br><span id="id_hide_id_medico"  <?php echo $str_hide_id_medico?>><INPUT  type="text" id="SC_id_medico" name="id_medico" value="<?php echo NM_encode_input($id_medico) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_medico_cond" name="medico_cond" onChange="nm_campos_between(document.getElementById('id_vis_medico'), this, 'medico')">
      ...
      <br><span id="id_hide_medico"  <?php echo $str_hide_medico?>><?php
      if ($medico != "")
      {
      $medico_look = (is_string($medico) ? substr($this->Db->qstr($medico), 1, -1) : $medico); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_registro_medico_cond" name="registro_medico_cond" onChange="nm_campos_between(document.getElementById('id_vis_registro_medico'), this, 'registro_medico')">
      ...
      <br><span id="id_hide_registro_medico"  <?php echo $str_hide_registro_medico?>><?php
      if ($registro_medico != "")
      {
      $registro_medico_look = (is_string($registro_medico) ? substr($this->Db->qstr($registro_medico), 1, -1) : $registro_medico); 
      $nmgp_def_dados = array(); 
