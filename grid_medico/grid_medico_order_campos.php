...
<?php
   ...
   $Ord_Cmp = new grid_medico_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_medico_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_medico'] = "Id_Medico";
   $tab_labels["id_medico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["id_medico"])) ? $_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["id_medico"] : "Id Medico";
   $tab_ger_campos['medico'] = "on";
   $tab_def_campos['medico'] = "medico";
   $tab_labels["medico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["medico"])) ? $_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["medico"] : "Medico";
   $tab_ger_campos['registro_medico'] = "on";
   $tab_def_campos['registro_medico'] = "registro_medico";
   $tab_labels["registro_medico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["registro_medico"])) ? $_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["registro_medico"] : "Registro Medico";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["telefono"] : "Telefono";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_medico']['labels']["estado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_medico']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_medico']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_medico_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_medico']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
