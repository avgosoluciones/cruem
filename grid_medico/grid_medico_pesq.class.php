...
class grid_medico_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_medico_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_medico_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_medico_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_telefono')
      {
          $telefono = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_telefono($telefono);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_medico')
      {
          $medico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_medico($medico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_registro_medico')
      {
          $registro_medico = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_registro_medico($registro_medico);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $NM_cond = str_replace(array("##ini##","##fim##"), array("",""),$NM_cond);
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> medico</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_medico/grid_medico_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_medico_ajax_search.js"></script>
 <script type="text/javascript" src="grid_medico_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_medico_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_medico']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_medico']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_telefono_cond#NMF#' + search_get_sel_txt('SC_telefono_cond') + '@NMF@';
  str_out += 'SC_telefono#NMF#' + search_get_text('SC_telefono') + '@NMF@';
  str_out += 'id_ac_telefono#NMF#' + search_get_text('id_ac_telefono') + '@NMF@';
  str_out += 'SC_id_medico_cond#NMF#' + search_get_sel_txt('SC_id_medico_cond') + '@NMF@';
  str_out += 'SC_id_medico#NMF#' + search_get_text('SC_id_medico') + '@NMF@';
  str_out += 'SC_medico_cond#NMF#' + search_get_sel_txt('SC_medico_cond') + '@NMF@';
  str_out += 'SC_medico#NMF#' + search_get_text('SC_medico') + '@NMF@';
  str_out += 'id_ac_medico#NMF#' + search_get_text('id_ac_medico') + '@NMF@';
  str_out += 'SC_registro_medico_cond#NMF#' + search_get_sel_txt('SC_registro_medico_cond') + '@NMF@';
  str_out += 'SC_registro_medico#NMF#' + search_get_text('SC_registro_medico') + '@NMF@';
  str_out += 'id_ac_registro_medico#NMF#' + search_get_text('id_ac_registro_medico') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_medico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_medico").autocomplete({
     minLength: 1,
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_medico").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_registro_medico").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_registro_medico").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_registro_medico",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_registro_medico").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_registro_medico").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_telefono").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_telefono").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_telefono",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> medico</div>
...
<?php
   ...
   {
      global 
             $telefono_cond, $telefono, $telefono_autocomp,
             $id_medico_cond, $id_medico,
             $medico_cond, $medico, $medico_autocomp,
             $registro_medico_cond, $registro_medico, $registro_medico_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['telefono']; 
          $telefono_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['telefono_cond']; 
          $id_medico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['id_medico']; 
          $id_medico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['id_medico_cond']; 
          $medico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['medico']; 
          $medico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['medico_cond']; 
          $registro_medico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['registro_medico']; 
          $registro_medico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['registro_medico_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['NM_operador']; 
          if (strtoupper($id_medico_cond) != "II" && strtoupper($id_medico_cond) != "QP" && strtoupper($id_medico_cond) != "NP" && strtoupper($id_medico_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_medico, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_medico_cond) || empty($id_medico_cond))
      {
         $id_medico_cond = "gt";
      }
      if (!isset($medico_cond) || empty($medico_cond))
      {
         $medico_cond = "qp";
      }
      if (!isset($registro_medico_cond) || empty($registro_medico_cond))
      {
         $registro_medico_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_telefono = (in_array($telefono_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_medico = (in_array($id_medico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_medico = (in_array($medico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_registro_medico = (in_array($registro_medico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($telefono)) ? strpos($telefono, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $telefono = substr($telefono, 0, $tmp_pos);
         }
      }
      if (!isset($id_medico) || $id_medico == "")
      {
          $id_medico = "";
      }
      if (isset($id_medico) && !empty($id_medico))
      {
         $tmp_pos = (is_string($id_medico)) ? strpos($id_medico, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_medico = substr($id_medico, 0, $tmp_pos);
         }
      }
      if (!isset($medico) || $medico == "")
      {
          $medico = "";
      }
      if (isset($medico) && !empty($medico))
      {
         $tmp_pos = (is_string($medico)) ? strpos($medico, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $medico = substr($medico, 0, $tmp_pos);
         }
      }
      if (!isset($registro_medico) || $registro_medico == "")
      {
          $registro_medico = "";
      }
      if (isset($registro_medico) && !empty($registro_medico))
      {
         $tmp_pos = (is_string($registro_medico)) ? strpos($registro_medico, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $registro_medico = substr($registro_medico, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_medico_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_medico']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_medico']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_telefono_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['telefono'])) ? $this->New_label['telefono'] : "Telefono"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_telefono_cond" name="telefono_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono'), this, 'telefono')">
       <OPTION value="qp" <?php if ("qp" == $telefono_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $telefono_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $telefono_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $telefono_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_telefono" <?php echo $str_hide_telefono?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['telefono'])) ? $this->New_label['telefono'] : "Telefono";
 $nmgp_tab_label .= "telefono?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $telefono;
      }
?>
<INPUT  type="text" id="SC_telefono" name="telefono" value="<?php echo NM_encode_input($telefono) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_telefono" name="telefono_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_id_medico_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_medico'])) ? $this->New_label['id_medico'] : "Id Medico"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_medico_cond" name="id_medico_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_medico'), this, 'id_medico')">
       <OPTION value="gt" <?php if ("gt" == $id_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_medico" <?php echo $str_hide_id_medico?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_medico'])) ? $this->New_label['id_medico'] : "Id Medico";
 $nmgp_tab_label .= "id_medico?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_medico" name="id_medico" value="<?php echo NM_encode_input($id_medico) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_medico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['medico'])) ? $this->New_label['medico'] : "Medico"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_medico_cond" name="medico_cond" onChange="nm_campos_between(document.getElementById('id_vis_medico'), this, 'medico')">
       <OPTION value="qp" <?php if ("qp" == $medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_medico" <?php echo $str_hide_medico?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['medico'])) ? $this->New_label['medico'] : "Medico";
 $nmgp_tab_label .= "medico?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $medico;
      }
?>
<INPUT  type="text" id="SC_medico" name="medico" value="<?php echo NM_encode_input($medico) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_medico" name="medico_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_registro_medico_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['registro_medico'])) ? $this->New_label['registro_medico'] : "Registro Medico"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_registro_medico_cond" name="registro_medico_cond" onChange="nm_campos_between(document.getElementById('id_vis_registro_medico'), this, 'registro_medico')">
       <OPTION value="qp" <?php if ("qp" == $registro_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $registro_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $registro_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $registro_medico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_registro_medico" <?php echo $str_hide_registro_medico?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['registro_medico'])) ? $this->New_label['registro_medico'] : "Registro Medico";
 $nmgp_tab_label .= "registro_medico?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $registro_medico;
      }
?>
<INPUT  type="text" id="SC_registro_medico" name="registro_medico" value="<?php echo NM_encode_input($registro_medico) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_registro_medico" name="registro_medico_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.telefono_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_telefono'), document.F1.telefono_cond, 'telefono');
   document.F1.telefono.value = "";
   document.F1.telefono_autocomp.value = "";
   document.F1.id_medico_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_medico'), document.F1.id_medico_cond, 'id_medico');
   document.F1.id_medico.value = "";
   document.F1.medico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_medico'), document.F1.medico_cond, 'medico');
   document.F1.medico.value = "";
   document.F1.medico_autocomp.value = "";
   document.F1.registro_medico_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_registro_medico'), document.F1.registro_medico_cond, 'registro_medico');
   document.F1.registro_medico.value = "";
   document.F1.registro_medico_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_telefono_cond'] = 'cond';
      $tp_fields['SC_telefono'] = 'text_aut';
      $tp_fields['id_ac_telefono'] = 'text_aut';
      $tp_fields['SC_id_medico_cond'] = 'cond';
      $tp_fields['SC_id_medico'] = 'text';
      $tp_fields['SC_medico_cond'] = 'cond';
      $tp_fields['SC_medico'] = 'text_aut';
      $tp_fields['id_ac_medico'] = 'text_aut';
      $tp_fields['SC_registro_medico_cond'] = 'cond';
      $tp_fields['SC_registro_medico'] = 'text_aut';
      $tp_fields['id_ac_registro_medico'] = 'text_aut';
   ...
   {
      global $telefono_cond, $telefono, $telefono_autocomp,
             $id_medico_cond, $id_medico,
             $medico_cond, $medico, $medico_autocomp,
             $registro_medico_cond, $registro_medico, $registro_medico_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($telefono_autocomp) && empty($telefono))
      {
          $telefono = $telefono_autocomp;
      }
      if (!empty($medico_autocomp) && empty($medico))
      {
          $medico = $medico_autocomp;
      }
      if (!empty($registro_medico_autocomp) && empty($registro_medico))
      {
          $registro_medico = $registro_medico_autocomp;
      }
      $telefono_cond_salva = $telefono_cond; 
      if (!isset($telefono_input_2) || $telefono_input_2 == "")
      {
          $telefono_input_2 = $telefono;
      }
      $id_medico_cond_salva = $id_medico_cond; 
      if (!isset($id_medico_input_2) || $id_medico_input_2 == "")
      {
          $id_medico_input_2 = $id_medico;
      }
      $medico_cond_salva = $medico_cond; 
      if (!isset($medico_input_2) || $medico_input_2 == "")
      {
          $medico_input_2 = $medico;
      }
      $registro_medico_cond_salva = $registro_medico_cond; 
      if (!isset($registro_medico_input_2) || $registro_medico_input_2 == "")
      {
          $registro_medico_input_2 = $registro_medico;
      }
      if ($id_medico_cond != "in")
      {
          nm_limpa_numero($id_medico, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['telefono'] = $telefono; 
      if (is_array($telefono) && !empty($telefono))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0] = $telefono;
      }
      elseif ($telefono_cond_salva == "nu" || $telefono_cond_salva == "nn" || $telefono_cond_salva == "ep" || $telefono_cond_salva == "ne" || !empty($telefono))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0][0] = $telefono;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['telefono_cond'] = $telefono_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['cmp'] = "telefono"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['opc'] = $telefono_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq']['telefono'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['id_medico'] = $id_medico; 
      if (is_array($id_medico) && !empty($id_medico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0] = $id_medico;
      }
      elseif ($id_medico_cond_salva == "nu" || $id_medico_cond_salva == "nn" || $id_medico_cond_salva == "ep" || $id_medico_cond_salva == "ne" || !empty($id_medico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0][0] = $id_medico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['id_medico_cond'] = $id_medico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['cmp'] = "id_medico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['opc'] = $id_medico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq']['id_medico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['medico'] = $medico; 
      if (is_array($medico) && !empty($medico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0] = $medico;
      }
      elseif ($medico_cond_salva == "nu" || $medico_cond_salva == "nn" || $medico_cond_salva == "ep" || $medico_cond_salva == "ne" || !empty($medico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0][0] = $medico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['medico_cond'] = $medico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['cmp'] = "medico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['opc'] = $medico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq']['medico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['registro_medico'] = $registro_medico; 
      if (is_array($registro_medico) && !empty($registro_medico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0] = $registro_medico;
      }
      elseif ($registro_medico_cond_salva == "nu" || $registro_medico_cond_salva == "nn" || $registro_medico_cond_salva == "ep" || $registro_medico_cond_salva == "ne" || !empty($registro_medico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['val'][0][0] = $registro_medico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['registro_medico_cond'] = $registro_medico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['cmp'] = "registro_medico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid]['opc'] = $registro_medico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['grid_pesq']['registro_medico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($telefono != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['telefono'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['telefono'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['telefono'] = $telefono;
      }
      $this->cmp_formatado['telefono'] = "'" . $this->cmp_formatado['telefono'] . "'";
      if (isset($this->cmp_formatado['telefono_input_2'])  && !empty($this->cmp_formatado['telefono_input_2'])) {
          $this->cmp_formatado['telefono_input_2'] = "'" . $this->cmp_formatado['telefono_input_2'] . "'";
      }
      $Conteudo = $id_medico;
      if (strtoupper($id_medico_cond) != "II" && strtoupper($id_medico_cond) != "QP" && strtoupper($id_medico_cond) != "NP" && strtoupper($id_medico_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_medico'] = $Conteudo;
      $this->cmp_formatado['id_medico'] = "'" . $this->cmp_formatado['id_medico'] . "'";
      if (isset($this->cmp_formatado['id_medico_input_2'])  && !empty($this->cmp_formatado['id_medico_input_2'])) {
          $this->cmp_formatado['id_medico_input_2'] = "'" . $this->cmp_formatado['id_medico_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($medico != '') {
      $medico_look = (is_string($medico) ? substr($this->Db->qstr($medico), 1, -1) : $medico); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['medico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['medico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['medico'] = $medico;
      }
      $this->cmp_formatado['medico'] = "'" . $this->cmp_formatado['medico'] . "'";
      if (isset($this->cmp_formatado['medico_input_2'])  && !empty($this->cmp_formatado['medico_input_2'])) {
          $this->cmp_formatado['medico_input_2'] = "'" . $this->cmp_formatado['medico_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($registro_medico != '') {
      $registro_medico_look = (is_string($registro_medico) ? substr($this->Db->qstr($registro_medico), 1, -1) : $registro_medico); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['registro_medico'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['registro_medico'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['registro_medico'] = $registro_medico;
      }
      $this->cmp_formatado['registro_medico'] = "'" . $this->cmp_formatado['registro_medico'] . "'";
      if (isset($this->cmp_formatado['registro_medico_input_2'])  && !empty($this->cmp_formatado['registro_medico_input_2'])) {
          $this->cmp_formatado['registro_medico_input_2'] = "'" . $this->cmp_formatado['registro_medico_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($telefono) || $telefono_cond == "nu" || $telefono_cond == "nn" || $telefono_cond == "ep" || $telefono_cond == "ne")
      {
         $this->monta_condicao("telefono", $telefono_cond, $telefono, "", "telefono", "VARCHAR", false);
      }

      //----- $id_medico
      $this->Date_part = false;
      if (isset($id_medico) || $id_medico_cond == "nu" || $id_medico_cond == "nn" || $id_medico_cond == "ep" || $id_medico_cond == "ne")
      {
         $this->monta_condicao("Id_Medico", $id_medico_cond, $id_medico, "", "id_medico", "INT", false);
      }

      //----- $medico
      $this->Date_part = false;
      if (isset($medico) || $medico_cond == "nu" || $medico_cond == "nn" || $medico_cond == "ep" || $medico_cond == "ne")
      {
         $this->monta_condicao("medico", $medico_cond, $medico, "", "medico", "VARCHAR", false);
      }

      //----- $registro_medico
      $this->Date_part = false;
      if (isset($registro_medico) || $registro_medico_cond == "nu" || $registro_medico_cond == "nn" || $registro_medico_cond == "ep" || $registro_medico_cond == "ne")
      {
         $this->monta_condicao("registro_medico", $registro_medico_cond, $registro_medico, "", "registro_medico", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_medico']['cond_pesq'] .= $this->NM_operador;
