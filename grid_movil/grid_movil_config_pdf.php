...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_movil']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_movil']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_movil']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_movil']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_movil']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_movil']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_movil']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_movil']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_movil']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_movil']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
