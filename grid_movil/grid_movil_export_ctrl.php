<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movil']['sc_process_barr'] = true;
require_once('../grid_movil/index.php');
unset($_SESSION['scriptcase']['grid_movil']['sc_process_barr']);
$ExportCtrl = new grid_movil_export_control;
$ExportCtrl->Export_barr();

class grid_movil_export_control
{
