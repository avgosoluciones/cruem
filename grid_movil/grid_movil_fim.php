...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_movil"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_movil"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_movil'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_movil']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_movil']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_movil']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_movil']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_movil']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_movil']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_movil']['embutida_filho'] as $ind => $sc_init)
          {
