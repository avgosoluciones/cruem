...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_movil";$Nm_numeric[] = "id_movil";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_movil_cond" name="id_movil_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_movil'), this, 'id_movil')">
      ...
      <br><span id="id_hide_id_movil"  <?php echo $str_hide_id_movil?>><INPUT  type="text" id="SC_id_movil" name="id_movil" value="<?php echo NM_encode_input($id_movil) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_placa_cond" name="placa_cond" onChange="nm_campos_between(document.getElementById('id_vis_placa'), this, 'placa')">
      ...
      <br><span id="id_hide_placa"  <?php echo $str_hide_placa?>><?php
      if ($placa != "")
      {
      $placa_look = (is_string($placa) ? substr($this->Db->qstr($placa), 1, -1) : $placa); 
      $nmgp_def_dados = array(); 
