...
*/
    ...
    $SC_cod_proj = "CRUE";
    $SC_apl_proc = "grid_observaciones";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_observaciones']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_observaciones']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_observaciones']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_observaciones']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_observaciones']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_observaciones']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_observaciones']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
