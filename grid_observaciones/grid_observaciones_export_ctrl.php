<?php
@session_start() ;
$_SESSION['scriptcase']['grid_observaciones']['sc_process_barr'] = true;
require_once('../grid_observaciones/index.php');
unset($_SESSION['scriptcase']['grid_observaciones']['sc_process_barr']);
$ExportCtrl = new grid_observaciones_export_control;
$ExportCtrl->Export_barr();

class grid_observaciones_export_control
{
