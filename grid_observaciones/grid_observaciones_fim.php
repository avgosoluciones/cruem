...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_observaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_observaciones"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_observaciones'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_observaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_observaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_observaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_observaciones']['embutida_filho'] as $ind => $sc_init)
          {
