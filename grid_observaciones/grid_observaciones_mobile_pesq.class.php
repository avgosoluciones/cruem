...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fecha";$Nm_numeric[] = "id_observacion";$Nm_numeric[] = "ip";$Nm_numeric[] = "id_procedimiento";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_ip"  <?php echo $str_hide_ip?>><INPUT  type="text" id="SC_ip" name="ip" value="<?php echo NM_encode_input($ip) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_observacion_cond" name="id_observacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_observacion'), this, 'id_observacion')">
      ...
      <br><span id="id_hide_id_observacion"  <?php echo $str_hide_id_observacion?>><INPUT  type="text" id="SC_id_observacion" name="id_observacion" value="<?php echo NM_encode_input($id_observacion) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_observa_cond" name="observa_cond" onChange="nm_campos_between(document.getElementById('id_vis_observa'), this, 'observa')">
      ...
      <br><span id="id_hide_observa"  <?php echo $str_hide_observa?>><?php
      if ($observa != "")
      {
      $observa_look = (is_string($observa) ? substr($this->Db->qstr($observa), 1, -1) : $observa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_user_cond" name="user_cond" onChange="nm_campos_between(document.getElementById('id_vis_user'), this, 'user')">
