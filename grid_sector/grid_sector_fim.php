...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_sector"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_sector"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_sector'] = array();
   $fecha_janela = false;
