...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_sector";$Nm_numeric[] = "id_sector";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_sector_cond" name="sector_cond" onChange="nm_campos_between(document.getElementById('id_vis_sector'), this, 'sector')">
      ...
      <br><span id="id_hide_sector"  <?php echo $str_hide_sector?>><?php
      if ($sector != "")
      {
      $sector_look = (is_string($sector) ? substr($this->Db->qstr($sector), 1, -1) : $sector); 
      $nmgp_def_dados = array(); 
