...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sector')
      {
          $sector = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sector($sector);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
            ...
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
             ...
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               ...
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "DF":     // 
               ...
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "GE":     // 
               ...
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "LT":     // 
               ...
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "LE":     // 
               ...
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "EP":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "NE":     // 
               ...
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_sector_cond#NMF#' + search_get_sel_txt('SC_sector_cond') + '@NMF@';
  str_out += 'SC_sector#NMF#' + search_get_text('SC_sector') + '@NMF@';
  str_out += 'id_ac_sector#NMF#' + search_get_text('id_ac_sector') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_sector").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_sector").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sector",
          max_itens: "10",
          cod_desc: "N",
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $sector_cond, $sector, $sector_autocomp,
      ...
      { 
          ...
          $id_sector = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['id_sector']; 
          $id_sector_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['id_sector_cond']; 
          $sector = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['sector']; 
          $sector_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['sector_cond']; 
      ...
      if (!isset($sector_cond) || empty($sector_cond))
      {
         $sector_cond = "qp";
      }
      ...
      $str_hide_sector = (in_array($sector_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($sector)) ? strpos($sector, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $sector = substr($sector, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<INPUT  type="text" id="SC_id_sector" name="id_sector" value="<?php echo NM_encode_input($id_sector) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_sector_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sector'])) ? $this->New_label['sector'] : "Sector"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_sector_cond" name="sector_cond" onChange="nm_campos_between(document.getElementById('id_vis_sector'), this, 'sector')">
       <OPTION value="qp" <?php if ("qp" == $sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sector" <?php echo $str_hide_sector?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['sector'])) ? $this->New_label['sector'] : "Sector";
 $nmgp_tab_label .= "sector?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $sector;
      }
?>
<INPUT  type="text" id="SC_sector" name="sector" value="<?php echo NM_encode_input($sector) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_sector" name="sector_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.sector_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sector'), document.F1.sector_cond, 'sector');
   document.F1.sector.value = "";
   document.F1.sector_autocomp.value = "";
 }
...
<?php
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_sector_cond'] = 'cond';
      $tp_fields['SC_sector'] = 'text_aut';
      $tp_fields['id_ac_sector'] = 'text_aut';
   ...
   {
      global $id_sector_cond, $id_sector,
             $sector_cond, $sector, $sector_autocomp, $nmgp_tab_label;
      ...
      if (!empty($sector_autocomp) && empty($sector))
      {
          $sector = $sector_autocomp;
      }
      ...
      $sector_cond_salva = $sector_cond; 
      if (!isset($sector_input_2) || $sector_input_2 == "")
      {
          $sector_input_2 = $sector;
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['id_sector'] = $id_sector; 
      if (is_array($id_sector) && !empty($id_sector))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['val'][0] = $id_sector;
      }
      elseif ($id_sector_cond_salva == "nu" || $id_sector_cond_salva == "nn" || $id_sector_cond_salva == "ep" || $id_sector_cond_salva == "ne" || !empty($id_sector))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['val'][0][0] = $id_sector;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['id_sector_cond'] = $id_sector_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['cmp'] = "id_sector"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['opc'] = $id_sector_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq']['id_sector'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['sector'] = $sector; 
      if (is_array($sector) && !empty($sector))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['val'][0] = $sector;
      }
      elseif ($sector_cond_salva == "nu" || $sector_cond_salva == "nn" || $sector_cond_salva == "ep" || $sector_cond_salva == "ne" || !empty($sector))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['val'][0][0] = $sector;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['campos_busca']['sector_cond'] = $sector_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['cmp'] = "sector"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid]['opc'] = $sector_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['grid_pesq']['sector'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
    ...
    if ($sector != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sector'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['sector'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sector'] = $sector;
      }
      $this->cmp_formatado['sector'] = "'" . $this->cmp_formatado['sector'] . "'";
      if (isset($this->cmp_formatado['sector_input_2'])  && !empty($this->cmp_formatado['sector_input_2'])) {
          $this->cmp_formatado['sector_input_2'] = "'" . $this->cmp_formatado['sector_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $sector
      $this->Date_part = false;
      if (isset($sector) || $sector_cond == "nu" || $sector_cond == "nn" || $sector_cond == "ep" || $sector_cond == "ne")
      {
         $this->monta_condicao("Sector", $sector_cond, $sector, "", "sector", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sector']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
