<?php
@session_start() ;
$_SESSION['scriptcase']['grid_seguridad_social']['sc_process_barr'] = true;
require_once('../grid_seguridad_social/index.php');
unset($_SESSION['scriptcase']['grid_seguridad_social']['sc_process_barr']);
$ExportCtrl = new grid_seguridad_social_export_control;
$ExportCtrl->Export_barr();

class grid_seguridad_social_export_control
{
