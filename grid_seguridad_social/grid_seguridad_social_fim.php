...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_seguridad_social"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_seguridad_social"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_seguridad_social'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_seguridad_social</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_seguridad_social']['embutida_filho'] as $ind => $sc_init)
          {
