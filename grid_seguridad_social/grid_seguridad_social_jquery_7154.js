...
function ajax_navigate(opc, parm, Fade='S')
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_grid_seguridad_social').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_grid_seguridad_social').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_grid_seguridad_social').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_grid_seguridad_social').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_grid_seguridad_social').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_seguridad_social').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_seguridad_social').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_seguridad_social').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_grid_seguridad_social').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_grid_seguridad_social').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_grid_seguridad_social').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_grid_seguridad_social').style.width  = '0px';
        }
        if (oResp["setValue"]) {
