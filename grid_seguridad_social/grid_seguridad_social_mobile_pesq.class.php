...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_seguridad_social";$Nm_numeric[] = "id_seguridad_social";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_seguridad_social_cond" name="id_seguridad_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_seguridad_social'), this, 'id_seguridad_social')">
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_seguridad_social_cond" name="seguridad_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_seguridad_social'), this, 'seguridad_social')">
      ...
      <br><span id="id_hide_seguridad_social"  <?php echo $str_hide_seguridad_social?>><?php
      if ($seguridad_social != "")
      {
      $seguridad_social_look = (is_string($seguridad_social) ? substr($this->Db->qstr($seguridad_social), 1, -1) : $seguridad_social); 
      $nmgp_def_dados = array(); 
