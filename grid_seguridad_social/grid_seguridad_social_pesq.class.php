...
class grid_seguridad_social_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_seguridad_social_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_seguridad_social_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_seguridad_social_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_seguridad_social')
      {
          $seguridad_social = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_seguridad_social($seguridad_social);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         $nome_sum = "seguridad_social.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $NM_cond = str_replace(array("##ini##","##fim##"), array("",""),$NM_cond);
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> seguridad_social</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_seguridad_social/grid_seguridad_social_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_seguridad_social_ajax_search.js"></script>
 <script type="text/javascript" src="grid_seguridad_social_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_seguridad_social_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_seguridad_social']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_seguridad_social']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_seguridad_social_cond#NMF#' + search_get_sel_txt('SC_id_seguridad_social_cond') + '@NMF@';
  str_out += 'SC_id_seguridad_social#NMF#' + search_get_text('SC_id_seguridad_social') + '@NMF@';
  str_out += 'SC_seguridad_social_cond#NMF#' + search_get_sel_txt('SC_seguridad_social_cond') + '@NMF@';
  str_out += 'SC_seguridad_social#NMF#' + search_get_text('SC_seguridad_social') + '@NMF@';
  str_out += 'id_ac_seguridad_social#NMF#' + search_get_text('id_ac_seguridad_social') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_seguridad_social").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_seguridad_social").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_seguridad_social",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_seguridad_social").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_seguridad_social").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> seguridad_social</div>
...
<?php
   ...
   {
      global 
             $id_seguridad_social_cond, $id_seguridad_social,
             $seguridad_social_cond, $seguridad_social, $seguridad_social_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $id_seguridad_social = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['id_seguridad_social']; 
          $id_seguridad_social_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['id_seguridad_social_cond']; 
          $seguridad_social = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['seguridad_social']; 
          $seguridad_social_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['seguridad_social_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['NM_operador']; 
          if (strtoupper($id_seguridad_social_cond) != "II" && strtoupper($id_seguridad_social_cond) != "QP" && strtoupper($id_seguridad_social_cond) != "NP" && strtoupper($id_seguridad_social_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_seguridad_social, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($id_seguridad_social_cond) || empty($id_seguridad_social_cond))
      {
         $id_seguridad_social_cond = "gt";
      }
      if (!isset($seguridad_social_cond) || empty($seguridad_social_cond))
      {
         $seguridad_social_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_id_seguridad_social = (in_array($id_seguridad_social_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_seguridad_social = (in_array($seguridad_social_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($id_seguridad_social) || $id_seguridad_social == "")
      {
          $id_seguridad_social = "";
      }
      if (isset($id_seguridad_social) && !empty($id_seguridad_social))
      {
         $tmp_pos = (is_string($id_seguridad_social)) ? strpos($id_seguridad_social, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_seguridad_social = substr($id_seguridad_social, 0, $tmp_pos);
         }
      }
      if (!isset($seguridad_social) || $seguridad_social == "")
      {
          $seguridad_social = "";
      }
      if (isset($seguridad_social) && !empty($seguridad_social))
      {
         $tmp_pos = (is_string($seguridad_social)) ? strpos($seguridad_social, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $seguridad_social = substr($seguridad_social, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_seguridad_social_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_seguridad_social']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_seguridad_social']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_id_seguridad_social_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_seguridad_social'])) ? $this->New_label['id_seguridad_social'] : "Id Seguridad Social"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_seguridad_social_cond" name="id_seguridad_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_seguridad_social'), this, 'id_seguridad_social')">
       <OPTION value="gt" <?php if ("gt" == $id_seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_seguridad_social" <?php echo $str_hide_id_seguridad_social?> valign="top">
 ...
 $nmgp_tab_label .= "id_seguridad_social?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_id_seguridad_social" name="id_seguridad_social" value="<?php echo NM_encode_input($id_seguridad_social) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_seguridad_social_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['seguridad_social'])) ? $this->New_label['seguridad_social'] : "Seguridad Social"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_seguridad_social_cond" name="seguridad_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_seguridad_social'), this, 'seguridad_social')">
       <OPTION value="qp" <?php if ("qp" == $seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $seguridad_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_seguridad_social" <?php echo $str_hide_seguridad_social?> valign="top">
 ...
 $nmgp_tab_label .= "seguridad_social?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $seguridad_social;
      }
?>
<INPUT  type="text" id="SC_seguridad_social" name="seguridad_social" value="<?php echo NM_encode_input($seguridad_social) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_seguridad_social" name="seguridad_social_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_seguridad_social_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_seguridad_social'), document.F1.id_seguridad_social_cond, 'id_seguridad_social');
   document.F1.id_seguridad_social.value = "";
   document.F1.seguridad_social_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_seguridad_social'), document.F1.seguridad_social_cond, 'seguridad_social');
   document.F1.seguridad_social.value = "";
   document.F1.seguridad_social_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_seguridad_social/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_id_seguridad_social_cond'] = 'cond';
      $tp_fields['SC_id_seguridad_social'] = 'text';
      $tp_fields['SC_seguridad_social_cond'] = 'cond';
      $tp_fields['SC_seguridad_social'] = 'text_aut';
      $tp_fields['id_ac_seguridad_social'] = 'text_aut';
   ...
   {
      global $id_seguridad_social_cond, $id_seguridad_social,
             $seguridad_social_cond, $seguridad_social, $seguridad_social_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($seguridad_social_autocomp) && empty($seguridad_social))
      {
          $seguridad_social = $seguridad_social_autocomp;
      }
      $id_seguridad_social_cond_salva = $id_seguridad_social_cond; 
      if (!isset($id_seguridad_social_input_2) || $id_seguridad_social_input_2 == "")
      {
          $id_seguridad_social_input_2 = $id_seguridad_social;
      }
      $seguridad_social_cond_salva = $seguridad_social_cond; 
      if (!isset($seguridad_social_input_2) || $seguridad_social_input_2 == "")
      {
          $seguridad_social_input_2 = $seguridad_social;
      }
      if ($id_seguridad_social_cond != "in")
      {
          nm_limpa_numero($id_seguridad_social, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['id_seguridad_social'] = $id_seguridad_social; 
      if (is_array($id_seguridad_social) && !empty($id_seguridad_social))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['val'][0] = $id_seguridad_social;
      }
      elseif ($id_seguridad_social_cond_salva == "nu" || $id_seguridad_social_cond_salva == "nn" || $id_seguridad_social_cond_salva == "ep" || $id_seguridad_social_cond_salva == "ne" || !empty($id_seguridad_social))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['val'][0][0] = $id_seguridad_social;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['id_seguridad_social_cond'] = $id_seguridad_social_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['cmp'] = "id_seguridad_social"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['opc'] = $id_seguridad_social_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq']['id_seguridad_social'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['seguridad_social'] = $seguridad_social; 
      if (is_array($seguridad_social) && !empty($seguridad_social))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['val'][0] = $seguridad_social;
      }
      elseif ($seguridad_social_cond_salva == "nu" || $seguridad_social_cond_salva == "nn" || $seguridad_social_cond_salva == "ep" || $seguridad_social_cond_salva == "ne" || !empty($seguridad_social))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['val'][0][0] = $seguridad_social;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['seguridad_social_cond'] = $seguridad_social_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['cmp'] = "seguridad_social"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid]['opc'] = $seguridad_social_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['grid_pesq']['seguridad_social'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $id_seguridad_social;
      if (strtoupper($id_seguridad_social_cond) != "II" && strtoupper($id_seguridad_social_cond) != "QP" && strtoupper($id_seguridad_social_cond) != "NP" && strtoupper($id_seguridad_social_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_seguridad_social'] = $Conteudo;
      $this->cmp_formatado['id_seguridad_social'] = "'" . $this->cmp_formatado['id_seguridad_social'] . "'";
      if (isset($this->cmp_formatado['id_seguridad_social_input_2'])  && !empty($this->cmp_formatado['id_seguridad_social_input_2'])) {
          $this->cmp_formatado['id_seguridad_social_input_2'] = "'" . $this->cmp_formatado['id_seguridad_social_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($seguridad_social != '') {
      $seguridad_social_look = (is_string($seguridad_social) ? substr($this->Db->qstr($seguridad_social), 1, -1) : $seguridad_social); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['seguridad_social'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['seguridad_social'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['seguridad_social'] = $seguridad_social;
      }
      $this->cmp_formatado['seguridad_social'] = "'" . $this->cmp_formatado['seguridad_social'] . "'";
      if (isset($this->cmp_formatado['seguridad_social_input_2'])  && !empty($this->cmp_formatado['seguridad_social_input_2'])) {
          $this->cmp_formatado['seguridad_social_input_2'] = "'" . $this->cmp_formatado['seguridad_social_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($id_seguridad_social) || $id_seguridad_social_cond == "nu" || $id_seguridad_social_cond == "nn" || $id_seguridad_social_cond == "ep" || $id_seguridad_social_cond == "ne")
      {
         $this->monta_condicao("Id_Seguridad_Social", $id_seguridad_social_cond, $id_seguridad_social, "", "id_seguridad_social", "INT", false);
      }

      //----- $seguridad_social
      $this->Date_part = false;
      if (isset($seguridad_social) || $seguridad_social_cond == "nu" || $seguridad_social_cond == "nn" || $seguridad_social_cond == "ep" || $seguridad_social_cond == "ne")
      {
         $this->monta_condicao("seguridad_social", $seguridad_social_cond, $seguridad_social, "", "seguridad_social", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad_social']['cond_pesq'] .= $this->NM_operador;
