<?php
@session_start() ;
$_SESSION['scriptcase']['grid_servicios_ips']['sc_process_barr'] = true;
require_once('../grid_servicios_ips/index.php');
unset($_SESSION['scriptcase']['grid_servicios_ips']['sc_process_barr']);
$ExportCtrl = new grid_servicios_ips_export_control;
$ExportCtrl->Export_barr();

class grid_servicios_ips_export_control
{
