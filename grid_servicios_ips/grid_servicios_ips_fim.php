...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____grid_servicios_ips"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____grid_servicios_ips"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_servicios_ips'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_servicios_ips</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_servicios_ips']['embutida_filho'] as $ind => $sc_init)
          {
