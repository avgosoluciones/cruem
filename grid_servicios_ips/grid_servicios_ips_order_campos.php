...
<?php
   ...
   $Ord_Cmp = new grid_servicios_ips_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_servicios_ips_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['ips_nombre_ips'] = "ips_nombre_ips";
   }
   else
   {
       $tab_def_campos['ips_nombre_ips'] = "ips.nombre_ips";
   }
   $tab_labels["ips_nombre_ips"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['labels']["ips_nombre_ips"])) ? $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['labels']["ips_nombre_ips"] : "Nombre Ips";
   $tab_ger_campos['servici_servicios'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['servici_servicios'] = "servici_servicios";
   }
   else
   {
       $tab_def_campos['servici_servicios'] = "servici.servicios";
   }
   $tab_labels["servici_servicios"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['labels']["servici_servicios"])) ? $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['labels']["servici_servicios"] : "Servicios";
   $tab_ger_campos['serv_ips_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['serv_ips_estado'] = "serv_ips_estado";
   }
   else
   {
       $tab_def_campos['serv_ips_estado'] = "serv_ips.estado";
   }
   $tab_labels["serv_ips_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['labels']["serv_ips_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['labels']["serv_ips_estado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_servicios_ips_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_servicios_ips']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
