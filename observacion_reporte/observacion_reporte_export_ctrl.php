<?php
@session_start() ;
$_SESSION['scriptcase']['observacion_reporte']['sc_process_barr'] = true;
require_once('../observacion_reporte/index.php');
unset($_SESSION['scriptcase']['observacion_reporte']['sc_process_barr']);
$ExportCtrl = new observacion_reporte_export_control;
$ExportCtrl->Export_barr();

class observacion_reporte_export_control
{
