<?php
class observacion_reporte_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
   ...
   var $procedimiento_consecutivo = array();
...
//
   ...
   $_SESSION['scriptcase']['observacion_reporte']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("observacion_reporte", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq_filtro'];
   $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
   $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
   $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
   $_SESSION['scriptcase']['contr_link_emb'] = $this->nm_location;
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_init()
 {
     ...
     $this->Pdf->SetTextColor(70, 68, 68);
 }
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/grp__NM__bg__NM__bitacorasugerenciaPage.png", "5.000000", "5.000000", "210", "380", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['barrio_id_barrio'] = "Id Barrio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['barrio_barrio'] = "Barrio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['barrio_id_sector'] = "Id Sector";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['eps_id_eps'] = "Id Eps";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['eps_eps'] = "Eps";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_id_procedimiento'] = "Id Procedimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_secad'] = "Secad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_direccion_servicio'] = "Direccion Servicio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_id_barrio'] = "Id Barrio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_quien_reporta'] = "Quien Reporta";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_hora_ingreso_llamada'] = "Hora Ingreso Llamada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_hora_notifica_movil'] = "Hora Notifica Movil";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_hora_llegada_sitio'] = "Hora Llegada Sitio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_hora_llegada_ips'] = "Hora Llegada Ips";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_hora_salida_ips'] = "Hora Salida Ips";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_tipo_servicio'] = "Tipo Servicio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_numero_contacto'] = "Numero Contacto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_consecutivo'] = "Consecutivo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_nombre_apellido'] = "Nombre Apellido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_tipo_documento'] = "Tipo Documento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_documento_identidad'] = "Documento Identidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_edad'] = "Edad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_tipo_caso'] = "Tipo Caso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_genero'] = "Genero";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_circunstancias_emergencia'] = "Circunstancias Emergencia";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_id_seguridad_social'] = "Id Seguridad Social";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_id_eps'] = "Id Eps";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_fecha'] = "Fecha";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_ip'] = "Ip";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['procedimiento_login'] = "Login";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['sector_id_sector'] = "Id Sector";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['sector_sector'] = "Sector";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['seguridad_id_seguridad_social'] = "Id Seguridad Social";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['seguridad_seguridad_social'] = "Seguridad Social";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['medico_id_medico'] = "Id Medico";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['medico_medico'] = "Medico";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['medico_registro_medico'] = "Registro Medico";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['medico_telefono'] = "Telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['medico_estado'] = "Estado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['ambulancia_id_movil'] = "Id Movil";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['ambulancia_placa'] = "Placa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones'] = "Anotaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones_id_observacion'] = "Id Observacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones_id_procedimiento'] = "Id Procedimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones_fecha'] = "Fecha";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones_ip'] = "Ip";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones_observa'] = "Observa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['anotaciones_user'] = "User";
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['labels']['sc_field_0'] = "Tipo Caso";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['observacion_reporte']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['qt_col_grid']) 
      {  
          ...
          $this->procedimiento_consecutivo[$this->nm_grid_colunas] = $this->rs_grid->fields[17] ;  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $this->procedimiento_consecutivo[$this->nm_grid_colunas] = NM_encode_input(sc_strip_script($this->procedimiento_consecutivo[$this->nm_grid_colunas]));
          }
          else {
              $this->procedimiento_consecutivo[$this->nm_grid_colunas] = sc_strip_script($this->procedimiento_consecutivo[$this->nm_grid_colunas]);
          }
          if ($this->procedimiento_consecutivo[$this->nm_grid_colunas] === "") 
          { 
              $this->procedimiento_consecutivo[$this->nm_grid_colunas] = "" ;  
          } 
          $this->procedimiento_consecutivo[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->procedimiento_consecutivo[$this->nm_grid_colunas]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
            ...
            $cell_barrio_barrio = array('posx' => '135.40475416664958', 'posy' => '54', 'data' => $this->barrio_barrio[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_eps_eps = array('posx' => '38.298437499995174', 'posy' => '55.02513124999306', 'data' => $this->eps_eps[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_secad = array('posx' => '174', 'posy' => '41.46920416666144', 'data' => $this->procedimiento_secad[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_direccion_servicio = array('posx' => '92.8068374999883', 'posy' => '62.268099999992145', 'data' => $this->procedimiento_direccion_servicio[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_Anotaciones_observa = array('posx' => '24.275520833330273', 'posy' => '141', 'data' => $this->anotaciones_observa[$this->nm_grid_colunas], 'width'      => '170', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_hora_ingreso_llamada = array('posx' => '23.86224166666366', 'posy' => '108.26432499998634', 'data' => $this->procedimiento_hora_ingreso_llamada[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_Hora_notifica_movil = array('posx' => '59.67597708332582', 'posy' => '107.73515833331975', 'data' => $this->procedimiento_hora_notifica_movil[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_hora_llegada_sitio = array('posx' => '96', 'posy' => '108.26432499998634', 'data' => $this->procedimiento_hora_llegada_sitio[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_hora_llegada_ips = array('posx' => '129', 'posy' => '108.26432499998634', 'data' => $this->procedimiento_hora_llegada_ips[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_hora_salida_ips = array('posx' => '166', 'posy' => '108.26432499998634', 'data' => $this->procedimiento_hora_salida_ips[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_tipo_servicio = array('posx' => '120.3854166666515', 'posy' => '79.8835291666566', 'data' => $this->procedimiento_tipo_servicio[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_numero_contacto = array('posx' => '41.208854166661474', 'posy' => '79.30065208332333', 'data' => $this->procedimiento_numero_contacto[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_nombre_apellido = array('posx' => '130', 'posy' => '48', 'data' => $this->procedimiento_nombre_apellido[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_tipo_documento = array('posx' => '42.53177083332797', 'posy' => '48.179037499993925', 'data' => $this->procedimiento_tipo_documento[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_documento_identidad = array('posx' => '47.563087499994', 'posy' => '47.860743749993965', 'data' => $this->procedimiento_documento_identidad[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_edad = array('posx' => '33.535937499995775', 'posy' => '67.08431041665821', 'data' => $this->procedimiento_edad[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_genero = array('posx' => '36.7151708333287', 'posy' => '73.4136729166574', 'data' => $this->procedimiento_genero[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_circunstancias_emergencia = array('posx' => '23.5272791666637', 'posy' => '89.99563958332199', 'data' => $this->procedimiento_circunstancias_emergencia[$this->nm_grid_colunas], 'width'      => '20', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_procedimiento_fecha = array('posx' => '36.97552083332867', 'posy' => '40.9691416666615', 'data' => $this->procedimiento_fecha[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_sector_Sector = array('posx' => '110.8604166666527', 'posy' => '54', 'data' => $this->sector_sector[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_seguridad_seguridad_social = array('posx' => '31.99817916666263', 'posy' => '60.205143749992416', 'data' => $this->seguridad_seguridad_social[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_medico = array('posx' => '59.00208333332589', 'posy' => '122.18378958331793', 'data' => $this->medico_medico[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_reg = array('posx' => '127.26458333331729', 'posy' => '122.52695416665122', 'data' => $this->medico_registro_medico[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_movil = array('posx' => '123.82499999998439', 'posy' => '72.46699374999086', 'data' => $this->ambulancia_placa[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_operador = array('posx' => '59.00208333332589', 'posy' => '128.32291666665049', 'data' => $this->procedimiento_login[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_47 = array('posx' => '110.33124999998608', 'posy' => '41.4983083333281', 'data' => $this->procedimiento_quien_reporta[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_50 = array('posx' => '59.26666666665919', 'posy' => '115.62291666665209', 'data' => $this->procedimiento_tipo_caso[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
            $cell_53 = array('posx' => '98.73932499998755', 'posy' => '34.65221458332896', 'data' => $this->procedimiento_consecutivo[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '10', 'color_r'    => '70', 'color_g'    => '68', 'color_b'    => '68', 'font_style' => $this->default_style);
