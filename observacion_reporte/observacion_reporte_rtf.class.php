...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "observacion_reporte.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_name']);
      }
   ...
   function NM_export_procedimiento_quien_reporta()
   {
         ...
         $this->procedimiento_quien_reporta = str_replace('<', '&lt;', $this->procedimiento_quien_reporta);
         $this->procedimiento_quien_reporta = str_replace('>', '&gt;', $this->procedimiento_quien_reporta);
         $this->Texto_tag .= "<td>" . $this->procedimiento_quien_reporta . "</td>\r\n";
   }
   ...
   function NM_export_procedimiento_tipo_caso()
   {
         ...
         $this->procedimiento_tipo_caso = str_replace('<', '&lt;', $this->procedimiento_tipo_caso);
         $this->procedimiento_tipo_caso = str_replace('>', '&gt;', $this->procedimiento_tipo_caso);
         $this->Texto_tag .= "<td>" . $this->procedimiento_tipo_caso . "</td>\r\n";
   }
   ...
   function NM_export_anotaciones()
   {
         ...
         $this->anotaciones = str_replace('<', '&lt;', $this->anotaciones);
         $this->anotaciones = str_replace('>', '&gt;', $this->anotaciones);
         $this->Texto_tag .= "<td>" . $this->anotaciones . "</td>\r\n";
   }
   ...
   function NM_export_anotaciones_id_observacion()
   {
         ...
         $this->anotaciones_id_observacion = str_replace('<', '&lt;', $this->anotaciones_id_observacion);
         $this->anotaciones_id_observacion = str_replace('>', '&gt;', $this->anotaciones_id_observacion);
         $this->Texto_tag .= "<td>" . $this->anotaciones_id_observacion . "</td>\r\n";
   }
   ...
   function NM_export_anotaciones_id_procedimiento()
   {
         ...
         $this->anotaciones_id_procedimiento = str_replace('<', '&lt;', $this->anotaciones_id_procedimiento);
         $this->anotaciones_id_procedimiento = str_replace('>', '&gt;', $this->anotaciones_id_procedimiento);
         $this->Texto_tag .= "<td>" . $this->anotaciones_id_procedimiento . "</td>\r\n";
   }
   //----- anotaciones_fecha
   function NM_export_anotaciones_fecha()
   {
         ...
         $this->anotaciones_fecha = NM_charset_to_utf8($this->anotaciones_fecha);
         $this->anotaciones_fecha = str_replace('<', '&lt;', $this->anotaciones_fecha);
         $this->anotaciones_fecha = str_replace('>', '&gt;', $this->anotaciones_fecha);
         $this->Texto_tag .= "<td>" . $this->anotaciones_fecha . "</td>\r\n";
   }
   //----- anotaciones_ip
   function NM_export_anotaciones_ip()
   {
         ...
         $this->anotaciones_ip = str_replace('<', '&lt;', $this->anotaciones_ip);
         $this->anotaciones_ip = str_replace('>', '&gt;', $this->anotaciones_ip);
         $this->Texto_tag .= "<td>" . $this->anotaciones_ip . "</td>\r\n";
   }
   //----- anotaciones_observa
   function NM_export_anotaciones_observa()
   {
         ...
         $this->anotaciones_observa = str_replace('<', '&lt;', $this->anotaciones_observa);
         $this->anotaciones_observa = str_replace('>', '&gt;', $this->anotaciones_observa);
         $this->Texto_tag .= "<td>" . $this->anotaciones_observa . "</td>\r\n";
   }
   //----- anotaciones_user
   function NM_export_anotaciones_user()
   {
         ...
         $this->anotaciones_user = str_replace('<', '&lt;', $this->anotaciones_user);
         $this->anotaciones_user = str_replace('>', '&gt;', $this->anotaciones_user);
         $this->Texto_tag .= "<td>" . $this->anotaciones_user . "</td>\r\n";
   }
   //----- sc_field_0
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['observacion_reporte']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
