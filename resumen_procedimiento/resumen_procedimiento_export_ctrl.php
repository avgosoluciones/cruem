<?php
@session_start() ;
$_SESSION['scriptcase']['resumen_procedimiento']['sc_process_barr'] = true;
require_once('../resumen_procedimiento/index.php');
unset($_SESSION['scriptcase']['resumen_procedimiento']['sc_process_barr']);
$ExportCtrl = new resumen_procedimiento_export_control;
$ExportCtrl->Export_barr();

class resumen_procedimiento_export_control
{
