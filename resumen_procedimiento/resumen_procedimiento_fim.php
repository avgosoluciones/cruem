...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRUE_____resumen_procedimiento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRUE_____resumen_procedimiento"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['editar_procedimiento'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>resumen_procedimiento</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['resumen_procedimiento']['embutida_filho'] as $ind => $sc_init)
          {
