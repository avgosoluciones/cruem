...
function ajax_navigate(opc, parm, Fade='S')
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_resumen_procedimiento').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_resumen_procedimiento').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_resumen_procedimiento').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_resumen_procedimiento').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_resumen_procedimiento').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_resumen_procedimiento').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_resumen_procedimiento').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_resumen_procedimiento').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_resumen_procedimiento').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_resumen_procedimiento').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_resumen_procedimiento').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_resumen_procedimiento').style.width  = '0px';
        }
        if (oResp["setValue"]) {
