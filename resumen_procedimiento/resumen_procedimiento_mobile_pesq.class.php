...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_barrio_id_barrio_cond" name="barrio_id_barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio_id_barrio'), this, 'barrio_id_barrio')">
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_barrio_barrio_cond" name="barrio_barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio_barrio'), this, 'barrio_barrio')">
      ...
      <br><span id="id_hide_barrio_barrio"  <?php echo $str_hide_barrio_barrio?>><?php
      if ($barrio_barrio != "")
      {
      $barrio_barrio_look = (is_string($barrio_barrio) ? substr($this->Db->qstr($barrio_barrio), 1, -1) : $barrio_barrio); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_barrio_id_sector_cond" name="barrio_id_sector_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio_id_sector'), this, 'barrio_id_sector')">
      ...
      <br><span id="id_hide_barrio_id_sector"  <?php echo $str_hide_barrio_id_sector?>><INPUT  type="text" id="SC_barrio_id_sector" name="barrio_id_sector" value="<?php echo NM_encode_input($barrio_id_sector) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_eps_id_eps_cond" name="eps_id_eps_cond" onChange="nm_campos_between(document.getElementById('id_vis_eps_id_eps'), this, 'eps_id_eps')">
      ...
      <br><span id="id_hide_eps_id_eps"  <?php echo $str_hide_eps_id_eps?>><INPUT  type="text" id="SC_eps_id_eps" name="eps_id_eps" value="<?php echo NM_encode_input($eps_id_eps) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
