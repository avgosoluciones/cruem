...
class resumen_procedimiento_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . resumen_procedimiento_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . resumen_procedimiento_pack_protect_string($Tipo_filter[0]) . "\">.." . resumen_procedimiento_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_barrio_barrio')
      {
          $barrio_barrio = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_barrio_barrio($barrio_barrio);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_barrio_barrio($barrio_barrio)
   {
      $barrio_barrio = substr($this->Db->qstr($barrio_barrio), 1, -1);
            $barrio_barrio_look = (is_string($barrio_barrio) ? substr($this->Db->qstr($barrio_barrio), 1, -1) : $barrio_barrio); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct barrio.barrio from " . $this->Ini->nm_tabela . " where  barrio.barrio like '%" . $barrio_barrio . "%' order by barrio.barrio"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "procedimiento.hora_ingreso_llamada";$Nm_datas[] = "procedimiento_hora_ingreso_llamada";$Nm_datas[] = "procedimiento.hora_notifica_movil";$Nm_datas[] = "procedimiento_hora_notifica_movil";$Nm_datas[] = "procedimiento.hora_llegada_sitio";$Nm_datas[] = "procedimiento_hora_llegada_sitio";$Nm_datas[] = "procedimiento.hora_llegada_ips";$Nm_datas[] = "procedimiento_hora_llegada_ips";$Nm_datas[] = "procedimiento.hora_salida_ips";$Nm_datas[] = "procedimiento_hora_salida_ips";$Nm_datas[] = "procedimiento.fecha";$Nm_datas[] = "procedimiento_fecha";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $NM_cond = str_replace(array("##ini##","##fim##"), array("",""),$NM_cond);
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>resumen_procedimiento/resumen_procedimiento_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="resumen_procedimiento_ajax_search.js"></script>
 <script type="text/javascript" src="resumen_procedimiento_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="resumen_procedimiento_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['resumen_procedimiento']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['resumen_procedimiento']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_barrio_id_barrio_cond#NMF#' + search_get_sel_txt('SC_barrio_id_barrio_cond') + '@NMF@';
  str_out += 'SC_barrio_id_barrio#NMF#' + search_get_text('SC_barrio_id_barrio') + '@NMF@';
  str_out += 'SC_barrio_barrio_cond#NMF#' + search_get_sel_txt('SC_barrio_barrio_cond') + '@NMF@';
  str_out += 'SC_barrio_barrio#NMF#' + search_get_text('SC_barrio_barrio') + '@NMF@';
  str_out += 'id_ac_barrio_barrio#NMF#' + search_get_text('id_ac_barrio_barrio') + '@NMF@';
  str_out += 'SC_barrio_id_sector_cond#NMF#' + search_get_sel_txt('SC_barrio_id_sector_cond') + '@NMF@';
  str_out += 'SC_barrio_id_sector#NMF#' + search_get_text('SC_barrio_id_sector') + '@NMF@';
  str_out += 'SC_eps_id_eps_cond#NMF#' + search_get_sel_txt('SC_eps_id_eps_cond') + '@NMF@';
  str_out += 'SC_eps_id_eps#NMF#' + search_get_text('SC_eps_id_eps') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_barrio_barrio").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_barrio_barrio").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_barrio_barrio",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_barrio_barrio").val(ui.item.value);
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Emergencias registradas</div>
...
<?php
   ...
   {
      global 
             $barrio_id_barrio_cond, $barrio_id_barrio,
             $barrio_barrio_cond, $barrio_barrio, $barrio_barrio_autocomp,
             $barrio_id_sector_cond, $barrio_id_sector,
             $eps_id_eps_cond, $eps_id_eps,
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("resumen_procedimiento", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $barrio_id_barrio = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_barrio']; 
          $barrio_id_barrio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_barrio_cond']; 
          $barrio_barrio = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_barrio']; 
          $barrio_barrio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_barrio_cond']; 
          $barrio_id_sector = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_sector']; 
          $barrio_id_sector_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_sector_cond']; 
          $eps_id_eps = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['eps_id_eps']; 
          $eps_id_eps_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['eps_id_eps_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['NM_operador']; 
          if (strtoupper($barrio_id_barrio_cond) != "II" && strtoupper($barrio_id_barrio_cond) != "QP" && strtoupper($barrio_id_barrio_cond) != "NP" && strtoupper($barrio_id_barrio_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($barrio_id_barrio, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($barrio_id_sector_cond) != "II" && strtoupper($barrio_id_sector_cond) != "QP" && strtoupper($barrio_id_sector_cond) != "NP" && strtoupper($barrio_id_sector_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($barrio_id_sector, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($eps_id_eps_cond) != "II" && strtoupper($eps_id_eps_cond) != "QP" && strtoupper($eps_id_eps_cond) != "NP" && strtoupper($eps_id_eps_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($eps_id_eps, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($barrio_id_barrio_cond) || empty($barrio_id_barrio_cond))
      {
         $barrio_id_barrio_cond = "gt";
      }
      if (!isset($barrio_barrio_cond) || empty($barrio_barrio_cond))
      {
         $barrio_barrio_cond = "qp";
      }
      if (!isset($barrio_id_sector_cond) || empty($barrio_id_sector_cond))
      {
         $barrio_id_sector_cond = "gt";
      }
      if (!isset($eps_id_eps_cond) || empty($eps_id_eps_cond))
      {
         $eps_id_eps_cond = "gt";
      }
      ...
      $str_hide_barrio_id_barrio = (in_array($barrio_id_barrio_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_barrio_barrio = (in_array($barrio_barrio_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_barrio_id_sector = (in_array($barrio_id_sector_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_eps_id_eps = (in_array($eps_id_eps_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($barrio_id_barrio) || $barrio_id_barrio == "")
      {
          $barrio_id_barrio = "";
      }
      if (isset($barrio_id_barrio) && !empty($barrio_id_barrio))
      {
         $tmp_pos = (is_string($barrio_id_barrio)) ? strpos($barrio_id_barrio, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $barrio_id_barrio = substr($barrio_id_barrio, 0, $tmp_pos);
         }
      }
      if (!isset($barrio_barrio) || $barrio_barrio == "")
      {
          $barrio_barrio = "";
      }
      if (isset($barrio_barrio) && !empty($barrio_barrio))
      {
         $tmp_pos = (is_string($barrio_barrio)) ? strpos($barrio_barrio, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $barrio_barrio = substr($barrio_barrio, 0, $tmp_pos);
         }
      }
      if (!isset($barrio_id_sector) || $barrio_id_sector == "")
      {
          $barrio_id_sector = "";
      }
      if (isset($barrio_id_sector) && !empty($barrio_id_sector))
      {
         $tmp_pos = (is_string($barrio_id_sector)) ? strpos($barrio_id_sector, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $barrio_id_sector = substr($barrio_id_sector, 0, $tmp_pos);
         }
      }
      if (!isset($eps_id_eps) || $eps_id_eps == "")
      {
          $eps_id_eps = "";
      }
      if (isset($eps_id_eps) && !empty($eps_id_eps))
      {
         $tmp_pos = (is_string($eps_id_eps)) ? strpos($eps_id_eps, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $eps_id_eps = substr($eps_id_eps, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("resumen_procedimiento_help.txt"))
   {
      $Arq_WebHelp = file("resumen_procedimiento_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['resumen_procedimiento']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['resumen_procedimiento']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_barrio_id_barrio_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['barrio_id_barrio'])) ? $this->New_label['barrio_id_barrio'] : "Id Barrio"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_barrio_id_barrio_cond" name="barrio_id_barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio_id_barrio'), this, 'barrio_id_barrio')">
       <OPTION value="gt" <?php if ("gt" == $barrio_id_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $barrio_id_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $barrio_id_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_barrio_id_barrio" <?php echo $str_hide_barrio_id_barrio?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['barrio_id_barrio'])) ? $this->New_label['barrio_id_barrio'] : "Id Barrio";
 $nmgp_tab_label .= "barrio_id_barrio?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_barrio_id_barrio" name="barrio_id_barrio" value="<?php echo NM_encode_input($barrio_id_barrio) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_barrio_barrio_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['barrio_barrio'])) ? $this->New_label['barrio_barrio'] : "Barrio"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_barrio_barrio_cond" name="barrio_barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio_barrio'), this, 'barrio_barrio')">
       <OPTION value="qp" <?php if ("qp" == $barrio_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $barrio_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $barrio_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $barrio_barrio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_barrio_barrio" <?php echo $str_hide_barrio_barrio?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['barrio_barrio'])) ? $this->New_label['barrio_barrio'] : "Barrio";
 $nmgp_tab_label .= "barrio_barrio?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $barrio_barrio_look = (is_string($barrio_barrio) ? substr($this->Db->qstr($barrio_barrio), 1, -1) : $barrio_barrio); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct barrio.barrio from " . $this->Ini->nm_tabela . " where barrio.barrio = '$barrio_barrio_look' order by barrio.barrio"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
      ...
      if (isset($nmgp_def_dados[0][$barrio_barrio]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$barrio_barrio];
      }
      else
      {
          $sAutocompValue = $barrio_barrio;
      }
?>
<INPUT  type="text" id="SC_barrio_barrio" name="barrio_barrio" value="<?php echo NM_encode_input($barrio_barrio) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_barrio_barrio" name="barrio_barrio_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_barrio_id_sector_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['barrio_id_sector'])) ? $this->New_label['barrio_id_sector'] : "Id Sector"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_barrio_id_sector_cond" name="barrio_id_sector_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio_id_sector'), this, 'barrio_id_sector')">
       <OPTION value="gt" <?php if ("gt" == $barrio_id_sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $barrio_id_sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $barrio_id_sector_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_barrio_id_sector" <?php echo $str_hide_barrio_id_sector?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['barrio_id_sector'])) ? $this->New_label['barrio_id_sector'] : "Id Sector";
 $nmgp_tab_label .= "barrio_id_sector?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_barrio_id_sector" name="barrio_id_sector" value="<?php echo NM_encode_input($barrio_id_sector) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_eps_id_eps_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['eps_id_eps'])) ? $this->New_label['eps_id_eps'] : "Id Eps"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_eps_id_eps_cond" name="eps_id_eps_cond" onChange="nm_campos_between(document.getElementById('id_vis_eps_id_eps'), this, 'eps_id_eps')">
       <OPTION value="gt" <?php if ("gt" == $eps_id_eps_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $eps_id_eps_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $eps_id_eps_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_eps_id_eps" <?php echo $str_hide_eps_id_eps?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['eps_id_eps'])) ? $this->New_label['eps_id_eps'] : "Id Eps";
 $nmgp_tab_label .= "eps_id_eps?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_eps_id_eps" name="eps_id_eps" value="<?php echo NM_encode_input($eps_id_eps) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.barrio_id_barrio_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_barrio_id_barrio'), document.F1.barrio_id_barrio_cond, 'barrio_id_barrio');
   document.F1.barrio_id_barrio.value = "";
   document.F1.barrio_barrio_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_barrio_barrio'), document.F1.barrio_barrio_cond, 'barrio_barrio');
   document.F1.barrio_barrio.value = "";
   document.F1.barrio_barrio_autocomp.value = "";
   document.F1.barrio_id_sector_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_barrio_id_sector'), document.F1.barrio_id_sector_cond, 'barrio_id_sector');
   document.F1.barrio_id_sector.value = "";
   document.F1.eps_id_eps_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_eps_id_eps'), document.F1.eps_id_eps_cond, 'eps_id_eps');
   document.F1.eps_id_eps.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CRUE/resumen_procedimiento";
   ...
   function inicializa_vars()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "resumen_procedimiento/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_barrio_id_barrio_cond'] = 'cond';
      $tp_fields['SC_barrio_id_barrio'] = 'text';
      $tp_fields['SC_barrio_barrio_cond'] = 'cond';
      $tp_fields['SC_barrio_barrio'] = 'text_aut';
      $tp_fields['id_ac_barrio_barrio'] = 'text_aut';
      $tp_fields['SC_barrio_id_sector_cond'] = 'cond';
      $tp_fields['SC_barrio_id_sector'] = 'text';
      $tp_fields['SC_eps_id_eps_cond'] = 'cond';
      $tp_fields['SC_eps_id_eps'] = 'text';
   ...
   {
      global $barrio_id_barrio_cond, $barrio_id_barrio,
             $barrio_barrio_cond, $barrio_barrio, $barrio_barrio_autocomp,
             $barrio_id_sector_cond, $barrio_id_sector,
             $eps_id_eps_cond, $eps_id_eps, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($barrio_barrio_autocomp) && empty($barrio_barrio))
      {
          $barrio_barrio = $barrio_barrio_autocomp;
      }
      $barrio_id_barrio_cond_salva = $barrio_id_barrio_cond; 
      if (!isset($barrio_id_barrio_input_2) || $barrio_id_barrio_input_2 == "")
      {
          $barrio_id_barrio_input_2 = $barrio_id_barrio;
      }
      $barrio_barrio_cond_salva = $barrio_barrio_cond; 
      if (!isset($barrio_barrio_input_2) || $barrio_barrio_input_2 == "")
      {
          $barrio_barrio_input_2 = $barrio_barrio;
      }
      $barrio_id_sector_cond_salva = $barrio_id_sector_cond; 
      if (!isset($barrio_id_sector_input_2) || $barrio_id_sector_input_2 == "")
      {
          $barrio_id_sector_input_2 = $barrio_id_sector;
      }
      $eps_id_eps_cond_salva = $eps_id_eps_cond; 
      if (!isset($eps_id_eps_input_2) || $eps_id_eps_input_2 == "")
      {
          $eps_id_eps_input_2 = $eps_id_eps;
      }
      if ($barrio_id_barrio_cond != "in")
      {
          nm_limpa_numero($barrio_id_barrio, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($barrio_id_sector_cond != "in")
      {
          nm_limpa_numero($barrio_id_sector, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($eps_id_eps_cond != "in")
      {
          nm_limpa_numero($eps_id_eps, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_barrio'] = $barrio_id_barrio; 
      if (is_array($barrio_id_barrio) && !empty($barrio_id_barrio))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0] = $barrio_id_barrio;
      }
      elseif ($barrio_id_barrio_cond_salva == "nu" || $barrio_id_barrio_cond_salva == "nn" || $barrio_id_barrio_cond_salva == "ep" || $barrio_id_barrio_cond_salva == "ne" || !empty($barrio_id_barrio))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0][0] = $barrio_id_barrio;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_barrio_cond'] = $barrio_id_barrio_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['cmp'] = "barrio_id_barrio"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['opc'] = $barrio_id_barrio_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq']['barrio_id_barrio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_barrio'] = $barrio_barrio; 
      if (is_array($barrio_barrio) && !empty($barrio_barrio))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0] = $barrio_barrio;
      }
      elseif ($barrio_barrio_cond_salva == "nu" || $barrio_barrio_cond_salva == "nn" || $barrio_barrio_cond_salva == "ep" || $barrio_barrio_cond_salva == "ne" || !empty($barrio_barrio))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0][0] = $barrio_barrio;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_barrio_cond'] = $barrio_barrio_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['cmp'] = "barrio_barrio"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['opc'] = $barrio_barrio_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq']['barrio_barrio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_sector'] = $barrio_id_sector; 
      if (is_array($barrio_id_sector) && !empty($barrio_id_sector))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0] = $barrio_id_sector;
      }
      elseif ($barrio_id_sector_cond_salva == "nu" || $barrio_id_sector_cond_salva == "nn" || $barrio_id_sector_cond_salva == "ep" || $barrio_id_sector_cond_salva == "ne" || !empty($barrio_id_sector))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0][0] = $barrio_id_sector;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['barrio_id_sector_cond'] = $barrio_id_sector_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['cmp'] = "barrio_id_sector"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['opc'] = $barrio_id_sector_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq']['barrio_id_sector'] = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['eps_id_eps'] = $eps_id_eps; 
      if (is_array($eps_id_eps) && !empty($eps_id_eps))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0] = $eps_id_eps;
      }
      elseif ($eps_id_eps_cond_salva == "nu" || $eps_id_eps_cond_salva == "nn" || $eps_id_eps_cond_salva == "ep" || $eps_id_eps_cond_salva == "ne" || !empty($eps_id_eps))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['val'][0][0] = $eps_id_eps;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['eps_id_eps_cond'] = $eps_id_eps_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['cmp'] = "eps_id_eps"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid]['opc'] = $eps_id_eps_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['grid_pesq']['eps_id_eps'] = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $barrio_id_barrio;
      if (strtoupper($barrio_id_barrio_cond) != "II" && strtoupper($barrio_id_barrio_cond) != "QP" && strtoupper($barrio_id_barrio_cond) != "NP" && strtoupper($barrio_id_barrio_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['barrio_id_barrio'] = $Conteudo;
      $this->cmp_formatado['barrio_id_barrio'] = "'" . $this->cmp_formatado['barrio_id_barrio'] . "'";
      if (isset($this->cmp_formatado['barrio_id_barrio_input_2'])  && !empty($this->cmp_formatado['barrio_id_barrio_input_2'])) {
          $this->cmp_formatado['barrio_id_barrio_input_2'] = "'" . $this->cmp_formatado['barrio_id_barrio_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($barrio_barrio != '') {
      $barrio_barrio_look = (is_string($barrio_barrio) ? substr($this->Db->qstr($barrio_barrio), 1, -1) : $barrio_barrio); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['barrio_barrio'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['barrio_barrio'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['barrio_barrio'] = $barrio_barrio;
      }
      $this->cmp_formatado['barrio_barrio'] = "'" . $this->cmp_formatado['barrio_barrio'] . "'";
      if (isset($this->cmp_formatado['barrio_barrio_input_2'])  && !empty($this->cmp_formatado['barrio_barrio_input_2'])) {
          $this->cmp_formatado['barrio_barrio_input_2'] = "'" . $this->cmp_formatado['barrio_barrio_input_2'] . "'";
      }
      $Conteudo = $barrio_id_sector;
      if (strtoupper($barrio_id_sector_cond) != "II" && strtoupper($barrio_id_sector_cond) != "QP" && strtoupper($barrio_id_sector_cond) != "NP" && strtoupper($barrio_id_sector_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['barrio_id_sector'] = $Conteudo;
      $this->cmp_formatado['barrio_id_sector'] = "'" . $this->cmp_formatado['barrio_id_sector'] . "'";
      if (isset($this->cmp_formatado['barrio_id_sector_input_2'])  && !empty($this->cmp_formatado['barrio_id_sector_input_2'])) {
          $this->cmp_formatado['barrio_id_sector_input_2'] = "'" . $this->cmp_formatado['barrio_id_sector_input_2'] . "'";
      }
      $Conteudo = $eps_id_eps;
      if (strtoupper($eps_id_eps_cond) != "II" && strtoupper($eps_id_eps_cond) != "QP" && strtoupper($eps_id_eps_cond) != "NP" && strtoupper($eps_id_eps_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['eps_id_eps'] = $Conteudo;
      $this->cmp_formatado['eps_id_eps'] = "'" . $this->cmp_formatado['eps_id_eps'] . "'";
      if (isset($this->cmp_formatado['eps_id_eps_input_2'])  && !empty($this->cmp_formatado['eps_id_eps_input_2'])) {
          $this->cmp_formatado['eps_id_eps_input_2'] = "'" . $this->cmp_formatado['eps_id_eps_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($barrio_id_barrio) || $barrio_id_barrio_cond == "nu" || $barrio_id_barrio_cond == "nn" || $barrio_id_barrio_cond == "ep" || $barrio_id_barrio_cond == "ne")
      {
         $this->monta_condicao("barrio.Id_Barrio", $barrio_id_barrio_cond, $barrio_id_barrio, "", "barrio_id_barrio", "INT", false);
      }

      //----- $barrio_barrio
      $this->Date_part = false;
      if (isset($barrio_barrio) || $barrio_barrio_cond == "nu" || $barrio_barrio_cond == "nn" || $barrio_barrio_cond == "ep" || $barrio_barrio_cond == "ne")
      {
         $this->monta_condicao("barrio.barrio", $barrio_barrio_cond, $barrio_barrio, "", "barrio_barrio", "VARCHAR", false);
      }

      //----- $barrio_id_sector
      $this->Date_part = false;
      if (isset($barrio_id_sector) || $barrio_id_sector_cond == "nu" || $barrio_id_sector_cond == "nn" || $barrio_id_sector_cond == "ep" || $barrio_id_sector_cond == "ne")
      {
         $this->monta_condicao("barrio.Id_Sector", $barrio_id_sector_cond, $barrio_id_sector, "", "barrio_id_sector", "INT", false);
      }

      //----- $eps_id_eps
      $this->Date_part = false;
      if (isset($eps_id_eps) || $eps_id_eps_cond == "nu" || $eps_id_eps_cond == "nn" || $eps_id_eps_cond == "ep" || $eps_id_eps_cond == "ne")
      {
         $this->monta_condicao("eps.Id_Eps", $eps_id_eps_cond, $eps_id_eps, "", "eps_id_eps", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq'] = $this->comando;
       }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_dyn']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_dyn'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_dyn'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_dyn'];
           }
       }
   }
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['cond_pesq'] .= $this->NM_operador;
