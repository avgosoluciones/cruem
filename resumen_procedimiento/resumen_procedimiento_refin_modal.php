...
class refin_search_modal
{
   function init_modal()
   {
       ...
       $label_cmp     = $_SESSION['sc_session'][$this->sc_init]['resumen_procedimiento']['int_search_label'][$cmp_process];
       $lim_col       = 3;
       $qtd_col       = 0;
...
<?php
       ...
       $bol_submit_onclick = true;
           ...
           $arr_field = $_SESSION['sc_session'][$this->sc_init]['resumen_procedimiento']['int_search_dados'][$cmp_process]; 
                    foreach ($arr_field as $cada_opc => $dados_opc)
                    {
                        if(!isset($_SESSION['sc_session'][$this->sc_init]['resumen_procedimiento']['interativ_search'][$cmp_process]['val_sel']) || !in_array($cada_opc, $_SESSION['sc_session'][$this->sc_init]['resumen_procedimiento']['interativ_search'][$cmp_process]['val_sel']))
                        {
            ...
            <div class="scGridRefinedSearchMolduraResult scGridRefinedSearchCampo" style="overflow-y: scroll;">
                <div style="display: flex; flex-flow: row wrap;">
                    ...
                    foreach ($arr_field as $cada_opc => $dados_opc)
                    {
                        ...
                        $checked = (isset($_SESSION['sc_session'][$this->sc_init]['resumen_procedimiento']['interativ_search'][$cmp_process]['val_sel']) && in_array($cada_opc, $_SESSION['sc_session'][$this->sc_init]['resumen_procedimiento']['interativ_search'][$cmp_process]['val_sel'])) ? " checked" : "";
                        $evt  = "";
