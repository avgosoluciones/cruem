...
class resumen_procedimiento_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      if (1 >= sizeof($this->comp_y_axys))
      {
        ...
        if ('S' == $this->Label_CSV) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['resumen_procedimiento'] ['export_info'] ['ordered_x_matrix'] as $rowNumber => $rowInfo) {
            }
        }

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['resumen_procedimiento'] ['export_data'] as $exportRowInfo) {
            $csvLine = [];
            ...
            for ($i = $dimensionCount; $i < $_SESSION['sc_session'] [$this->Ini->sc_page] ['resumen_procedimiento'] ['export_info'] ['dimension_count'] ['y']; $i++) {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['csv_res_file'] = $this->Csv_f;
      }
