...
class resumen_procedimiento_res_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_json()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_use_label']  = $this->Json_use_label;
      $this->Res->resumo_export();
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_use_label']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_res_grid']) && !$this->Ini->sc_export_ajax) {
          $Mens_bar  = NM_charset_to_utf8($this->Ini->Nm_lang['lang_othr_prcs']);
          $Mens_smry = NM_charset_to_utf8($this->Ini->Nm_lang['lang_othr_smry_titl']);
          $this->pb->setProgressbarMessage($Mens_bar . ": " . $Mens_smry);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['json_res_file']['json'] = $this->Json_f;
      }
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          foreach ($lines as $columns)
          {
              ...
              else
              {
                  ...
                  if ($this->Json_format)
                  {
                      $cada_dado = resumen_procedimiento_resumo::formatValue($columns['format'], $columns['value'], true);
                  }
                  else
                  {
