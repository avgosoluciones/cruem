...
class resumen_procedimiento_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Tit_doc    = "resumen_procedimiento" . $this->Xls_tp;
      $this->Tit_zip    = "resumen_procedimiento.zip";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'] .= $this->Xls_tp ;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_name']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_return']);
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['pivot_tabular'];
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_res_sheet'] = $this->Xls_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Emergencias registradas :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xls_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
