...
class resumen_procedimiento_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xml()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xml_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xml_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<resumen_procedimiento>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<resumen_procedimiento>\r\n");
          }
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xml_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xml_res_file']['xml'] = $this->Xml_f;
          if ($this->Grava_view)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['resumen_procedimiento']['xml_res_file']['view'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo_view;
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<resumen_procedimiento";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
